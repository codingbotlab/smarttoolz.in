...
function smarttoolz_db():PDO{
 ...
 $pdo=new PDO('mysql:host='.SMARTTOOLZ_DB_HOST.';dbname='.SMARTTOOLZ_DB_NAME.';charset=utf8mb4',SMARTTOOLZ_DB_USER,$pass,[PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION,PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC,PDO::ATTR_EMULATE_PREPARES=>false]);
 return $pdo;
}
