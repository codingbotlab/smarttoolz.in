...
<div class="nav-links"><a href="/" <?=$isHome?'aria-current="page"':''?>><span class="material-symbols-rounded">home</span> Home</a><a href="/tool.php" <?=$isAllTools?'aria-current="page"':''?>><span class="material-symbols-rounded">apps</span> All Tools</a><a href="/tools/" aria-label="Browse tools"><span class="material-symbols-rounded">category</span> Categories</a></div>
</nav></header>
<?php if ($isToolPage): ?>
