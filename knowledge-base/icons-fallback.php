...
$smarttoolzIconBuffer = ob_start(static function (string $html): string {
    $icons = [
        ...
        'library_books' => '<path d="M4 3h13a2 2 0 0 1 2 2v16H6a2.5 2.5 0 0 1-2-2V3Z"/><path d="M7 7h8M7 11h8M7 15h5"/><path d="M19 7h1v14H7"/>',
...
/* Explicitly flush our buffer so the SVG replacement happens before PHP shutdown. */
