...
<section class="lh-section">
  ...
  <p>For important data, check that the copied files actually open from the external drive before assuming the transfer worked.</p>
</section>
...
<section class="lh-section">
  ...
  <div class="lh-callout"><strong>3-2-1 concept:</strong> Keep 3 copies of important data, on 2 different types of storage, with 1 copy kept somewhere separate.</div>
...
<section class="lh-section">
  ...
  <ul>
    ...
    <li>If an external drive contains your only backup, create another backup when possible.</li>
...
<section class="lh-section">
  ...
  <ol>
    ...
    <li>Create a folder named <strong>Computer Basics External Storage Practice</strong>.</li>
