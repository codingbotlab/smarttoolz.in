...
{
    if ((string)($lesson['slug'] ?? '') !== 'course-16-lesson-31') {
        return null;
    }

    return <<<'HTML'
<section class="lh-section">
  <h2>What Is Computer Maintenance?</h2>
  ...
  <div class="lh-callout"><strong>Key idea:</strong> Maintenance helps keep the computer healthy; backups protect your data. You need both.</div>
</section>

<section class="lh-section">
  <h2>1. Keep Windows and Software Updated</h2>
  <p>Updates can contain security fixes, bug fixes, compatibility improvements, and new features. Keep Windows, browsers, and regularly used applications updated through trusted update mechanisms.</p>
  <div class="lh-callout"><strong>Good habit:</strong> Install updates from Windows or the software's trusted update system. Avoid random “update now” pop-ups from unfamiliar websites.</div>
</section>

<section class="lh-section">
  <h2>2. Keep Enough Free Storage</h2>
  <p>A nearly full system drive can cause problems with updates, temporary files, application installs, and general system operation.</p>
  <ol>
    ...
    <li>Use Windows cleanup features when appropriate.</li>
...
<section class="lh-section">
  ...
  <p>Windows Security can provide protection and device health information. If you suspect malware, run an appropriate security scan rather than installing an unknown “PC cleaner” from a pop-up.</p>
</section>

<section class="lh-section">
  <h2>6. Review Startup Apps</h2>
...
<section class="lh-section">
  ...
  <p>Windows includes built-in areas that can report device health, security, storage, and performance-related information.</p>
...
<section class="lh-section">
  ...
  <ol>
    ...
    <li>Open Windows Security and review the current protection status.</li>
    ...
    <li>Confirm that your important documents and photos have a separate backup.</li>
  </ol>
</section>
...
<section class="lh-section">
  ...
  <ul>
    ...
    <li>Thinking maintenance is the same thing as backup.</li>
  </ul>
</section>
...
<section class="lh-section">
  ...
  <ol>
    ...
    <li>Why should you use trusted security and update tools?</li>
  ...
  <details class="mt-3">
    ...
    <ol class="mt-3">
      ...
      <li>Random pop-ups and downloads can be misleading or unsafe.</li>
...
<section class="lh-section">
  <h2>Key Takeaway</h2>
  <div class="lh-callout"><strong>A well-maintained computer is easier to use, safer, and more reliable. Keep software updated, maintain free storage, protect against malware, keep airflow clear, review startup apps, organize files, and keep separate backups of important data.</strong></div>
</section>
HTML;
}
