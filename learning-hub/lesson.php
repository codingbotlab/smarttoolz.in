...
require_once __DIR__.'/includes/course16_lesson20_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson21_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson22_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson23_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson24_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson25_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson26_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson27_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson28_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson29_computer_basics.php';
require_once __DIR__.'/includes/course16_lesson30_computer_basics.php';
...
if ($slug === 'course-16-lesson-20') {$override=lh_course16_lesson20_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-21') {$override=lh_course16_lesson21_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-22') {$override=lh_course16_lesson22_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-23') {$override=lh_course16_lesson23_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-24') {$override=lh_course16_lesson24_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-25') {$override=lh_course16_lesson25_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-26') {$override=lh_course16_lesson26_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-27') {$override=lh_course16_lesson27_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-28') {$override=lh_course16_lesson28_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-29') {$override=lh_course16_lesson29_computer_basics_override($lesson,$position);}
if ($slug === 'course-16-lesson-30') {$override=lh_course16_lesson30_computer_basics_override($lesson,$position);}
