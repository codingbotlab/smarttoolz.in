...
if ($slug === 'course-16-lesson-4') {
    $override=lh_course16_lesson4_override($lesson,$position);
}
if ($slug === 'course-16-lesson-5') {
    $override=lh_course16_lesson5_override($lesson,$position);
}
