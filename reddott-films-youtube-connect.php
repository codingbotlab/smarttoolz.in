 ...
 *
 * This is intentionally separate from Creator AI Google Login.
 * It uses the existing server-side Google OAuth client configuration,
 * but has its own YouTube redirect URI and OAuth state.
 */
