...
<meta name="description" content="Browse the complete SmartToolz website, free online tools, How To Use guides and helpful articles by category.">
...
<main class="sitemap-page">
  <section class="sitemap-hero"><span class="eyebrow">EXPLORE SMARTTOOLZ</span><h1>Everything in one place.</h1><p>Browse every SmartToolz page, free online tool, How To Use guide and helpful article. Find what you need and get started in one click.</p></section>
  <section class="sitemap-toolbar"><div><strong><?= count($tools) ?></strong><span> tools</span></div><div><strong><?= count($grouped) ?></strong><span> categories</span></div><div><strong><?= count($tools) ?></strong><span> how-to guides</span></div><div><strong><?= count($blogs) ?></strong><span> articles</span></div><a href="/tools/">View All Tools →</a></section>
  ...
  <section class="sitemap-section">
    <div class="sitemap-section-title"><div><span class="eyebrow">HOW TO USE</span><h2>Tool guides</h2></div><a href="/tools/">Browse all tools →</a></div>
