...
// Discover real blog article files automatically.
$blogs = [];
...
<meta name="description" content="Browse the complete SmartToolz website, free online tools and helpful guides by category.">
...
<main class="sitemap-page">
  <section class="sitemap-hero"><span class="eyebrow">EXPLORE SMARTTOOLZ</span><h1>Everything in one place.</h1><p>Browse every SmartToolz page, free online tool and helpful guide. Find what you need and get started in one click.</p></section>
  <section class="sitemap-toolbar"><div><strong><?= count($tools) ?></strong><span> tools</span></div><div><strong><?= count($grouped) ?></strong><span> categories</span></div><div><strong><?= count($blogs) ?></strong><span> guides</span></div><a href="/tools/">View All Tools →</a></section>
  ...
  <section class="sitemap-section">
    ...
    <div class="blog-sitemap-grid">
      ...
      <a class="blog-sitemap-card" href="/blog/<?= htmlspecialchars($blog['slug'], ENT_QUOTES, 'UTF-8') ?>/">
        <span class="blog-sitemap-icon">✦</span><span><?= htmlspecialchars($blog['title'], ENT_QUOTES, 'UTF-8') ?></span><b>→</b>
      </a>
      <?php endforeach; ?>
    </div>
  </section>
  ...
  <section class="sitemap-section"><div class="sitemap-section-title"><div><span class="eyebrow">TOOLS</span><h2>Browse by category</h2></div><a href="/tools/">View all tools →</a></div></section>
