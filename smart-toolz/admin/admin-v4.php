...
<aside class="av4-side">
  ...
  <nav class="av4-nav">
    ...
    <a class="<?= $tab==='categories'?'active':'' ?>" href="?tab=categories">🗂️<span>Categories</span></a>
  ...
  <div class="av4-side-bottom"><a class="av4-site-link" href="/smart-toolz/">← Back to SmartToolz</a><div class="av4-foot"><strong><?=av4h($admin['name']??'Admin')?></strong><span><?=av4h($admin['email']??'')?></span><em><i></i> Admin online</em></div></div>
</aside>
<main class="av4-main">
  <header class="av4-top"><div class="av4-title"><div class="av4-eyebrow">SMARTTOOLZ · ADMIN</div><h1><?=av4h($pageTitle)?></h1><p><?=av4h($pageSubtitle)?></p></div><div class="av4-top-actions"><a class="av4-top-btn" href="?tab=dashboard">⌂ Home</a><div class="av4-live"><span class="av4-dot"></span><span data-av4-live><?=number_format($live)?></span> live now</div></div></header>
