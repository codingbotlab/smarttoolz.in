...
function saas_install(): void {
 $db=saas_db();
 $sql=[
 "CREATE TABLE IF NOT EXISTS saas_plans (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, slug VARCHAR(40) NOT NULL UNIQUE, name VARCHAR(80) NOT NULL, price_inr DECIMAL(10,2) NOT NULL DEFAULT 0, monthly_credits INT UNSIGNED NOT NULL DEFAULT 0, ads_free TINYINT(1) NOT NULL DEFAULT 0, active TINYINT(1) NOT NULL DEFAULT 1, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
 ...
 $db->exec("INSERT IGNORE INTO saas_plans(slug,name,price_inr,monthly_credits,ads_free) VALUES ('free','Free',0,100,0),('pro','Pro',199,2000,1),('creator','Creator',499,10000,1)");
}
