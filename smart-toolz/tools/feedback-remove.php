...
echo '<style id="smarttoolz-feedback-remove">,.st-feedback-strip,.st-feedback-card,.smarttoolz-feedback-actions{display:none!important}</style>';
?>
<script>
(function(){
  'use strict';
  function removeLegacy(){
    document.querySelectorAll(',.st-feedback-strip,.st-feedback-card,.smarttoolz-feedback-actions').forEach(function(el){el.remove();});
  }
  function start(){
    removeLegacy();
