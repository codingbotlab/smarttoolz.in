...
<title>Image Flipper Online - Smart-Tooz</title>

<meta
    name="description"
    content="Free online image flipper. Flip JPG, PNG and WebP images horizontally or vertically and download them instantly."
>
...
<div class="page-layout">
    ...
    <main class="tool-content">
        ...
        <section class="info-box">
            ...
            <h2>
                Free Online Image Flipper
            </h2>


            <p>

                Flip JPG, PNG and WebP images horizontally
                or vertically with this free online image
                flipper. Your image is processed directly
                inside your browser, so you don't need to
                upload it to a server. Choose your preferred
                output format and download the flipped image.
...
function updateStatus() {
    ...
    if (
        ...
        flipStatus.textContent =
            'Horizontally + Vertically Flipped';
    ...
    canvas.toBlob(
        function(blob) {
            ...
            if (!blob) {
                ...
                resultInfo.textContent =
                    'Unable to create the flipped image.';
            ...
            resultInfo.textContent =
                '✓ Image flipped and downloaded successfully.';
