...
<link rel="canonical" href="<?= smarttoolz_escape($canonical) ?>">
<meta property="og:type" content="website"><meta property="og:site_name" content="SmartToolz"><meta property="og:title" content="<?= smarttoolz_escape($heading . ' — Free Online Tools | SmartToolz') ?>"><meta property="og:description" content="<?= smarttoolz_escape($description) ?>"><meta property="og:url" content="<?= smarttoolz_escape($canonical) ?>">
<meta name="twitter:card" content="summary">
<link rel="stylesheet" href="/assets/css/smarttoolz.css">
</head>
<body>
<?php require __DIR__ . '/header.php'; ?>
<main class="tools-page"><div class="container">
<section class="tools-hero"><span class="tag">SMARTTOOLZ COLLECTION</span><h1><?= smarttoolz_escape($heading) ?></h1><p><?= count($visible) ?> free tools ready to use — search, filter and get to work.</p></section>
<div class="tools-layout" id="categories">
...
<section><input id="toolSearch" class="tool-search" type="search" placeholder="Search tools by name or description…" aria-label="Search tools"><div id="toolGrid" class="tool-grid">
<?php foreach ($visible as $tool): ?><a class="tool-card" href="<?= smarttoolz_escape($tool['url']) ?>" data-search="<?= smarttoolz_escape(strtolower($tool['name'].' '.$tool['description'].' '.$tool['category'])) ?>"><span class="tool-icon"><?= smarttoolz_escape($tool['icon']) ?></span><h3><?= smarttoolz_escape($tool['name']) ?></h3><p><?= smarttoolz_escape($tool['description']) ?></p><span class="tool-open">Open tool →</span></a><?php endforeach; ?>
</div><div id="empty" class="empty" hidden>No tools match your search.</div></section>
</div></div></main>
