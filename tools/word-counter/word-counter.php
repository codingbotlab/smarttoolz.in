...
<section class="related" aria-label="Related text tools"><div class="related-head"><h2>Related Text Tools</h2><a href="/tool.php">View all tools →</a></div><div class="related-grid"><a class="related-card" href="/tools/text-case-converter/"><span class="related-icon">Aa</span><h3>Text Case Converter</h3><p>Change text to upper, lower, title and other cases.</p><span class="related-link">Open tool →</span></a><a class="related-card" href="/tools/remove-duplicate-lines/"><span class="related-icon">≡</span><h3>Remove Duplicate Lines</h3><p>Clean repeated lines from text quickly.</p><span class="related-link">Open tool →</span></a><a class="related-card" href="/tools/character-counter/"><span class="related-icon">#</span><h3>Character Counter</h3><p>Check character totals and text length instantly.</p><span class="related-link">Open tool →</span></a><a class="related-card" href="/tools/line-counter/"><span class="related-icon">☷</span><h3>Line Counter</h3><p>Count lines in pasted or typed text.</p><span class="related-link">Open tool →</span></a></div></section>
</main>
<script>
(() => {
  'use strict';
