    ...
    <div class="stv-channel-page">
        <section class="stv-channel-hero">
            ...
            <div class="stv-channel-info">
                ...
                <p>@<?php echo esc_html( $user->user_login ); ?> · <?php echo esc_html( count($videos) ); ?> videos</p>
        ...
        <nav class="stv-channel-tabs" aria-label="Channel navigation">
            <a class="stv-channel-tab stv-channel-tab--active" href="<?php echo esc_url( smarttoolz_video_route_url('channel') ); ?>">Home</a>
            <a class="stv-channel-tab" href="<?php echo esc_url( smarttoolz_video_route_url('channel-videos') ); ?>">Videos</a>
            <?php if ( smarttoolz_video_route_enabled('channel-shorts') ) : ?><a class="stv-channel-tab" href="<?php echo esc_url( smarttoolz_video_route_url('channel-shorts') ); ?>">Shorts</a><?php endif; ?>
            <?php if ( smarttoolz_video_route_enabled('channel-live') ) : ?><a class="stv-channel-tab" href="<?php echo esc_url( smarttoolz_video_route_url('channel-live') ); ?>">Live</a><?php endif; ?>
        </nav>
        <section>
