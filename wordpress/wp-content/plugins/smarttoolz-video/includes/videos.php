...
function smarttoolz_video_manage_page() {
    ...
    ?>
    <section class="stv-creator"><div class="stv-section-heading"><div><h1 class="stv-page-title">Your videos</h1><p class="stv-section-subtitle">Upload, edit and delete the videos on your SmartToolz channel.</p></div><a class="stv-view-link" href="<?php echo esc_url(smarttoolz_video_route_url('channel')); ?>">View channel</a></div>
