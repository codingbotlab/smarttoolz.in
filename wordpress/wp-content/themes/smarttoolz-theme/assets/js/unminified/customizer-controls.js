...
( function( $ ) {
	...
	ASTCustomizer = {
		...
		_initToggles: function()
		{
			...
			ASTControlTrigger.triggerHook( 'smarttoolz-toggle-control', api );
		...
		{
			document.addEventListener('SmartToolzToggleSubControls', function (e) {
...
( function( api ) {
    // Extends our custom smarttoolz-pro section.
    api.sectionConstructor['smarttoolz-pro'] = api.Section.extend( {
