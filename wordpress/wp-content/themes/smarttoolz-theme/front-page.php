  ...
  <div class="st-hero-grid">
    ...
    <div class="st-hero-card">
      ...
      <div class="st-stat-row">
        <div class="st-stat"><b><?php echo esc_html( (string) wp_count_posts()->publish ); ?></b><span><?php esc_html_e( 'Published posts', 'smarttoolz' ); ?></span></div>
        <div class="st-stat"><b><?php echo esc_html( (string) count( $categories ) ); ?></b><span><?php esc_html_e( 'Active categories', 'smarttoolz' ); ?></span></div>
      </div>
    </div>
  </div>
</section>
...
<section class="st-section" id="categories">
  <div class="st-section-head"><h2><?php esc_html_e( 'Explore categories', 'smarttoolz' ); ?></h2></div>
  <div class="st-grid st-category-grid">
    <?php if ( $categories ) : foreach ( $categories as $category ) : ?>
      <a class="st-card st-category-card" href="<?php echo esc_url( get_category_link( $category->term_id ) ); ?>">
        <span class="st-category-icon">#</span>
        <h3><?php echo esc_html( $category->name ); ?></h3>
        <p><?php echo esc_html( sprintf( _n( '%d article', '%d articles', $category->count, 'smarttoolz' ), $category->count ) ); ?></p>
      </a>
    <?php endforeach; else : ?>
      <div class="st-card"><p><?php esc_html_e( 'Categories will appear here as you publish content.', 'smarttoolz' ); ?></p></div>
    <?php endif; ?>
  </div>
</section>

<section class="st-section" id="latest">
  <div class="st-section-head"><h2><?php esc_html_e( 'Latest from SmartToolz', 'smarttoolz' ); ?><span class="st-section-subtitle"><?php esc_html_e( 'Fresh articles and guides', 'smarttoolz' ); ?></span></h2><a href="<?php echo esc_url( get_post_type_archive_link( 'post' ) ?: home_url( '/' ) ); ?>"><?php esc_html_e( 'View all', 'smarttoolz' ); ?></a></div>
  <div class="st-grid">
