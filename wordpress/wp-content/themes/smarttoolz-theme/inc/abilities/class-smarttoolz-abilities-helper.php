 ...
 * Abilities Helper
 *
 * Common utility functions for SmartToolz abilities.
 *
 * @package SmartToolz
...
/**
 * Class SmartToolz_Abilities_Helper
 */
class SmartToolz_Abilities_Helper {
	/**
	...
	public static function update_font_extras( $args, $option_key ) {
		...
		$font_extras = smarttoolz_get_option( $option_key, array() );
		...
		smarttoolz_update_option( $option_key, $font_extras );
	}
}
