...
/**
 * Class SmartToolz_Get_Footer_Builder_Design
 */
class SmartToolz_Get_Footer_Builder_Design extends SmartToolz_Abstract_Ability {
	/**
	 * Configure the ability.
	 */
	public function configure() {
		$this->id          = 'smarttoolz/get-footer-builder-design';
		$this->label       = __( 'Get SmartToolz Footer Builder Design Options', 'smarttoolz' );
		$this->description = __( 'Retrieves design options for SmartToolz footer builder sections (above, primary, below) including background, border color, border size, padding and margin.', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		foreach ( $sections_to_fetch as $sect ) {
			...
			$design_options[ $sect ] = array(
				...
				'border_color' => smarttoolz_get_option( $prefix . '-top-border-color', '' ),
...
SmartToolz_Get_Footer_Builder_Design::register();
