...
/**
 * Class SmartToolz_Get_Footer_Builder
 */
class SmartToolz_Get_Footer_Builder extends SmartToolz_Abstract_Ability {
	/**
	 * Configure the ability.
	 */
	public function configure() {
		$this->id          = 'smarttoolz/get-footer-builder';
		$this->label       = __( 'Get SmartToolz Footer Builder Settings', 'smarttoolz' );
		$this->description = __( 'Retrieves the current SmartToolz theme footer builder configuration including desktop and mobile layouts with components like buttons, HTML blocks, widgets, social icons, footer menu, and copyright positioned in above footer, primary footer, and below footer sections.', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		$desktop_items = smarttoolz_get_option( 'footer-desktop-items', array() );
		$mobile_items  = smarttoolz_get_option( 'footer-mobile-items', array() );
		...
		$above_footer_columns   = smarttoolz_get_option( 'hba-footer-column', '3' );
		$primary_footer_columns = smarttoolz_get_option( 'hb-footer-column', '3' );
		$below_footer_columns   = smarttoolz_get_option( 'hbb-footer-column', '1' );

		$above_footer_layout   = smarttoolz_get_option( 'hba-footer-layout', 'full' );
		$primary_footer_layout = smarttoolz_get_option( 'hb-footer-layout', 'full' );
		$below_footer_layout   = smarttoolz_get_option( 'hbb-footer-layout', 'full' );
		...
		return SmartToolz_Abilities_Response::success(
			__( 'Retrieved footer builder settings successfully.', 'smarttoolz' ),
			array(
...
SmartToolz_Get_Footer_Builder::register();
