...
/**
 * Class SmartToolz_Update_Footer_Builder_Design
 */
class SmartToolz_Update_Footer_Builder_Design extends SmartToolz_Abstract_Ability {
	/**
	 * Configure the ability.
	 */
	public function configure() {
		$this->id          = 'smarttoolz/update-footer-builder-design';
		$this->label       = __( 'Update SmartToolz Footer Builder Design Options', 'smarttoolz' );
		$this->description = __( 'Updates design options for SmartToolz footer builder sections (above, primary, below) including background, border color, border size, padding and margin.', 'smarttoolz' );
		...
		$this->meta = array(
			...
			'constraints' => array(
				'dependencies' => array(
					array(
						'tool'             => 'smarttoolz/get-footer-builder-design',
	...
	public function execute( $args ) {
		...
		if ( isset( $args['border_color'] ) ) {
			...
			smarttoolz_update_option( $prefix . '-top-border-color', $sanitized_color );
			$updated           = true;
		...
		$message = sprintf(
			__( '%1$s footer design updated: %2$s.', 'smarttoolz' ),
			ucfirst( $section ),
...
SmartToolz_Update_Footer_Builder_Design::register();
