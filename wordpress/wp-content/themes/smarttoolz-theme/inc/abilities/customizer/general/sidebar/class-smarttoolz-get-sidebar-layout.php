...
/**
 * Class SmartToolz_Get_Sidebar_Layout
 */
class SmartToolz_Get_Sidebar_Layout extends SmartToolz_Abstract_Ability {
	/**
	...
	public function configure() {
		$this->id          = 'smarttoolz/get-sidebar-layout';
		$this->label       = __( 'Get SmartToolz Sidebar Layout', 'smarttoolz' );
		$this->description = __( 'Retrieves the default sidebar layout setting for the SmartToolz theme (no sidebar, left sidebar, or right sidebar).', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		return SmartToolz_Abilities_Response::success(
			__( 'Retrieved sidebar layout successfully.', 'smarttoolz' ),
			array(
				'layout'            => $layout,
...
SmartToolz_Get_Sidebar_Layout::register();
