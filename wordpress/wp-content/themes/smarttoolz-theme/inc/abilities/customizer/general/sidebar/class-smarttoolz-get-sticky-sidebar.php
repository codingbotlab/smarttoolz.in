...
/**
 * Class SmartToolz_Get_Sticky_Sidebar
 */
class SmartToolz_Get_Sticky_Sidebar extends SmartToolz_Abstract_Ability {
	/**
	...
	public function configure() {
		$this->id          = 'smarttoolz/get-sidebar-sticky';
		$this->label       = __( 'Get SmartToolz Sticky Sidebar Status', 'smarttoolz' );
		$this->description = __( 'Retrieves the sticky sidebar setting for the SmartToolz theme (enabled or disabled).', 'smarttoolz' );
	...
	public function execute( $args ) {
		$enabled = smarttoolz_get_option( 'site-sticky-sidebar', false );

		return SmartToolz_Abilities_Response::success(
			__( 'Retrieved sticky sidebar status successfully.', 'smarttoolz' ),
			array(
...
SmartToolz_Get_Sticky_Sidebar::register();
