...
/**
 * Class SmartToolz_Update_Sidebar
 */
class SmartToolz_Update_Sidebar extends SmartToolz_Abstract_Ability {
	/**
	...
	public function configure() {
		$this->id          = 'smarttoolz/update-sidebar';
		$this->category    = 'smarttoolz';
		$this->label       = __( 'Update SmartToolz Sidebar Settings', 'smarttoolz' );
		$this->description = __( 'Updates sidebar settings for the SmartToolz theme including layout, style, width, and sticky sidebar.', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		if ( isset( $args['sticky_enabled'] ) ) {
			...
			smarttoolz_update_option( 'site-sticky-sidebar', $sticky );
			$updated           = true;
...
SmartToolz_Update_Sidebar::register();
