...
/**
 * Class SmartToolz_List_Font_Families
 */
class SmartToolz_List_Font_Families extends SmartToolz_Abstract_Ability {
	/**
	 * Configure the ability.
	 */
	public function configure() {
		$this->id          = 'smarttoolz/list-font-family';
		$this->label       = __( 'List Available Font Families', 'smarttoolz' );
		$this->description = __( 'Lists the most popular and frequently used Google Font families available for use. Returns curated lists of trending fonts with categories and variants.', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		return SmartToolz_Abilities_Response::success(
			...
			sprintf( __( 'Found %d font families.', 'smarttoolz' ), count( $fonts ) ),
			array(
	...
	/**
	 * Get all available Google Fonts from SmartToolz.
	 *
...
SmartToolz_List_Font_Families::register();
