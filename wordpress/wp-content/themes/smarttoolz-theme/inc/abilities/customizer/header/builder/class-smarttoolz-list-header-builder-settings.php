...
/**
 * Class SmartToolz_List_Header_Builder_Settings
 *
 ...
 */
class SmartToolz_List_Header_Builder_Settings extends SmartToolz_Abstract_Ability {
	/**
	...
	public function get_examples() {
		return array(
			...
			'what widgets does smarttoolz header support',
	...
	public function execute( $args ) {
		...
		return SmartToolz_Abilities_Response::success(
			sprintf(
				...
				__( 'Retrieved header builder settings. %1$d widgets available, %2$d layouts configured.', 'smarttoolz' ),
	...
	private function get_current_layout( $device, $detailed ) {
		...
		$layout     = smarttoolz_get_option( $option_key, array() );
...
SmartToolz_List_Header_Builder_Settings::register();
