...
/**
 * Class SmartToolz_Get_Header_Builder_Design
 */
class SmartToolz_Get_Header_Builder_Design extends SmartToolz_Abstract_Ability {
	/**
	...
	public function configure() {
		$this->id          = 'smarttoolz/get-header-builder-design';
		$this->label       = __( 'Get SmartToolz Header Builder Design Options', 'smarttoolz' );
		$this->description = __( 'Retrieves design options for SmartToolz header builder sections (above, primary, below) including background, border color, border size, padding and margin.', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		foreach ( $sections_to_fetch as $sect ) {
			...
			$design_options[ $sect ] = array(
				'background'   => smarttoolz_get_option( $prefix . '-bg-obj-responsive', array() ),
				'border_color' => smarttoolz_get_option( $prefix . '-bottom-border-color', '' ),
				'border_size'  => smarttoolz_get_option( $prefix . '-separator', 0 ),
				'padding'      => smarttoolz_get_option( $section_id . '-padding', array() ),
				'margin'       => smarttoolz_get_option( $section_id . '-margin', array() ),
			);
		}
...
SmartToolz_Get_Header_Builder_Design::register();
