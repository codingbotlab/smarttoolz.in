...
/**
 * Class SmartToolz_Get_Header_Builder
 */
class SmartToolz_Get_Header_Builder extends SmartToolz_Abstract_Ability {
	/**
	...
	public function configure() {
		$this->id          = 'smarttoolz/get-header-builder';
		$this->label       = __( 'Get SmartToolz Header Builder Settings', 'smarttoolz' );
		$this->description = __( 'Retrieves the current SmartToolz theme header builder configuration including desktop and mobile layouts with components like buttons, HTML blocks, menus, widgets, social icons, and search positioned in above header, primary header, and below header sections.', 'smarttoolz' );
	...
	public function execute( $args ) {
		...
		$desktop_items      = smarttoolz_get_option( 'header-desktop-items', array() );
		$mobile_items       = smarttoolz_get_option( 'header-mobile-items', array() );
		$mobile_popup_items = smarttoolz_get_option( 'header-mobile-popup-items', array() );
		...
		return SmartToolz_Abilities_Response::success(
			__( 'Retrieved header builder settings successfully.', 'smarttoolz' ),
			array(
...
SmartToolz_Get_Header_Builder::register();
