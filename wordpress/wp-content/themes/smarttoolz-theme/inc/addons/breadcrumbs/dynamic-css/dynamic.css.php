 ...
 * Breadcrumbs
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_breadcrumb_section_dynamic_css' );
 ...
 * @since 1.7.0
 */
function smarttoolz_breadcrumb_section_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	$breadcrumb_position = smarttoolz_get_option( 'breadcrumb-position', 'none' );
	...
	$breadcrumb_text_color      = smarttoolz_get_option( 'breadcrumb-text-color-responsive', $default_color_array );
	$breadcrumb_active_color    = smarttoolz_get_option( 'breadcrumb-active-color-responsive', $default_color_array );
	$breadcrumb_hover_color     = smarttoolz_get_option( 'breadcrumb-hover-color-responsive', $default_color_array );
	$breadcrumb_separator_color = smarttoolz_get_option( 'breadcrumb-separator-color', $default_color_array );
	$breadcrumb_bg_color        = smarttoolz_get_option( 'breadcrumb-bg-color', $default_color_array );

	$breadcrumb_font_size          = smarttoolz_get_option( 'breadcrumb-font-size' );
	$breadcrumb_spacing            = smarttoolz_get_option( 'breadcrumb-spacing' );
	$breadcrumb_alignment          = smarttoolz_get_option( 'breadcrumb-alignment' );
	$breadcrumb_separator          = smarttoolz_get_option( 'breadcrumb-separator' );
	$breadcrumb_separator_selector = smarttoolz_get_option( 'breadcrumb-separator-selector' );

	/**
	 * Generate dynamic CSS based on the Breadcrumb Source option selected from the customizer.
	 */
	$breadcrumb_source = smarttoolz_get_option( 'select-breadcrumb-source' );
	...
	if ( function_exists( 'yoast_breadcrumb' ) && true === $wpseo_option['breadcrumbs-enable'] && $breadcrumb_source && 'yoast-seo-breadcrumbs' === $breadcrumb_source ) {
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumb_last, .ast-breadcrumbs-wrapper span' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'breadcrumb-font-family' ), smarttoolz_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_tablet = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumb_last, .ast-breadcrumbs-wrapper span' => array(
				'font-size' => smarttoolz_responsive_font( $breadcrumb_font_size, 'tablet' ),
			),
		);
		...
		$breadcrumbs_mobile = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumb_last, .ast-breadcrumbs-wrapper span' => array(
				'font-size' => smarttoolz_responsive_font( $breadcrumb_font_size, 'mobile' ),
			),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumbs, .ast-breadcrumbs-wrapper .current-item' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'breadcrumb-font-family' ), smarttoolz_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .last, .ast-breadcrumbs-wrapper .separator' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'breadcrumb-font-family' ), smarttoolz_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-inner, .ast-breadcrumbs-inner .breadcrumb-item, .ast-breadcrumbs-inner .breadcrumb-item.active, .ast-breadcrumbs-inner .breadcrumb-item:after' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'breadcrumb-font-family' ), smarttoolz_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper, .ast-breadcrumbs-wrapper *' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'breadcrumb-font-family' ), smarttoolz_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
	...
	if ( 'smarttoolz_header_markup_after' === $breadcrumb_position || 'smarttoolz_header_after' === $breadcrumb_position ) {
		// After Header.
		$breadcrumbs_desktop['.main-header-bar.ast-header-breadcrumb, .ast-header-break-point .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .header-main-layout-2 .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .ast-mobile-header-stack .main-header-bar.ast-header-breadcrumb, .ast-default-menu-enable.ast-main-header-nav-open.ast-header-break-point .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb, .ast-main-header-nav-open .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb'] = array(
			'padding-top'    => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'top', 'desktop' ),
			'padding-right'  => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'right', 'desktop' ),
			'padding-bottom' => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'bottom', 'desktop' ),
			'padding-left'   => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'left', 'desktop' ),
		);
		$breadcrumbs_tablet['.main-header-bar.ast-header-breadcrumb, .ast-header-break-point .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .header-main-layout-2 .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .ast-mobile-header-stack .main-header-bar.ast-header-breadcrumb, .ast-default-menu-enable.ast-main-header-nav-open.ast-header-break-point .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb, .ast-main-header-nav-open .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb']  = array(
			'padding-top'    => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'top', 'tablet' ),
			'padding-right'  => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'right', 'tablet' ),
			'padding-bottom' => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'bottom', 'tablet' ),
			'padding-left'   => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'left', 'tablet' ),
		);
		$breadcrumbs_mobile['.main-header-bar.ast-header-breadcrumb, .ast-header-break-point .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .header-main-layout-2 .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .ast-mobile-header-stack .main-header-bar.ast-header-breadcrumb, .ast-default-menu-enable.ast-main-header-nav-open.ast-header-break-point .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb, .ast-main-header-nav-open .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb']  = array(
			'padding-top'    => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'top', 'mobile' ),
			'padding-right'  => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'right', 'mobile' ),
			'padding-bottom' => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'bottom', 'mobile' ),
			'padding-left'   => smarttoolz_responsive_spacing( $breadcrumb_spacing, 'left', 'mobile' ),
		);
	...
	} elseif ( 'smarttoolz_masthead_content' === $breadcrumb_position ) {
		// Inside Header.
	...
	$css .= smarttoolz_parse_css( $breadcrumbs_desktop );
	$css .= smarttoolz_parse_css( $breadcrumbs_tablet, '', smarttoolz_get_tablet_breakpoint() );
	$css .= smarttoolz_parse_css( $breadcrumbs_mobile, '', smarttoolz_get_mobile_breakpoint() );
	$css .= smarttoolz_parse_css( $breadcrumbs_default_css );
