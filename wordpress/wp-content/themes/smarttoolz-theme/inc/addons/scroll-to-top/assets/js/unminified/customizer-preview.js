...
( function( $ ) {
	...
	smarttoolz_css(
		'smarttoolz-settings[scroll-to-top-icon-size]',
		'font-size',
		'#ast-scroll-top',
		'px'
	);
	smarttoolz_css( 'smarttoolz-settings[scroll-to-top-icon-color]', 'color', '#ast-scroll-top' );
	smarttoolz_css( 'smarttoolz-settings[scroll-to-top-icon-bg-color]', 'background-color', '#ast-scroll-top' );
	smarttoolz_css( 'smarttoolz-settings[scroll-to-top-icon-h-color]', 'color', '#ast-scroll-top:hover' );
	smarttoolz_css( 'smarttoolz-settings[scroll-to-top-icon-h-bg-color]', 'background-color', '#ast-scroll-top:hover' );

	// Border Radius Fields for Button.
	wp.customize( 'smarttoolz-settings[scroll-to-top-icon-radius-fields]', function( value ) {
		value.bind( function( border ) {
			let tablet_break_point    = smarttoolzBuilderPreview.tablet_break_point || 768,
			mobile_break_point    = smarttoolzBuilderPreview.mobile_break_point || 544;
			let dynamicStyle = '';
			...
			smarttoolz_add_dynamic_css( 'scroll-to-top-icon-radius-fields', dynamicStyle );
		} );
	} );

	// Scroll to top position.
	wp.customize( 'smarttoolz-settings[scroll-to-top-icon-position]', function( value ) {
