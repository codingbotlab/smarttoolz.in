 ...
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_ext_transparent_above_header_sections_dynamic_css' );
 ...
 */
function smarttoolz_ext_transparent_above_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	$above_header_layout = smarttoolz_get_option( 'above-header-layout', 'disabled' );

	if ( 'disabled' === $above_header_layout ) {
		return $dynamic_css;
	}

	if ( false == SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() ) {
		return $dynamic_css;
	}
	...
	$transparent_bg_color_tablet  = smarttoolz_get_prop( smarttoolz_get_option( 'transparent-header-bg-color-responsive' ), 'tablet' );
	$transparent_bg_color_mobile  = smarttoolz_get_prop( smarttoolz_get_option( 'transparent-header-bg-color-responsive' ), 'mobile' );
 ...
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_ext_transparent_below_header_sections_dynamic_css' );
 ...
 */
function smarttoolz_ext_transparent_below_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	// set page width depending on site layout.
	$below_header_layout = smarttoolz_get_option( 'below-header-layout', 'disabled' );
