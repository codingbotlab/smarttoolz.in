...
wp.hooks.addFilter(
	...
	'smarttoolz/meta/groupLayoutSettings',
	(settings, name) => {
...
let smarttoolzLastRootBlockOrder = null;
wp.data.subscribe(() => {
	...
	if ( rootBlockOrder === smarttoolzLastRootBlockOrder ) {
		return;
	}
	smarttoolzLastRootBlockOrder = rootBlockOrder;
