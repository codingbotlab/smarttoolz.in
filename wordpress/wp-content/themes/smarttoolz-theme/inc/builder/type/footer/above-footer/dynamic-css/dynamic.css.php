 ...
 * Above Footer CSS
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_fb_above_footer_dynamic_css' );
 ...
 * @since 3.0.0
 */
function smarttoolz_fb_above_footer_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! ( SmartToolz_Builder_Helper::is_footer_row_empty( 'above' ) || is_customize_preview() ) ) {
		return $dynamic_css;
	}
	...
	$footer_bg               = smarttoolz_get_option( 'hba-footer-bg-obj-responsive' );
	$footer_top_border_size  = smarttoolz_get_option( 'hba-footer-separator' );
	$footer_top_border_color = smarttoolz_get_option( 'hba-footer-top-border-color' );
	$footer_height           = smarttoolz_get_option( 'hba-footer-height' );
	$footer_width            = smarttoolz_get_option( 'hba-footer-layout-width' );
	$content_width           = smarttoolz_get_option( 'site-content-width' );
	$inner_spacing           = smarttoolz_get_option( 'hba-inner-spacing' );
	...
	$css_output_desktop = array(
		...
		$selector . ' .ast-builder-grid-row, ' . $selector . ' .site-footer-section' => array(
			'align-items' => smarttoolz_get_option( 'hba-footer-vertical-alignment' ),
		),
