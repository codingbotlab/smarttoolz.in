...
define( 'SMARTTOOLZ_HEADER_ACCOUNT_DIR', SMARTTOOLZ_THEME_DIR . 'inc/builder/type/header/account' );
define( 'SMARTTOOLZ_HEADER_ACCOUNT_URI', SMARTTOOLZ_THEME_URI . 'inc/builder/type/header/account' );

if ( ! class_exists( 'SmartToolz_Header_Account_Component' ) ) {
	 ...
	 * @since 3.0.0
	 */
	class SmartToolz_Header_Account_Component {
		/**
		...
		public function __construct() {
			...
			if ( ! is_admin() || SmartToolz_Builder_Customizer::smarttoolz_collect_customizer_builder_data() ) {
				require_once SMARTTOOLZ_HEADER_ACCOUNT_DIR . '/dynamic-css/dynamic.css.php';
			}
		...
		public static function account_menu_markup() {
			...
			$enable_woo_menu = ( class_exists( 'WooCommerce' ) && 'woocommerce' === $account_type && smarttoolz_get_option( 'header-account-woo-menu' ) );
			 ...
			 * @var Array
			 */
			$menu_classes = apply_filters( 'smarttoolz_menu_classes', array( 'main-header-menu', 'ast-menu-shadow', 'ast-nav-menu', 'ast-account-nav-menu' ) );
			...
			if ( has_nav_menu( $theme_location ) && ! $enable_woo_menu ) {
				...
				$account_menu_markup = $smarttoolz_builder->nofollow_markup( $theme_location, $account_menu_markup );
				...
				echo '<div class="ast-hf-account-menu-wrap ast-main-header-bar-alignment">';
					echo '<div class="account-main-header-bar-navigation">';
						...
						echo ' class="ast-flex-grow-1 navigation-accessibility site-header-focus-item" aria-label="' . esc_attr__( 'Account Woo Navigation', 'smarttoolz' ) . '">';
	 ...
	 */
	new SmartToolz_Header_Account_Component();
