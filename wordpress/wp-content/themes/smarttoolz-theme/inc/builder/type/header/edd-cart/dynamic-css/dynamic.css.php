 ...
 * Search
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_hb_edd_cart_dynamic_css' );
 ...
 * @since 3.0.0
 */
function smarttoolz_hb_edd_cart_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! SmartToolz_Builder_Helper::is_component_loaded( 'edd-cart', 'header' ) ) {
		return $dynamic_css;
	}
	...
	$header_cart_icon_color     = smarttoolz_get_option( 'edd-header-cart-icon-color', $theme_color );
	$header_cart_icon_radius    = smarttoolz_get_option( 'edd-header-cart-icon-radius' );
	$cart_h_color               = smarttoolz_get_foreground_color( $header_cart_icon_color );

	$trans_header_cart_icon_color = smarttoolz_get_option( 'transparent-header-edd-cart-icon-color', $theme_color );
	$trans_header_cart_h_color    = smarttoolz_get_foreground_color( $trans_header_cart_icon_color );
	 ...
	 * - EDD cart styles.
	 */
	$cart_text_color      = smarttoolz_get_option( 'header-edd-cart-text-color' );
	$cart_link_color      = smarttoolz_get_option( 'header-edd-cart-link-color', $link_color );
	$cart_bg_color        = smarttoolz_get_option( 'header-edd-cart-background-color' );
	$cart_separator_color = smarttoolz_get_option( 'header-edd-cart-separator-color' );

	$checkout_button_text_color   = smarttoolz_get_option( 'header-edd-checkout-btn-text-color', $btn_color );
	$checkout_button_bg_color     = smarttoolz_get_option( 'header-edd-checkout-btn-background-color', $btn_bg_color );
	$checkout_button_text_h_color = smarttoolz_get_option( 'header-edd-checkout-btn-text-hover-color', $btn_color );
	$checkout_button_bg_h_color   = smarttoolz_get_option( 'header-edd-checkout-btn-bg-hover-color', $btn_bg_color );
	...
	$css_output_desktop = array(
		...
		$selector . ' .ast-addon-cart-wrap span.smarttoolz-icon:after' => array(
			'color'            => esc_attr( $cart_h_color ),
		...
		$trans_header_cart_selector . ' .ast-addon-cart-wrap span.smarttoolz-icon:after' => array(
	...
	$responsive_selector = '.smarttoolz-cart-drawer.edd-active';
	...
	$css_output_mobile = array(
		...
		$responsive_selector . ' .smarttoolz-cart-drawer-title, ' . $responsive_selector . ' .widget_edd_cart_widget span, ' . $responsive_selector . ' .widget_edd_cart_widget strong, ' . $responsive_selector . ' .widget_edd_cart_widget *' => array(
		...
		$responsive_selector . ' .smarttoolz-cart-drawer-header' => array(
	...
	if ( 'none' !== $header_cart_icon_style ) {
		...
		$header_cart_icon = array(
			...
			$selector . ' .ast-edd-cart-menu-wrap .count' => array(
				'color'        => esc_attr( smarttoolz_get_option( 'edd-header-cart-icon-color' ) ),
				'border-color' => esc_attr( smarttoolz_get_option( 'edd-header-cart-icon-color' ) ),
			),
			...
			$trans_header_cart_selector . ' .ast-edd-cart-menu-wrap .count' => array(
				'color'        => esc_attr( smarttoolz_get_option( 'transparent-header-edd-cart-icon-color' ) ),
				'border-color' => esc_attr( smarttoolz_get_option( 'transparent-header-edd-cart-icon-color' ) ),
			),
			...
			'.ast-edd-site-header-cart.ast-edd-menu-cart-outline .ast-addon-cart-wrap, .ast-edd-site-header-cart.ast-edd-menu-cart-fill .ast-addon-cart-wrap, .ast-edd-site-header-cart.ast-edd-menu-cart-outline .count, .ast-edd-site-header-cart.ast-edd-menu-cart-fill .count, .ast-edd-site-header-cart.ast-edd-menu-cart-outline .ast-addon-cart-wrap .ast-edd-header-cart-info-wrap, .ast-edd-site-header-cart.ast-edd-menu-cart-fill .ast-addon-cart-wrap .ast-edd-header-cart-info-wrap' => array(
				'border-radius' => smarttoolz_get_css_value( $header_cart_icon_radius, 'px' ),
			),
		);
		...
		$header_cart_icon = smarttoolz_parse_css( $header_cart_icon );
	}

	/* Parse CSS from array() */
	$css_output .= $header_cart_icon;

	$css_output .= SmartToolz_Builder_Base_Dynamic_CSS::prepare_visibility_css( 'section-header-edd-cart', '.ast-header-edd-cart' );
