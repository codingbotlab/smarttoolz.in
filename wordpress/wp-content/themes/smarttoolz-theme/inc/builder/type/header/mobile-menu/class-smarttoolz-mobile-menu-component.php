...
define( 'SMARTTOOLZ_BUILDER_MOBILE_MENU_DIR', SMARTTOOLZ_THEME_DIR . 'inc/builder/type/header/mobile-menu' );
define( 'SMARTTOOLZ_BUILDER_MOBILE_MENU_URI', SMARTTOOLZ_THEME_URI . 'inc/builder/type/header/mobile-menu' );
 ...
 * @since 3.0.0
 */
class SmartToolz_Mobile_Menu_Component {
	/**
	...
	public function __construct() {
		...
		if ( ! is_admin() || SmartToolz_Builder_Customizer::smarttoolz_collect_customizer_builder_data() ) {
			require_once SMARTTOOLZ_BUILDER_MOBILE_MENU_DIR . '/dynamic-css/dynamic.css.php';
		}
	...
	public static function menu_markup( $device = 'mobile' ) {
		...
		// Menu Animation.
		$menu_animation = smarttoolz_get_option( 'header-mobile-menu-submenu-container-animation' );
		 ...
		 * @var Array
		 */
		$menu_classes = apply_filters( 'smarttoolz_primary_menu_classes', array( 'main-header-menu', 'ast-nav-menu', 'ast-flex', $submenu_class, $stack_on_mobile_class ) );
		...
		$items_wrap .= smarttoolz_attr(
			...
			array(
				...
				'aria-label' => esc_attr__( 'Site Navigation: ', 'smarttoolz' ) . $menu_name,
			)
		);
		$items_wrap .= '>';
		...
		if ( has_nav_menu( $theme_location ) ) {
			...
			$mobile_menu_markup = $smarttoolz_builder->nofollow_markup( $theme_location, $mobile_menu_markup );
 ...
 */
new SmartToolz_Mobile_Menu_Component();
