 ...
 * Header Menu Colors
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_hb_mobile_menu_dynamic_css', 11 );
 ...
 * @since 3.0.0
 */
function smarttoolz_hb_mobile_menu_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! SmartToolz_Builder_Helper::is_component_loaded( 'mobile-menu', 'header' ) ) {
		return $dynamic_css;
	}
	...
	// Sub Menu.
	$sub_menu_divider_toggle = smarttoolz_get_option( 'header-mobile-menu-submenu-item-border' );
	$sub_menu_divider_size   = smarttoolz_get_option( 'header-mobile-menu-submenu-item-b-size' );
	$sub_menu_divider_color  = smarttoolz_get_option( 'header-mobile-menu-submenu-item-b-color' );

	// Menu.
	$menu_resp_color           = smarttoolz_get_option( 'header-mobile-menu-color-responsive' );
	$menu_resp_bg_color        = smarttoolz_get_option( 'header-mobile-menu-bg-obj-responsive' );
	$menu_resp_color_hover     = smarttoolz_get_option( 'header-mobile-menu-h-color-responsive' );
	$menu_resp_bg_color_hover  = smarttoolz_get_option( 'header-mobile-menu-h-bg-color-responsive' );
	$menu_resp_color_active    = smarttoolz_get_option( 'header-mobile-menu-a-color-responsive' );
	$menu_resp_bg_color_active = smarttoolz_get_option( 'header-mobile-menu-a-bg-color-responsive' );

	$submenu_resp_bg_color = smarttoolz_get_option( 'header-mobile-menu-submenu-bg-color-responsive' );
	...
	// Typography.
	$menu_font_size              = smarttoolz_get_option( 'header-mobile-menu-font-size' );
	...
	// Spacing.
	$menu_spacing = smarttoolz_get_option( 'header-mobile-menu-menu-spacing' );
	...
	$menu_spacing_desktop_top = smarttoolz_responsive_spacing( $menu_spacing, 'top', 'desktop' );
	...
	$css_output_desktop = array(
		...
		$selector . ' .menu-item > .menu-link' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'header-mobile-menu-font-family' ), smarttoolz_get_option( 'header-mobile-menu-font-weight' ), array(), 'font-extras-header-mobile-menu' ),
		$selector                              => array(
	...
	$css_output_desktop[ $selector . ' .main-header-menu, ' . $selector . ' .main-header-menu .menu-link, ' . $selector . ' .main-header-menu .sub-menu' ] = smarttoolz_get_responsive_background_obj( $menu_resp_bg_color, 'desktop' );
	...
	$css_output_tablet[ $selector . ' .main-header-menu , ' . $selector . ' .main-header-menu .menu-link, ' . $selector . ' .main-header-menu .sub-menu' ] = smarttoolz_get_responsive_background_obj( $menu_resp_bg_color, 'tablet' );
	...
	$css_output_mobile[ $selector . ' .main-header-menu, ' . $selector . ' .main-header-menu .menu-link, ' . $selector . ' .main-header-menu .sub-menu' ] = smarttoolz_get_responsive_background_obj( $menu_resp_bg_color, 'mobile' );
	...
	$css_output .= smarttoolz_parse_css( $css_output_desktop_submenu );
	...
	$dynamic_css .= SmartToolz_Builder_Base_Dynamic_CSS::prepare_visibility_css( $_section, $selector, 'block' );
