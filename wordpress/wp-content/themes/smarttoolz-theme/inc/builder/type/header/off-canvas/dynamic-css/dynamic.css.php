 ...
 * Off Canvas Row.
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_off_canvas_row_setting', 11 );
 ...
 * @since 3.0.0
 */
function smarttoolz_off_canvas_row_setting( $dynamic_css, $dynamic_css_filtered = '' ) {

	$selector = '.ast-mobile-popup-drawer.active';
	if ( ! SmartToolz_Builder_Helper::is_component_loaded( 'mobile-trigger', 'header' ) && ! is_customize_preview() ) {
		return $dynamic_css;
	}

	$off_canvas_background       = smarttoolz_get_option( 'off-canvas-background' );
	$off_canvas_close_color      = smarttoolz_get_option( 'off-canvas-close-color' );
	$offcanvas_content_alignment = smarttoolz_get_option( 'header-offcanvas-content-alignment', 'flex-start' );
	$padding                     = smarttoolz_get_option( 'off-canvas-padding' );
	$menu_content_alignment      = 'center';
	$inner_spacing               = smarttoolz_get_option( 'off-canvas-inner-spacing' );
	$mobile_header_type          = smarttoolz_get_option( 'mobile-header-type' );
	$move_body                   = smarttoolz_get_option( 'off-canvas-move-body' );
	$is_site_rtl                 = is_rtl();
	...
	if ( 'off-canvas' === $mobile_header_type || 'full-width' === $mobile_header_type || is_customize_preview() ) {
		$dynamic_css .= smarttoolz_off_canvas_static_css();
	}
	if ( 'dropdown' === $mobile_header_type || is_customize_preview() ) {
		$dynamic_css .= smarttoolz_dropdown_type_static_css();
	}
	...
	$css_output = array(
		...
		$selector . ' .ast-mobile-popup-inner' => smarttoolz_get_background_obj( $off_canvas_background ),

		'.ast-mobile-header-wrap .ast-mobile-header-content, .ast-desktop-header-content' => smarttoolz_get_background_obj( $off_canvas_background ),
		...
		'.ast-mobile-popup-content > *, .ast-mobile-header-content > *, .ast-desktop-popup-content > *, .ast-desktop-header-content > *' => array(
			'padding-top'    => smarttoolz_get_css_value( $inner_spacing, 'px' ),
			'padding-bottom' => smarttoolz_get_css_value( $inner_spacing, 'px' ),
		),
 ...
 * @return string.
 */
function smarttoolz_off_canvas_static_css() {
	$off_canvas_css = '
	...
	.ast-desktop .ast-desktop-popup-content .smarttoolz-menu-animation-slide-up > .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-popup-content .smarttoolz-menu-animation-slide-up > .menu-item .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-popup-content .smarttoolz-menu-animation-slide-down > .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-popup-content .smarttoolz-menu-animation-slide-down > .menu-item .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-popup-content .smarttoolz-menu-animation-fade > .menu-item > .sub-menu,
	.ast-mobile-popup-drawer.show,
	.ast-desktop .ast-desktop-popup-content .smarttoolz-menu-animation-fade > .menu-item .menu-item > .sub-menu{
	  opacity: 1;
	  visibility: visible;
	}';
	...
	return SmartToolz_Enqueue_Scripts::trim_css( $off_canvas_css );
}
 ...
 * @return string.
 */
function smarttoolz_dropdown_type_static_css() {
	$dropdown_type_css = '
	...
	.ast-desktop .ast-desktop-header-content .smarttoolz-menu-animation-slide-up > .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-header-content .smarttoolz-menu-animation-slide-up > .menu-item .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-header-content .smarttoolz-menu-animation-slide-down > .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-header-content .smarttoolz-menu-animation-slide-down > .menu-item .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-header-content .smarttoolz-menu-animation-fade > .menu-item > .sub-menu,
	.ast-desktop .ast-desktop-header-content .smarttoolz-menu-animation-fade > .menu-item .menu-item > .sub-menu {
	  opacity: 1;
	  visibility: visible;
	}
	...
	return SmartToolz_Enqueue_Scripts::trim_css( $dropdown_type_css );
}
