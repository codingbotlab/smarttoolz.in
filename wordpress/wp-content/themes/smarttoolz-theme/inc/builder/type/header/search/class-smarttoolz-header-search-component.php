...
define( 'SMARTTOOLZ_HEADER_SEARCH_DIR', SMARTTOOLZ_THEME_DIR . 'inc/builder/type/header/search' );
define( 'SMARTTOOLZ_HEADER_SEARCH_URI', SMARTTOOLZ_THEME_URI . 'inc/builder/type/header/search' );
 ...
 * @since 3.0.0
 */
class SmartToolz_Header_Search_Component {
	/**
	...
	public function __construct() {
		...
		require_once SMARTTOOLZ_HEADER_SEARCH_DIR . '/class-smarttoolz-header-search-component-loader.php';

		// Include front end files.
		if ( ! is_admin() || SmartToolz_Builder_Customizer::smarttoolz_collect_customizer_builder_data() ) {
			require_once SMARTTOOLZ_HEADER_SEARCH_DIR . '/dynamic-css/dynamic.css.php';
		}
		// @codingStandardsIgnoreEnd WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

		add_filter( 'rest_post_query', array( $this, 'smarttoolz_update_rest_post_query' ), 10, 2 );
	}
	 ...
	 * @return array
	 */
	public function smarttoolz_update_rest_post_query( $args, $request ) {
		if (
			 ...
			 */
			$args = apply_filters( 'smarttoolz_live_search_query_args', $args, $request );
		}
 ...
 */
new SmartToolz_Header_Search_Component();
