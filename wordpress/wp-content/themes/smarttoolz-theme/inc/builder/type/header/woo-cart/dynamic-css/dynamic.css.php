 ...
 * Search
 */
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_hb_woo_cart_dynamic_css' );

if ( ! function_exists( 'smarttoolz_cart_position' ) ) {
	/**
	 * Position markup
	 *
	 * @since 3.9.0
	 ...
	 * @return array
	 */
	function smarttoolz_cart_position( $postion, $device ) {
		switch ( $postion ) {
			case 'bottom':
				return array(
 ...
 * @since 3.0.0
 */
function smarttoolz_hb_woo_cart_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! SmartToolz_Builder_Helper::is_component_loaded( 'woo-cart', 'header' ) ) {
		return $dynamic_css;
	}
	...
	$icon_color            = esc_attr( smarttoolz_get_option( 'header-woo-cart-icon-color', $theme_color ) );
	$icon_hover_color      = esc_attr( smarttoolz_get_option( 'header-woo-cart-icon-hover-color' ) ); // icon cart hover color.

	$header_cart_icon_radius_fields  = smarttoolz_get_option( 'woo-header-cart-icon-radius-fields' );
	$cart_h_color                    = smarttoolz_get_foreground_color( $icon_color );
	$header_cart_icon_style          = smarttoolz_get_option( 'woo-header-cart-icon-style' );
	$theme_h_color                   = smarttoolz_get_foreground_color( $theme_color );
	$cart_products_count_color       = smarttoolz_get_option( 'woo-header-cart-product-count-color', $theme_h_color );
	$cart_products_count_color_hover = smarttoolz_get_option( 'woo-header-cart-product-count-h-color' );

	$transparent_header_icon_color   = esc_attr( smarttoolz_get_option( 'transparent-header-woo-cart-icon-color', $icon_color ) );
	$transparent_header_cart_h_color = smarttoolz_get_foreground_color( $transparent_header_icon_color );
	$header_woo_cart_list            = smarttoolz_get_option( 'woo-header-cart-icon', 'default' );
	 ...
	 */
	$cart_text_color        = smarttoolz_get_option( 'header-woo-cart-text-color' );
	$cart_link_color        = smarttoolz_get_option( 'header-woo-cart-link-color' );
	$cart_bg_color          = smarttoolz_get_option( 'header-woo-cart-background-color' );
	$cart_h_bg_color        = smarttoolz_get_option( 'header-woo-cart-background-hover-color' );
	$cart_separator_color   = smarttoolz_get_option( 'header-woo-cart-separator-color' );
	$cart_h_link_color      = smarttoolz_get_option( 'header-woo-cart-link-hover-color' );
	$cart_button_text_color = smarttoolz_get_option( 'header-woo-cart-btn-text-color' );
	$cart_icon_size         = smarttoolz_get_option( 'header-woo-cart-icon-size' );

	$cart_button_bg_color     = smarttoolz_get_option( 'header-woo-cart-btn-background-color' );
	$cart_button_text_h_color = smarttoolz_get_option( 'header-woo-cart-btn-text-hover-color' );
	$cart_button_bg_h_color   = smarttoolz_get_option( 'header-woo-cart-btn-bg-hover-color' );

	$checkout_button_text_color   = smarttoolz_get_option( 'header-woo-checkout-btn-text-color' );
	$checkout_button_bg_color     = smarttoolz_get_option( 'header-woo-checkout-btn-background-color' );
	$checkout_button_text_h_color = smarttoolz_get_option( 'header-woo-checkout-btn-text-hover-color' );
	$checkout_button_bg_h_color   = smarttoolz_get_option( 'header-woo-checkout-btn-bg-hover-color' );
	$cart_total_label_position    = smarttoolz_get_option( 'woo-header-cart-icon-total-label-position' );
	$cart_badge_display           = smarttoolz_get_option( 'woo-header-cart-badge-display' );

	$check_transparent_is_enabled_on = smarttoolz_get_option( 'transparent-header-on-devices' );
	...
	$css_output_desktop = array(
		...
		$selector . ' .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
			'color'            => esc_attr( $theme_h_color ),
			'background-color' => esc_attr( $icon_color ),
		),
		'.ast-icon-shopping-bag .ast-icon svg, .ast-icon-shopping-cart .ast-icon svg, .ast-icon-shopping-basket .ast-icon svg' => array(
			'height' => smarttoolz_get_css_value( $cart_icon_size_desktop, 'px' ),
			'width'  => smarttoolz_get_css_value( $cart_icon_size_desktop, 'px' ),
		),
		'.ast-cart-menu-wrap, i.smarttoolz-icon.ast-icon-shopping-' . $header_woo_cart_list => array(
			'font-size' => smarttoolz_get_css_value( $cart_icon_size_desktop, 'px' ),
		),
		 ...
		 */
		'.ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a:not(.button), .smarttoolz-cart-drawer .widget_shopping_cart_content a:not(.button)' => array(
		...
		'.ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a:not(.button):hover, .smarttoolz-cart-drawer .widget_shopping_cart_content a:not(.button):hover' => array(
			'color' => esc_attr( $cart_h_link_color_desktop ),
		),
		'.ast-site-header-cart .woocommerce.widget_shopping_cart, div.smarttoolz-cart-drawer ' => array(
			'background-color' => esc_attr( $cart_bg_color_desktop ),
			'border-color'     => esc_attr( $cart_bg_color_desktop ),
		),
		'.ast-site-header-cart .widget_shopping_cart:hover, .smarttoolz-cart-drawer:hover' => array(
			'background-color' => esc_attr( $cart_h_bg_color_desktop ),
			'border-color'     => esc_attr( $cart_h_bg_color_desktop ),
		),
		'.ast-site-header-cart .widget_shopping_cart .woocommerce-mini-cart__total, .smarttoolz-cart-drawer .smarttoolz-cart-drawer-, .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__total, .smarttoolz-cart-drawer .smarttoolz-cart-drawer-header' => array(
			'border-top-color'    => esc_attr( $cart_separator_color_desktop ),
			'border-bottom-color' => esc_attr( $cart_separator_color_desktop ),
		),
		'.ast-site-header-cart .widget_shopping_cart .mini_cart_item,.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .widget_shopping_cart_content ul li' => array(
			'border-bottom-color' => $cart_separator_color_desktop ? smarttoolz_hex_to_rgba( $cart_separator_color_desktop ) : '',
		),
		 ...
		 */
		'.ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a.button.wc-forward:not(.checkout), .woocommerce-js .smarttoolz-cart-drawer .widget_shopping_cart_content a.button.wc-forward:not(.checkout), .ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a.button.wc-forward:not(.checkout),  .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping)' => array(
			'color'            => esc_attr( $cart_button_text_color_desktop ),
			'background-color' => esc_attr( $cart_button_bg_color_desktop ),
		),
		'.ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a.button.wc-forward:not(.checkout):hover, .woocommerce-js .smarttoolz-cart-drawer .widget_shopping_cart_content a.button.wc-forward:not(.checkout):hover, .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping):hover' => array(
		 ...
		 */
		'.ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a.button.checkout.wc-forward, .smarttoolz-cart-drawer .widget_shopping_cart_content a.button.checkout.wc-forward' => array(
		...
		'.ast-site-header-cart .ast-site-header-cart-data .widget_shopping_cart_content a.button.checkout.wc-forward:hover, .smarttoolz-cart-drawer .widget_shopping_cart_content a.button.checkout.wc-forward:hover' => array(
			'color'            => esc_attr( $checkout_button_text_h_color_desktop ),
			'background-color' => esc_attr( $checkout_button_bg_h_color_desktop ),
		),

		'.ast-site-header-cart .ast-addon-cart-wrap i.smarttoolz-icon:after, .ast-theme-transparent-header .ast-site-header-cart .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
			'color' => esc_attr( $cart_products_count_color ),
		),
	);

	// Offcanvas cart.
	$flyout_cart_width              = smarttoolz_get_option( 'woo-slide-in-cart-width' );
	...
	if ( 'flyout' === smarttoolz_get_option( 'woo-header-cart-click-action' ) || is_customize_preview() ) {
		$desktop_flyout_cart_direction = smarttoolz_get_option( 'woo-desktop-cart-flyout-direction' );
		...
		$css_output_desktop['.ast-desktop .smarttoolz-cart-drawer'] = array(
			'width' => smarttoolz_get_css_value( $flyout_cart_width_desktop, $flyout_cart_width_desktop_unit ),
		);
		if ( 'left' === $desktop_flyout_cart_direction ) {
			$css_output_desktop['.ast-desktop .smarttoolz-cart-drawer']        = array(
				'width' => smarttoolz_get_css_value( $flyout_cart_width_desktop, $flyout_cart_width_desktop_unit ),
				'left'  => '-' . smarttoolz_get_css_value( $flyout_cart_width_desktop, $flyout_cart_width_desktop_unit ),
			);
			$css_output_desktop['.ast-desktop .smarttoolz-cart-drawer.active'] = array(
				'left' => smarttoolz_get_css_value( $flyout_cart_width_desktop, $flyout_cart_width_desktop_unit ),
			);
		}
	}
	...
	$responsive_selector = '.smarttoolz-cart-drawer';

	$css_output_mobile = array(
		$responsive_selector . ' .smarttoolz-cart-drawer-title, ' . $responsive_selector . ' .widget_shopping_cart_content span, ' . $responsive_selector . ' .widget_shopping_cart_content strong,' . $responsive_selector . ' .woocommerce-mini-cart__empty-message, .smarttoolz-cart-drawer .woocommerce-mini-cart *' => array(
		...
		$responsive_selector . '#smarttoolz-mobile-cart-drawer' => array(
			'background-color' => esc_attr( $cart_bg_color_mobile ),
			'border-color'     => esc_attr( $cart_bg_color_mobile ),
		),
		$responsive_selector . '#smarttoolz-mobile-cart-drawer:hover' => array(
			'background-color' => esc_attr( $cart_h_bg_color_mobile ),
			'border-color'     => esc_attr( $cart_h_bg_color_mobile ),
		),
		'#smarttoolz-mobile-cart-drawer:hover .widget_shopping_cart:before, #smarttoolz-mobile-cart-drawer:hover .widget_shopping_cart:after, .open-preview-woocommerce-cart #smarttoolz-mobile-cart-drawer .widget_shopping_cart:before' => array(
		...
		'#smarttoolz-mobile-cart-drawer .widget_shopping_cart .woocommerce-mini-cart__total, .smarttoolz-cart-drawer .smarttoolz-cart-drawer-header' => array(
			'border-top-color'    => esc_attr( $cart_separator_color_mobile ),
			'border-bottom-color' => esc_attr( $cart_separator_color_mobile ),
		),
		'#smarttoolz-mobile-cart-drawer .widget_shopping_cart .mini_cart_item' => array(
			'border-bottom-color' => $cart_separator_color_mobile ? smarttoolz_hex_to_rgba( $cart_separator_color_mobile ) : '',
		),
		...
		$responsive_selector . '.ast-icon-shopping-bag .ast-icon svg, .ast-icon-shopping-cart .ast-icon svg, .ast-icon-shopping-basket .ast-icon svg' => array(
			'height' => smarttoolz_get_css_value( $cart_icon_size_mobile, 'px' ),
			'width'  => smarttoolz_get_css_value( $cart_icon_size_mobile, 'px' ),
		),
		'.ast-header-break-point.ast-hfb-header .ast-cart-menu-wrap, i.smarttoolz-icon.ast-icon-shopping-' . $header_woo_cart_list => array(
			'font-size' => smarttoolz_get_css_value( $cart_icon_size_mobile, 'px' ),
		),
		...
		$responsive_selector . '.active'                   => array(
			'width' => smarttoolz_get_css_value( $flyout_cart_width_mobile, $flyout_cart_width_mobile_unit ),
		),
		 ...
		 * Cart button color for widget
		 */
		'.woocommerce-js ' . $responsive_selector . ' .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping)' => array(
			'color'            => esc_attr( $cart_button_text_color_mobile ),
			'background-color' => esc_attr( $cart_button_bg_color_mobile ),
		),
		'.woocommerce-js ' . $responsive_selector . ' .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping):hover' => array(
	...
	$css_output_tablet = array(
		...
		'#smarttoolz-mobile-cart-drawer .widget_shopping_cart .mini_cart_item' => array(
			'border-bottom-color' => $cart_separator_color_tablet ? smarttoolz_hex_to_rgba( $cart_separator_color_tablet ) : '',
		),
		$responsive_selector . ' .widget_shopping_cart_content a:not(.button):hover' => array(
			'color' => esc_attr( $cart_h_link_color_tablet ),
		),
		$responsive_selector . '.ast-icon-shopping-bag .ast-icon svg, .ast-icon-shopping-cart .ast-icon svg, .ast-icon-shopping-basket .ast-icon svg' => array(
			'height' => smarttoolz_get_css_value( $cart_icon_size_tablet, 'px' ),
			'width'  => smarttoolz_get_css_value( $cart_icon_size_tablet, 'px' ),
		),
		'.ast-header-break-point.ast-hfb-header .ast-cart-menu-wrap, i.smarttoolz-icon.ast-icon-shopping-' . $header_woo_cart_list => array(
			'font-size' => smarttoolz_get_css_value( $cart_icon_size_tablet, 'px' ),
		),
		 ...
		 */
		$responsive_selector . '.active'                   => array(
			'width' => smarttoolz_get_css_value( $flyout_cart_width_tablet, $flyout_cart_width_tablet_unit ),
		),
	...
	if ( 'none' !== $header_cart_icon_style ) {
		...
		if ( function_exists( 'smarttoolz_has_pro_woocommerce_addon' ) && ! smarttoolz_has_pro_woocommerce_addon() && 'outline' === $header_cart_icon_style && 'default' !== $header_woo_cart_list ) {
			$border_width             = smarttoolz_get_option( 'woo-header-cart-border-width' );
			$header_cart_icon_outline = array(
				'.ast-menu-cart-outline .ast-cart-menu-wrap .count, .ast-menu-cart-outline .ast-addon-cart-wrap'  => array(
					...
					'border-width' => smarttoolz_get_css_value( $border_width, 'px' ),
				),
			);

			$css_output .= smarttoolz_parse_css( $header_cart_icon_outline );
		}
		...
		$header_cart_icon = array(
			...
			'.ast-site-header-cart.ast-menu-cart-outline .ast-cart-menu-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-cart-menu-wrap, .ast-site-header-cart.ast-menu-cart-outline .ast-cart-menu-wrap .count, .ast-site-header-cart.ast-menu-cart-fill .ast-cart-menu-wrap .count, .ast-site-header-cart.ast-menu-cart-outline .ast-addon-cart-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-addon-cart-wrap, .ast-site-header-cart.ast-menu-cart-outline .ast-woo-header-cart-info-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-woo-header-cart-info-wrap' => array(
				'border-top-left-radius'     => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'top', 'desktop' ),
				'border-top-right-radius'    => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'right', 'desktop' ),
				'border-bottom-right-radius' => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'bottom', 'desktop' ),
				'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'left', 'desktop' ),
			),
		...
		$header_cart_icon_tablet = array(
			// Border radius.
			'.ast-site-header-cart.ast-menu-cart-outline .ast-cart-menu-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-cart-menu-wrap, .ast-site-header-cart.ast-menu-cart-outline .ast-cart-menu-wrap .count, .ast-site-header-cart.ast-menu-cart-fill .ast-cart-menu-wrap .count, .ast-site-header-cart.ast-menu-cart-outline .ast-addon-cart-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-addon-cart-wrap, .ast-site-header-cart.ast-menu-cart-outline .ast-woo-header-cart-info-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-woo-header-cart-info-wrap' => array(
				'border-top-left-radius'     => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'top', 'tablet' ),
				'border-top-right-radius'    => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'right', 'tablet' ),
				'border-bottom-right-radius' => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'bottom', 'tablet' ),
				'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'left', 'tablet' ),
			),
		...
		$header_cart_icon_mobile = array(
			// Border radius.
			'.ast-site-header-cart.ast-menu-cart-outline .ast-cart-menu-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-cart-menu-wrap, .ast-site-header-cart.ast-menu-cart-outline .ast-cart-menu-wrap .count, .ast-site-header-cart.ast-menu-cart-fill .ast-cart-menu-wrap .count, .ast-site-header-cart.ast-menu-cart-outline .ast-addon-cart-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-addon-cart-wrap, .ast-site-header-cart.ast-menu-cart-outline .ast-woo-header-cart-info-wrap, .ast-site-header-cart.ast-menu-cart-fill .ast-woo-header-cart-info-wrap' => array(
				'border-top-left-radius'     => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'top', 'mobile' ),
				'border-top-right-radius'    => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'right', 'mobile' ),
				'border-bottom-right-radius' => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'bottom', 'mobile' ),
				'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $header_cart_icon_radius_fields, 'left', 'mobile' ),
			),
		);

		// We adding this conditional CSS only to maintain backwards. Remove this condition after 2-3 updates of add-on.
		if ( defined( 'SMARTTOOLZ_EXT_VER' ) && version_compare( SMARTTOOLZ_EXT_VER, '3.4.2', '<' ) ) {
		...
		$css_output .= smarttoolz_parse_css( $header_cart_icon );
		$css_output .= smarttoolz_parse_css( $header_cart_icon_tablet, '', smarttoolz_get_tablet_breakpoint() );
		$css_output .= smarttoolz_parse_css( $header_cart_icon_mobile, '', smarttoolz_get_mobile_breakpoint() );
	}
	...
	$remove_when_transparent_header = array(
		...
		'.ast-menu-cart-fill .ast-site-header-cart-li:hover .ast-cart-menu-wrap .count, .ast-menu-cart-fill .ast-site-header-cart-li:hover .ast-cart-menu-wrap, .ast-menu-cart-fill .ast-site-header-cart-li:hover .ast-addon-cart-wrap, .ast-menu-cart-fill .ast-site-header-cart-li:hover .ast-addon-cart-wrap .ast-woo-header-cart-info-wrap, .ast-menu-cart-fill .ast-site-header-cart-li:hover .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
		...
		$selector . ' .ast-site-header-cart-li:hover .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
			'color'            => esc_attr( $theme_h_color ),
			'background-color' => $icon_hover_color,
		),

		// Label/Fill icon hover Color.
		'.ast-site-header-cart-li:hover .ast-woo-header-cart-info-wrap,' . $selector . ' .ast-site-header-cart-li:hover .ast-addon-cart-wrap, .ast-menu-cart-outline .ast-site-header-cart-li:hover .ast-addon-cart-wrap .smarttoolz-icon' => array(
			'color' => $icon_hover_color,
		),
		...
		'.ast-site-header-cart.ast-menu-cart-fill .ast-site-header-cart-li:hover .smarttoolz-icon' => array(
			'color' => $cart_h_color,
		),
	...
	if ( 'default' !== $header_woo_cart_list ) {
		...
		if ( ! SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() ) {
			$css_output .= smarttoolz_parse_css( $svg_cart_icon_not_transparent );
		}
	}

	$remove_when_tp_header = array(
		'.ast-site-header-cart .ast-site-header-cart-li:hover .ast-addon-cart-wrap i.smarttoolz-icon:after, .ast-theme-transparent-header .ast-site-header-cart .ast-site-header-cart-li:hover .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
			'color' => esc_attr( $cart_products_count_color_hover ),
		),
	);

	if ( $check_transparent_is_enabled_on && 'desktop' !== $check_transparent_is_enabled_on && 'both' !== $check_transparent_is_enabled_on ) {
		$css_output .= smarttoolz_parse_css( $remove_when_tp_header, smarttoolz_get_tablet_breakpoint( '', 1 ) );
	}

	if ( $check_transparent_is_enabled_on && 'mobile' !== $check_transparent_is_enabled_on && 'both' !== $check_transparent_is_enabled_on ) {
		$css_output .= smarttoolz_parse_css( $remove_when_tp_header, '', smarttoolz_get_tablet_breakpoint() );
	}
	...
	$add_when_transparent_header = array(
		...
		$trans_header_selector . ' .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
	...
	if ( ! SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() ) {
		$css_output .= smarttoolz_parse_css( $remove_when_transparent_header );
	}

	if ( SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() ) {

		/** @psalm-suppress InvalidScalarArgument  */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		$tablet_breakpoint = smarttoolz_get_tablet_breakpoint( '', 1 );

		if ( $check_transparent_is_enabled_on && 'desktop' !== $check_transparent_is_enabled_on && 'both' !== $check_transparent_is_enabled_on ) {
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$css_output .= smarttoolz_parse_css( $remove_when_transparent_header, $tablet_breakpoint, '' );
		}

		if ( $check_transparent_is_enabled_on && 'mobile' !== $check_transparent_is_enabled_on && 'both' !== $check_transparent_is_enabled_on ) {
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$css_output .= smarttoolz_parse_css( $remove_when_transparent_header, '', smarttoolz_get_tablet_breakpoint() );
		}

		if ( $check_transparent_is_enabled_on && 'desktop' === $check_transparent_is_enabled_on ) {
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$css_output .= smarttoolz_parse_css( $add_when_transparent_header, $tablet_breakpoint, '' );
		} elseif ( $check_transparent_is_enabled_on && 'mobile' === $check_transparent_is_enabled_on ) {
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$css_output .= smarttoolz_parse_css( $add_when_transparent_header, '', smarttoolz_get_tablet_breakpoint() );
		} else {
			$css_output .= smarttoolz_parse_css( $add_when_transparent_header );
		}
	}
	...
	if ( false === $cart_badge_display ) {
		$css_badge_output = array(
			'.smarttoolz-icon.smarttoolz-icon::after' => array(
				'display' => 'none',
			),
			...
			$css_output  .= smarttoolz_parse_css( $css_badge_output );
	}

	/**
	 * Added for the Cart total label badge position
	 */
	$cart_dynamic_label = smarttoolz_get_option( 'woo-header-cart-label-display' );
	if ( ! empty( $cart_dynamic_label ) ) {
		...
		$css_total_position_common_selector = array(
			...
			'.smarttoolz-icon'                           => array(
				'line-height' => 0.1,
			),
		);

		$css_output .= smarttoolz_parse_css( $css_total_position_common_selector );
	}

	if ( 'default' !== $header_woo_cart_list ) {

		$svg_cart_icon_not_transparent = array(
			'.ast-site-header-cart .ast-site-header-cart-li:hover .ast-addon-cart-wrap i.smarttoolz-icon:after' => array(
				'color' => esc_attr( $cart_products_count_color_hover ),
			),
		);
	...
	if ( $cart_label_position_desktop ) {
		$cart_l_p_desktop = smarttoolz_cart_position( $cart_label_position_desktop, 'desktop' );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		$css_output .= smarttoolz_parse_css( $cart_l_p_desktop, smarttoolz_get_tablet_breakpoint( '', '1' ) );
	}
	if ( $cart_label_position_mobile ) {
		$cart_l_p_mobile = smarttoolz_cart_position( $cart_label_position_mobile, 'mobile' );
	}
	if ( $cart_label_position_tablet ) {
		$cart_l_p_tablet = smarttoolz_cart_position( $cart_label_position_tablet, 'tablet' );
	}
	/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$css_output .= smarttoolz_parse_css( $cart_l_p_tablet, smarttoolz_get_mobile_breakpoint( '', '1' ), smarttoolz_get_tablet_breakpoint() );
	/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$css_output .= smarttoolz_parse_css( $cart_l_p_mobile, '', smarttoolz_get_mobile_breakpoint( '', '1' ) );
	...
	$css_output      .= smarttoolz_parse_css( $angle_transition );

	$css_output .= SmartToolz_Extended_Base_Dynamic_CSS::prepare_advanced_margin_padding_css( 'section-header-woo-cart', '.woocommerce .ast-header-woo-cart .ast-site-header-cart .ast-addon-cart-wrap, .ast-header-woo-cart .ast-site-header-cart .ast-addon-cart-wrap' );
	$css_output .= SmartToolz_Builder_Base_Dynamic_CSS::prepare_visibility_css( 'section-header-woo-cart', '.ast-header-woo-cart' );
