<?php
/**
 * Custom Styling output for SmartToolz Theme.
 *
 * @package     SmartToolz
 * @subpackage  Class
 ...
 * Dynamic CSS
 */
if ( ! class_exists( 'SmartToolz_Dynamic_CSS' ) ) {

	/**
	 * Dynamic CSS
	 */
	class SmartToolz_Dynamic_CSS {
		/**
		 * Return CSS Output
		 *
		...
		public static function return_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			$narrow_container_max_width = smarttoolz_get_option( 'narrow-container-max-width', apply_filters( 'smarttoolz_narrow_container_width', 750 ) );
			$header_logo_width          = smarttoolz_get_option( 'ast-header-responsive-logo-width' );
			$container_layout           = smarttoolz_toggle_layout( 'ast-site-content-layout', 'global', false );

			// Get the Global Container Layout based on Global Boxed and Global Sidebar Style.
			if ( 'plain-container' === $container_layout ) {
				$is_boxed         = ( 'boxed' === smarttoolz_get_option( 'site-content-style' ) );
				$is_sidebar_boxed = ( 'boxed' === smarttoolz_get_option( 'site-sidebar-style' ) );
				$sidebar_layout   = smarttoolz_get_option( 'site-sidebar-layout' );
				...
				if ( 'no-sidebar' === $sidebar_layout ) {
					...
					if ( $is_boxed ) {
						 ...
						 * Container unboxed css is applied through smarttoolz_apply_unboxed_container()
						 */
						$container_layout = 'boxed-container';
					}
				}
			...
			$title_color                = smarttoolz_get_option( 'header-color-site-title' );
			$title_hover_color          = smarttoolz_get_option( 'header-color-h-site-title' );
			$tagline_color              = smarttoolz_get_option( 'header-color-site-tagline' );
			$site_title_setting         = smarttoolz_get_option( 'display-site-title-responsive' );
			...
			$site_tagline_setting       = smarttoolz_get_option( 'display-site-tagline-responsive' );
			...
			$box_bg_obj = smarttoolz_get_option( 'site-layout-outside-bg-obj-responsive' );

			// Override page background with meta value if set.
			$meta_background_enabled = smarttoolz_get_option_meta( 'ast-page-background-enabled' );

			// Check for third party pages meta.
			if ( '' === $meta_background_enabled && smarttoolz_with_third_party() ) {
				$meta_background_enabled = smarttoolz_third_party_archive_meta( 'ast-page-background-enabled' );
				if ( isset( $meta_background_enabled ) && 'enabled' === $meta_background_enabled ) {
					$box_bg_obj = smarttoolz_third_party_archive_meta( 'ast-page-background-meta' );
				}
			} elseif ( isset( $meta_background_enabled ) && 'enabled' === $meta_background_enabled ) {
				$box_bg_obj = smarttoolz_get_option_meta( 'ast-page-background-meta' );
			}

			// Color Options.
			$text_color         = smarttoolz_get_option( 'text-color' );
			$theme_color        = smarttoolz_get_option( 'theme-color' );
			$link_color         = smarttoolz_get_option( 'link-color', $theme_color );
			$link_hover_color   = smarttoolz_get_option( 'link-h-color' );
			$heading_base_color = smarttoolz_get_option( 'heading-base-color' );

			// Typography.
			$body_font_size       = smarttoolz_get_option( 'font-size-body' );
			$body_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'body-font-extras' ), 'line-height', 'line-height-unit' );
			$para_margin_bottom   = smarttoolz_get_option( 'para-margin-bottom' );
			$body_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'body-font-extras' ), 'text-transform' );
			$body_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'body-font-extras' ), 'letter-spacing', 'letter-spacing-unit' );
			$body_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'body-font-extras' ), 'text-decoration' );

			$site_title_font_size   = smarttoolz_get_option( 'font-size-site-title' );
			$site_tagline_font_size = smarttoolz_get_option( 'font-size-site-tagline' );

			$archive_post_title_font_size = smarttoolz_get_option( 'font-size-page-title' );
			$archive_post_meta_font_size  = smarttoolz_get_option( 'font-size-post-meta' );
			$archive_post_tax_font_size   = smarttoolz_get_option( 'font-size-post-tax' );
			$archive_cards_radius         = smarttoolz_get_option( 'post-card-border-radius' );
			$content_background_overlay   = smarttoolz_get_option( 'post-card-background-overlay' );

			$heading_h1_font_size = smarttoolz_get_option( 'font-size-h1' );
			$heading_h2_font_size = smarttoolz_get_option( 'font-size-h2' );
			$heading_h3_font_size = smarttoolz_get_option( 'font-size-h3' );
			$heading_h4_font_size = smarttoolz_get_option( 'font-size-h4' );
			$heading_h5_font_size = smarttoolz_get_option( 'font-size-h5' );
			$heading_h6_font_size = smarttoolz_get_option( 'font-size-h6' );

			/**
			 * Heading Typography - h1 - h3.
			 */
			$headings_font_family    = smarttoolz_get_option( 'headings-font-family' );
			$headings_font_weight    = smarttoolz_get_option( 'headings-font-weight' );
			$headings_line_height    = smarttoolz_get_font_extras( smarttoolz_get_option( 'headings-font-extras' ), 'line-height', 'line-height-unit' );
			$headings_font_transform = smarttoolz_get_font_extras( smarttoolz_get_option( 'headings-font-extras' ), 'text-transform' );

			$h1_font_family     = smarttoolz_get_option( 'font-family-h1' );
			$h1_font_weight     = smarttoolz_get_option( 'font-weight-h1' );
			$h1_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h1' ), 'line-height', 'line-height-unit' );
			$h1_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h1' ), 'text-transform' );
			$h1_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h1' ), 'letter-spacing', 'letter-spacing-unit' );
			$h1_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h1' ), 'text-decoration' );

			$h2_font_family     = smarttoolz_get_option( 'font-family-h2' );
			$h2_font_weight     = smarttoolz_get_option( 'font-weight-h2' );
			$h2_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h2' ), 'line-height', 'line-height-unit' );
			$h2_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h2' ), 'text-transform' );
			$h2_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h2' ), 'letter-spacing', 'letter-spacing-unit' );
			$h2_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h2' ), 'text-decoration' );

			$h3_font_family     = smarttoolz_get_option( 'font-family-h3' );
			$h3_font_weight     = smarttoolz_get_option( 'font-weight-h3' );
			$h3_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h3' ), 'line-height', 'line-height-unit' );
			$h3_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h3' ), 'text-transform' );
			$h3_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h3' ), 'letter-spacing', 'letter-spacing-unit' );
			$h3_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h3' ), 'text-decoration' );
			...
			$update_customizer_strctural_defaults = smarttoolz_check_is_structural_setup();
			$blog_layout                          = smarttoolz_get_blog_layout();
			...
			if ( smarttoolz_has_gcp_typo_preset_compatibility() ) {
				...
				$h4_font_family     = smarttoolz_get_option( 'font-family-h4' );
				$h4_font_weight     = smarttoolz_get_option( 'font-weight-h4' );
				$h4_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h4' ), 'line-height', 'line-height-unit' );
				$h4_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h4' ), 'text-transform' );
				$h4_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h4' ), 'letter-spacing', 'letter-spacing-unit' );
				$h4_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h4' ), 'text-decoration' );

				$h5_font_family     = smarttoolz_get_option( 'font-family-h5' );
				$h5_font_weight     = smarttoolz_get_option( 'font-weight-h5' );
				$h5_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h5' ), 'line-height', 'line-height-unit' );
				$h5_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h5' ), 'text-transform' );
				$h5_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h5' ), 'letter-spacing', 'letter-spacing-unit' );
				$h5_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h5' ), 'text-decoration' );

				$h6_font_family     = smarttoolz_get_option( 'font-family-h6' );
				$h6_font_weight     = smarttoolz_get_option( 'font-weight-h6' );
				$h6_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h6' ), 'line-height', 'line-height-unit' );
				$h6_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h6' ), 'text-transform' );
				$h6_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h6' ), 'letter-spacing', 'letter-spacing-unit' );
				$h6_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-h6' ), 'text-decoration' );
			...
			// Button Styling.
			$btn_border_radius_fields = smarttoolz_get_option( 'button-radius-fields' );
			$theme_btn_padding        = smarttoolz_get_option( 'theme-button-padding' );
			$highlight_theme_color    = smarttoolz_get_foreground_color( $theme_color );
			$button_styling_improved  = self::smarttoolz_4_6_4_compatibility();

			// Submenu Border color.
			$submenu_border               = smarttoolz_get_option( 'primary-submenu-border' );
			$primary_submenu_item_border  = smarttoolz_get_option( 'primary-submenu-item-border' );
			$primary_submenu_b_color      = smarttoolz_get_option( 'primary-submenu-b-color', $theme_color );
			$primary_submenu_item_b_color = smarttoolz_get_option( 'primary-submenu-item-b-color', '#eaeaea' );

			// SmartToolz and WordPress-5.8 compatibility.
			...
			$improve_gb_ui = smarttoolz_get_option( 'improve-gb-editor-ui', true );
			/** @psalm-suppress InvalidScalarArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

			$block_editor_legacy_setup = smarttoolz_block_based_legacy_setup();

			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				// Footer Bar Colors.
				$footer_bg_obj       = smarttoolz_get_option( 'footer-bg-obj' );
				$footer_color        = smarttoolz_get_option( 'footer-color' );
				$footer_link_color   = smarttoolz_get_option( 'footer-link-color' );
				$footer_link_h_color = smarttoolz_get_option( 'footer-link-h-color' );

				// Color.
				$footer_adv_bg_obj             = smarttoolz_get_option( 'footer-adv-bg-obj' );
				$footer_adv_text_color         = smarttoolz_get_option( 'footer-adv-text-color' );
				$footer_adv_widget_title_color = smarttoolz_get_option( 'footer-adv-wgt-title-color' );
				$footer_adv_link_color         = smarttoolz_get_option( 'footer-adv-link-color' );
				$footer_adv_link_h_color       = smarttoolz_get_option( 'footer-adv-link-h-color' );

				// Header Break Point.
				$header_break_point = smarttoolz_header_break_point();

				// Custom Buttom menu item.
				$header_custom_button_style          = smarttoolz_get_option( 'header-main-rt-section-button-style' );
				$header_custom_button_text_color     = smarttoolz_get_option( 'header-main-rt-section-button-text-color' );
				$header_custom_button_text_h_color   = smarttoolz_get_option( 'header-main-rt-section-button-text-h-color' );
				$header_custom_button_back_color     = smarttoolz_get_option( 'header-main-rt-section-button-back-color' );
				$header_custom_button_back_h_color   = smarttoolz_get_option( 'header-main-rt-section-button-back-h-color' );
				$header_custom_button_spacing        = smarttoolz_get_option( 'header-main-rt-section-button-padding' );
				$header_custom_button_border_color   = smarttoolz_get_option( 'header-main-rt-section-button-border-color' );
				$header_custom_button_border_h_color = smarttoolz_get_option( 'header-main-rt-section-button-border-h-color' );
				$header_custom_button_border_size    = smarttoolz_get_option( 'header-main-rt-section-button-border-size' );

				$header_custom_trans_button_text_color     = smarttoolz_get_option( 'header-main-rt-trans-section-button-text-color' );
				$header_custom_trans_button_text_h_color   = smarttoolz_get_option( 'header-main-rt-trans-section-button-text-h-color' );
				$header_custom_trans_button_back_color     = smarttoolz_get_option( 'header-main-rt-trans-section-button-back-color' );
				$header_custom_trans_button_back_h_color   = smarttoolz_get_option( 'header-main-rt-trans-section-button-back-h-color' );
				$header_custom_trans_button_spacing        = smarttoolz_get_option( 'header-main-rt-trans-section-button-padding' );
				$header_custom_trans_button_radius         = smarttoolz_get_option( 'header-main-rt-trans-section-button-border-radius' );
				$header_custom_trans_button_border_color   = smarttoolz_get_option( 'header-main-rt-trans-section-button-border-color' );
				$header_custom_trans_button_border_h_color = smarttoolz_get_option( 'header-main-rt-trans-section-button-border-h-color' );
				$header_custom_trans_button_border_size    = smarttoolz_get_option( 'header-main-rt-trans-section-button-border-size' );

			}

			$global_custom_button_border_size = smarttoolz_get_option( 'theme-button-border-group-border-size' );
			$btn_border_color                 = smarttoolz_get_option( 'theme-button-border-group-border-color' );
			$btn_border_h_color               = smarttoolz_get_option( 'theme-button-border-group-border-h-color' );

			/**
			 * Theme Button Typography
			 */
			$theme_btn_font_family     = smarttoolz_get_option( 'font-family-button' );
			$theme_btn_font_size       = smarttoolz_get_option( 'font-size-button' );
			$theme_btn_font_weight     = smarttoolz_get_option( 'font-weight-button' );
			$theme_btn_text_transform  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-button' ), 'text-transform' );
			$theme_btn_line_height     = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-button' ), 'line-height', 'line-height-unit' );
			$theme_btn_letter_spacing  = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-button' ), 'letter-spacing', 'letter-spacing-unit' );
			$theme_btn_text_decoration = smarttoolz_get_font_extras( smarttoolz_get_option( 'font-extras-button' ), 'text-decoration' );

			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				/**
				 * Custom Header Button Typography
				 */
				$header_custom_btn_font_family    = smarttoolz_get_option( 'primary-header-button-font-family' );
				$header_custom_btn_font_weight    = smarttoolz_get_option( 'primary-header-button-font-weight' );
				$header_custom_btn_font_size      = smarttoolz_get_option( 'primary-header-button-font-size' );
				$header_custom_btn_text_transform = smarttoolz_get_option( 'primary-header-button-text-transform' );
				$header_custom_btn_line_height    = smarttoolz_get_option( 'primary-header-button-line-height' );
				$header_custom_btn_letter_spacing = smarttoolz_get_option( 'primary-header-button-letter-spacing' );

				$footer_adv_border_width = smarttoolz_get_option( 'footer-adv-border-width' );
				$footer_adv_border_color = smarttoolz_get_option( 'footer-adv-border-color' );
			}

			/**
			 * Apply text color depends on link color
			 */
			$btn_text_color = smarttoolz_get_option( 'button-color' );
			if ( empty( $btn_text_color ) ) {
				$btn_text_color = smarttoolz_get_foreground_color( $theme_color );
			}

			/**
			 * Apply text hover color depends on link hover color
			 */
			$btn_text_hover_color = smarttoolz_get_option( 'button-h-color' );
			if ( empty( $btn_text_hover_color ) ) {
				$btn_text_hover_color = smarttoolz_get_foreground_color( $link_hover_color );
			}
			$btn_bg_color     = smarttoolz_get_option( 'button-bg-color', $theme_color );
			$btn_preset_style = smarttoolz_get_option( 'button-preset-style' );
			...
			if ( 'button_04' === $btn_preset_style || 'button_05' === $btn_preset_style || 'button_06' === $btn_preset_style ) {
				...
				if ( '' === smarttoolz_get_option( 'button-bg-color' ) && '' === smarttoolz_get_option( 'button-color' ) ) {
					$btn_text_color = $theme_color;
				} elseif ( '' === smarttoolz_get_option( 'button-color' ) ) {
			...
			$btn_bg_hover_color = smarttoolz_get_option( 'button-bg-h-color', $link_hover_color );

			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				// Spacing of Big Footer.
				$small_footer_divider_color = smarttoolz_get_option( 'footer-sml-divider-color' );
				$small_footer_divider       = smarttoolz_get_option( 'footer-sml-divider' );

				/**
				 * Small Footer Styling
				 */
				$small_footer_layout = smarttoolz_get_option( 'footer-sml-layout', 'footer-sml-layout-1' );
				$smarttoolz_footer_width  = smarttoolz_get_option( 'footer-layout-width' );
			}

			// Blog Post Title Typography Options.
			$single_post_max                        = smarttoolz_get_option( 'blog-single-width' );
			$single_post_max_width                  = smarttoolz_get_option( 'blog-single-max-width' );
			$single_page_max                        = smarttoolz_get_option( 'page-single-width' );
			$single_page_max_width                  = smarttoolz_get_option( 'page-single-max-width' );
			$blog_width                             = smarttoolz_get_option( 'blog-width' );
			$blog_max_width                         = smarttoolz_get_option( 'blog-max-width' );
			$mobile_header_toggle_btn_style_color   = smarttoolz_get_option( 'mobile-header-toggle-btn-style-color', $btn_bg_color );
			$mobile_header_toggle_btn_border_radius = smarttoolz_get_option( 'mobile-header-toggle-btn-border-radius' );
			$aspect_ratio_type                      = smarttoolz_get_option( 'blog-image-ratio-type' );
			$predefined_scale                       = smarttoolz_get_option( 'blog-image-ratio-pre-scale' );
			$custom_scale_width                     = smarttoolz_get_option( 'blog-image-custom-scale-width', 16 );
			$custom_scale_height                    = smarttoolz_get_option( 'blog-image-custom-scale-height', 9 );
			...
			$btn_style_color = smarttoolz_get_option( 'mobile-header-toggle-btn-style-color', false );

			if ( ! $btn_style_color ) {
				// button text color.
				$menu_btn_color = esc_attr( smarttoolz_get_option( 'button-color' ) );
			} else {
				// toggle button color.
				$menu_btn_color = smarttoolz_get_foreground_color( $btn_style_color );
			}

			$css_output = array();
			// Body Font Family.
			$body_font_family = smarttoolz_body_font_family();
			$body_font_weight = smarttoolz_get_option( 'body-font-weight' );
			...
			$h4_properties = array(
				'font-size'   => smarttoolz_responsive_font( $heading_h4_font_size, 'desktop' ),
				'line-height' => esc_attr( $headings_line_height ),
			);

			$h5_properties = array(
				'font-size'   => smarttoolz_responsive_font( $heading_h5_font_size, 'desktop' ),
				'line-height' => esc_attr( $headings_line_height ),
			);

			$h6_properties = array(
				'font-size'   => smarttoolz_responsive_font( $heading_h6_font_size, 'desktop' ),
				'line-height' => esc_attr( $headings_line_height ),
			);

			if ( smarttoolz_has_gcp_typo_preset_compatibility() ) {
				$h4_font_properties = array(
					'font-weight'     => smarttoolz_get_css_value( $h4_font_weight, 'font' ),
					'font-family'     => smarttoolz_get_css_value( $h4_font_family, 'font' ),
				...
				$h5_font_properties = array(
					'font-weight'     => smarttoolz_get_css_value( $h5_font_weight, 'font' ),
					'font-family'     => smarttoolz_get_css_value( $h5_font_family, 'font' ),
				...
				$h6_font_properties = array(
					'font-weight'     => smarttoolz_get_css_value( $h6_font_weight, 'font' ),
					'font-family'     => smarttoolz_get_css_value( $h6_font_family, 'font' ),
			...
			$article_space            = self::smarttoolz_4_6_0_compatibility() ? '2.5em' : '3em';
			$color_palette_reorganize = self::smarttoolz_4_8_9_compatibility();
			$is_dark_palette          = SmartToolz_Global_Palette::is_dark_palette();
			...
			$css_output = array(
				':root'                                  => array(
					...
					'--ast-code-block-background'          => true === self::smarttoolz_check_default_color_typo() ? $is_dark_palette ? 'var(--ast-global-color-5)' : '#ECEFF3' : '#EEEEEE',
					'--ast-comment-inputs-background'      => true === self::smarttoolz_check_default_color_typo() ? '#F9FAFB' : '#FAFAFA',
					'--ast-normal-container-width'         => $site_content_width . 'px',
					'--ast-narrow-container-width'         => $narrow_container_max_width . 'px',
					'--ast-blog-title-font-weight'         => self::smarttoolz_4_6_0_compatibility() ? '600' : 'normal',
					'--ast-blog-meta-weight'               => self::smarttoolz_4_6_0_compatibility() ? '600' : 'inherit',
				...
				// HTML.
				'html'                                   => array(
					'font-size' => smarttoolz_get_font_css_value( (int) $body_font_size_desktop * 6.25, '%' ),
				),
				$link_selector                           => array(
				...
				'body, button, input, select, textarea, .ast-button, .ast-custom-button' => array(
					'font-family'     => smarttoolz_get_font_family( $body_font_family ),
					'font-weight'     => esc_attr( $body_font_weight ),
					'font-size'       => smarttoolz_responsive_font( $body_font_size, 'desktop' ),
				...
				'blockquote'                             => array(
					'border-color' => smarttoolz_hex_to_rgba( $link_color, 0.15 ),
				),
				'p, .entry-content p'                    => array(
					'margin-bottom' => smarttoolz_get_css_value( $para_margin_bottom, 'em' ),
				),
				...
				)                                        => smarttoolz_get_font_array_css( smarttoolz_get_option( 'headings-font-family' ), smarttoolz_get_option( 'headings-font-weight' ), array(), 'headings-font-extras' ),
				...
				'.site-title'                            => array(
					'font-size' => smarttoolz_responsive_font( $site_title_font_size, 'desktop' ),
				...
				is_customize_preview() ? '.ast-sg-logo-section .custom-logo-link img, header .custom-logo-link img' : 'header .custom-logo-link img' => array(
					'max-width' => smarttoolz_get_css_value( $header_logo_width['desktop'], 'px' ),
					'width'     => smarttoolz_get_css_value( $header_logo_width['desktop'], 'px' ),
				),
				'.smarttoolz-logo-svg'                        => array(
					'width' => smarttoolz_get_css_value( $header_logo_width['desktop'], 'px' ),
				),

				'.site-header .site-description'         => array(
					'font-size' => smarttoolz_responsive_font( $site_tagline_font_size, 'desktop' ),
					'display'   => esc_attr( $desktop_tagline_visibility ),
				),
				'.entry-title'                           => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_title_font_size, 'desktop' ),
				),
				'.ast-blog-single-element.ast-taxonomy-container a' => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_tax_font_size, 'desktop' ),
				),
				'.ast-blog-meta-container'               => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_meta_font_size, 'desktop' ),
				),
				'blog-layout-5' === $blog_layout ? '.archive .ast-article-post, .blog .ast-article-post, .archive .ast-article-post:hover, .blog .ast-article-post:hover' : '.archive .ast-article-post .ast-article-inner, .blog .ast-article-post .ast-article-inner, .archive .ast-article-post .ast-article-inner:hover, .blog .ast-article-post .ast-article-inner:hover' => array(
					'border-top-left-radius'     => smarttoolz_responsive_spacing( $archive_cards_radius, 'top', 'desktop' ),
					'border-top-right-radius'    => smarttoolz_responsive_spacing( $archive_cards_radius, 'right', 'desktop' ),
					'border-bottom-right-radius' => smarttoolz_responsive_spacing( $archive_cards_radius, 'bottom', 'desktop' ),
					'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $archive_cards_radius, 'left', 'desktop' ),
					'overflow'                   => 'hidden',
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size'       => smarttoolz_responsive_font( $heading_h1_font_size, 'desktop' ),
					'font-weight'     => smarttoolz_get_css_value( $h1_font_weight, 'font' ),
					'font-family'     => smarttoolz_get_css_value( $h1_font_family, 'font' ),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size'       => smarttoolz_responsive_font( $heading_h2_font_size, 'desktop' ),
					'font-weight'     => smarttoolz_get_css_value( $h2_font_weight, 'font' ),
					'font-family'     => smarttoolz_get_css_value( $h2_font_family, 'font' ),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size'       => smarttoolz_responsive_font( $heading_h3_font_size, 'desktop' ),
					'font-weight'     => smarttoolz_get_css_value( $h3_font_weight, 'font' ),
					'font-family'     => smarttoolz_get_css_value( $h3_font_family, 'font' ),
				...
				'.tagcloud a:hover, .tagcloud a:focus, .tagcloud a.current-item' => array(
					'color'            => smarttoolz_get_foreground_color( $link_color ),
				...
				'.entry-meta, .entry-meta *'             => array(
					'line-height' => '1.45',
					'color'       => esc_attr( $link_color ),
					'font-weight' => self::smarttoolz_4_6_0_compatibility() && ! defined( 'SMARTTOOLZ_EXT_VER' ) ? '600' : '',
				),
				...
				'blockquote'                             => array(
					'color' => smarttoolz_adjust_brightness( $text_color, 75, 'darken' ),
				),
				...
				'.page-links .page-link, .single .post-navigation a' => array(
					'color' => esc_attr( self::smarttoolz_4_6_0_compatibility() ? $text_color : $link_color ),
				),
				...
				'.ast-header-search .ast-search-menu-icon.ast-dropdown-active .search-form, .ast-header-search .ast-search-menu-icon.ast-dropdown-active .search-field:focus' => array(
					'transition'   => 'all 0.2s',
					'border-color' => smarttoolz_get_option( 'site-accessibility-highlight-input-color' ),
				),
			...
			if ( 'blog-layout-6' === $blog_layout ) {
				$css_output['.ast-blog-layout-6-grid .ast-article-inner .post-thumb::after'] = array_merge(
					...
					smarttoolz_get_background_obj( $content_background_overlay ),
				);
			}

			if ( self::smarttoolz_4_4_0_compatibility() ) {
			...
			if ( ! apply_filters( 'smarttoolz_site_svg_logo_equal_height', smarttoolz_get_option( 'smarttoolz-site-svg-logo-equal-height', true ) ) ) {
				$css_output['.smarttoolz-logo-svg:not(.sticky-custom-logo .smarttoolz-logo-svg, .transparent-custom-logo .smarttoolz-logo-svg, .advanced-header-logo .smarttoolz-logo-svg)'] = array(
					'height' => smarttoolz_get_css_value( ! empty( $header_logo_width['desktop-svg-height'] ) && ! is_customize_preview() ? $header_logo_width['desktop-svg-height'] : '', 'px' ),
				);
			}
			...
			if ( ! self::smarttoolz_heading_inside_widget_font_size_comp() ) {
				$selectors .= ', .widget .wp-block-heading';
			}

			// Default widget title color.
			$css_output[ $selectors ] = array(
				'font-size' => smarttoolz_get_font_css_value( (int) $body_font_size_desktop * 1.428571429 ),
				'color'     => smarttoolz_has_global_color_format_support() ? esc_attr( $heading_base_color ) : esc_attr( $text_color ),
			);

			// Remove this condition after 2-3 updates of add-on.
			if ( defined( 'SMARTTOOLZ_EXT_VER' ) && version_compare( SMARTTOOLZ_EXT_VER, '3.0.1', '>=' ) ) {
				$css_output['.single .ast-author-details .author-title'] = array(
					'color' => esc_attr( $link_hover_color ),
				);
			}

			if ( 'no-sidebar' !== smarttoolz_page_layout() ) {
			...
			$content_links_underline = smarttoolz_get_option( 'underline-content-links' );
			...
			if ( $content_links_underline ) {
				...
				$buttons_exclusion_selectors  = smarttoolz_parse_selector(
				...
				$excluding_anchor_selectors = apply_filters( 'smarttoolz_remove_underline_anchor_links', $excluding_anchor_selectors );
			...
			$enable_site_accessibility        = smarttoolz_get_option( 'site-accessibility-toggle', false );
			$html_selectors_focus_visible     = smarttoolz_parse_selector( '.ast-search-menu-icon.slide-search a:focus-visible:focus-visible, .smarttoolz-search-icon:focus-visible, #close:focus-visible, a:focus-visible, .ast-menu-toggle:focus-visible, .site .skip-link:focus-visible, .wp-block-loginout input:focus-visible, .wp-block-search.wp-block-search__button-inside .wp-block-search__inside-wrapper, .ast-header-navigation-arrow:focus-visible, .woocommerce .wc-proceed-to-checkout > .checkout-button:focus-visible, .woocommerce .woocommerce-MyAccount-navigation ul li a:focus-visible, .ast-orders-table__row .ast-orders-table__cell:focus-visible, .woocommerce .woocommerce-order-details .order-again > .button:focus-visible, .woocommerce .woocommerce-message a.button.wc-forward:focus-visible, .woocommerce #minus_qty:focus-visible, .woocommerce #plus_qty:focus-visible, a#ast-apply-coupon:focus-visible, .woocommerce .woocommerce-info a:focus-visible, .woocommerce .smarttoolz-shop-summary-wrap a:focus-visible, .woocommerce a.wc-forward:focus-visible, #ast-apply-coupon:focus-visible, .woocommerce-js .woocommerce-mini-cart-item a.remove:focus-visible, #close:focus-visible, .button.search-submit:focus-visible, #search_submit:focus, .normal-search:focus-visible, .ast-header-account-wrap:focus-visible, .woocommerce .ast-on-card-button.ast-quick-view-trigger:focus, .smarttoolz-cart-drawer-close:focus, .ast-single-variation:focus, .ast-woocommerce-product-gallery__image:focus, .ast-button:focus, .woocommerce-product-gallery--with-images [data-controls="prev"]:focus-visible, .woocommerce-product-gallery--with-images [data-controls="next"]:focus-visible, .ast-builder-button-wrap:has(.ast-custom-button-link:focus), .ast-builder-button-wrap .ast-custom-button-link:focus', 'wc' );
			$html_selectors_focus_only_inputs = smarttoolz_parse_selector( 'input:focus, input[type="text"]:focus, input[type="email"]:focus, input[type="url"]:focus, input[type="password"]:focus, input[type="reset"]:focus, input[type="search"]:focus, input[type="number"]:focus, textarea:focus, .wp-block-search__input:focus, [data-section="section-header-mobile-trigger"] .ast-button-wrap .ast-mobile-menu-trigger-minimal:focus, .ast-mobile-popup-drawer.active .menu-toggle-close:focus, .woocommerce-ordering select.orderby:focus, #ast-scroll-top:focus, #coupon_code:focus, .woocommerce-page #comment:focus, .woocommerce #reviews #respond input#submit:focus, .woocommerce a.add_to_cart_button:focus, .woocommerce .button.single_add_to_cart_button:focus, .woocommerce .woocommerce-cart-form button:focus, .woocommerce .woocommerce-cart-form__cart-item .quantity .qty:focus, .woocommerce .woocommerce-billing-fields .woocommerce-billing-fields__field-wrapper .woocommerce-input-wrapper > .input-text:focus, .woocommerce #order_comments:focus, .woocommerce #place_order:focus, .woocommerce .woocommerce-address-fields .woocommerce-address-fields__field-wrapper .woocommerce-input-wrapper > .input-text:focus, .woocommerce .woocommerce-MyAccount-content form button:focus, .woocommerce .woocommerce-MyAccount-content .woocommerce-EditAccountForm .woocommerce-form-row .woocommerce-Input.input-text:focus, .woocommerce .ast-woocommerce-container .woocommerce-pagination ul.page-numbers li a:focus, body #content .woocommerce form .form-row .select2-container--default .select2-selection--single:focus, #ast-coupon-code:focus, .woocommerce.woocommerce-js .quantity input[type=number]:focus, .woocommerce-js .woocommerce-mini-cart-item .quantity input[type=number]:focus, .woocommerce p#ast-coupon-trigger:focus', 'wc' );

			if ( $enable_site_accessibility ) {
				$outline_style = smarttoolz_get_option( 'site-accessibility-highlight-type' );
				$outline_color = smarttoolz_get_option( 'site-accessibility-highlight-color' );

				$outline_input_style = smarttoolz_get_option( 'site-accessibility-highlight-input-type' );
				...
				$outline_input_color = smarttoolz_get_option( 'site-accessibility-highlight-input-color' );
				...
				if ( 'unset' !== $outline_input_style ) {
					$css_output[ $html_selectors_focus_only_inputs ] = array(
						...
						'border-width'  => 'thin',
						'outline-color' => smarttoolz_get_option( 'site-accessibility-highlight-input-color' ),
					);
				} else {
					$css_output[ $html_selectors_focus_only_inputs ] = array(
			...
			$page_header_logo = defined( 'SMARTTOOLZ_EXT_VER' ) && SmartToolz_Ext_Extension::is_active( 'advanced-headers' ) && SmartToolz_Ext_Advanced_Headers_Loader::smarttoolz_advanced_headers_design_option( 'logo-url' ) ? true : false;

			if ( smarttoolz_get_option( 'logo-title-inline' ) || is_customize_preview() ) {
			...
			if ( get_theme_mod( 'custom_logo' )
				|| smarttoolz_get_option( 'transparent-header-logo' )
				|| smarttoolz_get_option( 'sticky-header-logo' )
				|| $page_header_logo
				...
				if ( smarttoolz_get_option( 'header-logo-color' ) ) {
					$css_output['.site-logo-img img'] = array(
				...
				if ( smarttoolz_get_option( 'transparent-header-logo-color' ) ) {
			...
			$parse_css .= smarttoolz_parse_css( $css_output );
			...
			$parse_css .= smarttoolz_parse_css( $oembed_wrapper );

			if ( ! SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				...
				$parse_css .= smarttoolz_parse_css( $old_header_mobile_toggle );
			}

			$parse_css .= smarttoolz_container_layout_css();

			if ( 'no-sidebar' !== smarttoolz_page_layout() ) {
				$parse_css .= SmartToolz_Enqueue_Scripts::trim_css( self::load_sidebar_static_css() );
				$parse_css .= self::smarttoolz_sticky_sidebar_css();
			}

			if ( self::smarttoolz_4_6_0_compatibility() ) {

				// Forms default styling improvements.
				$parse_css .= self::smarttoolz_default_forms_styling_dynamic_css();
			}

			if ( true === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {

				$parse_css .= smarttoolz_parse_css(
					array(
					...
					'',
					number_format( absint( smarttoolz_get_tablet_breakpoint() ) + 0.99, 2, '.', '' )
				);
				...
				$parse_css .= smarttoolz_parse_css(
					...
					smarttoolz_get_tablet_breakpoint( '', 1 )
				);
			}

			// Comments CSS.
			if ( ! SmartToolz_Builder_Helper::apply_flex_based_css() ) {
				require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/comments.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			} else {
				require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/comments-flex.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}

			// Single post improvement.
			require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/single-post.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			$live_search_enabled = smarttoolz_get_option( 'live-search', false );
			if ( ( true === SmartToolz_Builder_Helper::$is_header_footer_builder_active && SmartToolz_Builder_Helper::is_component_loaded( 'search', 'header' ) && $live_search_enabled ) || ( is_search() && true === smarttoolz_get_option( 'ast-search-live-search' ) ) ) {
				// Live search CSS.
				require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/live-search.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}

			if ( ( SmartToolz_Builder_Helper::is_component_loaded( 'woo-cart', 'header' ) && defined( 'WC_VERSION' ) ) ||
				( SmartToolz_Builder_Helper::is_component_loaded( 'edd-cart', 'header' ) && defined( 'EDD_VERSION' ) )
			) {
				$parse_css .= SmartToolz_Enqueue_Scripts::trim_css( self::load_cart_static_css() );

				$parse_css .= smarttoolz_parse_css(
					array(
						'.smarttoolz-cart-drawer.active' => array(
							'width' => '80%',
						),
					),
					'',
					smarttoolz_get_tablet_breakpoint()
				);
				...
				$parse_css .= smarttoolz_parse_css(
					...
					'',
					smarttoolz_get_mobile_breakpoint()
				);
			}
			...
			if ( ! SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				$footer_css_output = array(
					...
					'.ast-small-footer > .ast-footer-overlay' => smarttoolz_get_background_obj( $footer_bg_obj ),
					...
					'.footer-adv .footer-adv-overlay' => array(
						...
						'border-top-width' => smarttoolz_get_css_value( $footer_adv_border_width, 'px' ),
					...
					'.footer-adv-overlay'             => smarttoolz_get_background_obj( $footer_adv_bg_obj ),

				);

				$parse_css .= smarttoolz_parse_css( $footer_css_output );
			}

			// Paginaiton CSS.
			require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/pagination.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			// Related Posts Dynamic CSS.

			// Navigation CSS.
			if ( ! self::smarttoolz_4_6_0_compatibility() && is_single() ) {
				/**
				 * CSS for post navigation design break for the old users.
				 */
				$parse_css .= SmartToolz_Enqueue_Scripts::trim_css(
					'
			...
			// Navigation CSS.
			if ( is_single() && self::smarttoolz_4_6_0_compatibility() ) {
				require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/navigation.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}
			 ...
			 * @since 4.7.0
			 */
			require_once SMARTTOOLZ_THEME_DIR . 'inc/dynamic-css/logo-svg-icons.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			...
			$parse_css                         .= smarttoolz_parse_css( $gtn_plugin_button_center_alignment );

			$ast_container_layout = smarttoolz_get_content_layout();
			$is_boxed             = smarttoolz_is_content_style_boxed();
			$is_sidebar_boxed     = smarttoolz_is_sidebar_style_boxed();
			$ast_container_layout = smarttoolz_apply_boxed_layouts( $ast_container_layout, $is_boxed, $is_sidebar_boxed );
			...
			if ( self::gutenberg_core_blocks_css_comp() && is_singular() ) {
				...
				$parse_css .= smarttoolz_parse_css( $trans_header_responsive_top_space_css_fix, '', smarttoolz_get_tablet_breakpoint() );
			}
			...
			if ( self::gutenberg_media_text_block_css_compat() && is_singular() ) {
				...
				/* Parse CSS from array() -> max-width: (tablet-breakpoint)px CSS */
				$parse_css .= smarttoolz_parse_css( $remove_primary_padding_on_mobile_css, '', smarttoolz_get_tablet_breakpoint() );
			}
			...
			if ( self::gtn_group_cover_css_comp() && is_singular() ) {
				...
				if ( 'disabled' === $display_header && apply_filters( 'smarttoolz_content_margin_full_width_contained', true ) || ( SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() ) || ( self::gutenberg_core_blocks_css_comp() ) ) {
					...
					$parse_css     .= smarttoolz_parse_css( $gtn_margin_top );
				}
				/**
				...
				if ( true === $update_customizer_strctural_defaults ) {
					...
					if ( 'disabled' !== $display_title && ! SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() && apply_filters( 'smarttoolz_contained_layout_primary_spacing', true ) ) {
						$gtn_margin_top = array(
							'.ast-plain-container.ast-no-sidebar #primary' => array(
								'margin-top'    => '60px',
								'margin-bottom' => '60px',
						...
						$parse_css .= smarttoolz_parse_css( $gtn_margin_top, '1200' );
					}
				}
			}

			$single_post_outside_spacing = smarttoolz_get_option( 'single-post-outside-spacing' );
			...
			if ( ! self::smarttoolz_4_6_0_compatibility() ) {
				$single_post_outside_spacing_css_desktop = array(
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'margin-top'    => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'top', 'desktop' ),
						'margin-bottom' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'bottom', 'desktop' ),
					),
					'.ast-left-sidebar.ast-single-post #primary, .ast-right-sidebar.ast-single-post #primary, .ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'padding-left'  => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'left', 'desktop' ),
						'padding-right' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'right', 'desktop' ),
					),
				);

				$parse_css .= smarttoolz_parse_css( $single_post_outside_spacing_css_desktop );
				...
				$single_post_outside_spacing_css_tablet = array(
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container #primary, .ast-narrow-container #primary' => array(
						'margin-top'    => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'top', 'tablet' ),
						'margin-bottom' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'bottom', 'tablet' ),
					),
					'.ast-left-sidebar #primary, .ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container #primary, .ast-narrow-container #primary' => array(
						'padding-left'  => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'left', 'tablet' ),
						'padding-right' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'right', 'tablet' ),
					),
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'margin-top'    => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'top', 'tablet' ),
						'margin-bottom' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'bottom', 'tablet' ),
				...
				$parse_css .= smarttoolz_parse_css( $single_post_outside_spacing_css_tablet, '', smarttoolz_get_tablet_breakpoint() );

				$single_post_outside_spacing_css_mobile = array(
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'margin-top'    => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'top', 'mobile' ),
						'margin-bottom' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'bottom', 'mobile' ),
					),
					'.ast-left-sidebar.ast-single-post #primary, .ast-right-sidebar.ast-single-post #primary, .ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'padding-left'  => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'left', 'mobile' ),
						'padding-right' => smarttoolz_responsive_spacing( $single_post_outside_spacing, 'right', 'mobile' ),
					),
				);

				$parse_css .= smarttoolz_parse_css( $single_post_outside_spacing_css_mobile, '', smarttoolz_get_mobile_breakpoint() );
			}

			if ( self::smarttoolz_4_8_2_compatibility() ) {
				...
				$parse_css .= smarttoolz_parse_css( $single_post_outside_padding_css_tablet, '', smarttoolz_get_tablet_breakpoint() );
				...
				$parse_css .= smarttoolz_parse_css( $single_post_outside_padding_css_mobile, '', smarttoolz_get_mobile_breakpoint() );
			}
			...
			$remove_single_post_top_padding_container = array(
				'.ast-separate-container #primary, .ast-narrow-container #primary' => array(
					'padding-top' => smarttoolz_get_css_value( 0, 'px' ),
				),
			);
			...
			$remove_single_post_bottom_padding_container = array(
				'.ast-separate-container #primary, .ast-narrow-container #primary' => array(
					'padding-bottom' => smarttoolz_get_css_value( 0, 'px' ),
				),
			);

			if ( isset( $single_post_outside_spacing['desktop']['top'] ) && '' != $single_post_outside_spacing['desktop']['top'] ) {
				$parse_css .= smarttoolz_parse_css( $remove_single_post_top_padding_container );
			}
			if ( isset( $single_post_outside_spacing['tablet']['top'] ) && '' != $single_post_outside_spacing['tablet']['top'] ) {
				$parse_css .= smarttoolz_parse_css( $remove_single_post_top_padding_container, '', smarttoolz_get_tablet_breakpoint() );
			}
			if ( isset( $single_post_outside_spacing['mobile']['top'] ) && '' != $single_post_outside_spacing['mobile']['top'] ) {
				$parse_css .= smarttoolz_parse_css( $remove_single_post_top_padding_container, '', smarttoolz_get_mobile_breakpoint() );
			}

			if ( isset( $single_post_outside_spacing['desktop']['top'] ) && '' != $single_post_outside_spacing['desktop']['top'] ) {
				$parse_css .= smarttoolz_parse_css( $remove_single_post_bottom_padding_container );
			}
			if ( isset( $single_post_outside_spacing['tablet']['top'] ) && '' != $single_post_outside_spacing['tablet']['top'] ) {
				$parse_css .= smarttoolz_parse_css( $remove_single_post_bottom_padding_container, '', smarttoolz_get_tablet_breakpoint() );
			}
			if ( isset( $single_post_outside_spacing['mobile']['top'] ) && '' != $single_post_outside_spacing['mobile']['top'] ) {
				$parse_css .= smarttoolz_parse_css( $remove_single_post_bottom_padding_container, '', smarttoolz_get_mobile_breakpoint() );
			}
			...
			if ( $block_editor_legacy_setup ) {
				...
				*/
				if ( self::gtn_image_group_css_comp() ) {
					...
					$parse_css              .= smarttoolz_parse_css( $gtn_full_wide_image_css, '1200' );
					...
					$parse_css .= smarttoolz_parse_css( $gtn_tablet_column_css, '', '782' );
				}
								...
								$parse_css .= smarttoolz_parse_css(
									array(
										...
										'.ast-plain-container.ast-no-sidebar .entry-content .alignwide .wp-block-cover__inner-container, .ast-plain-container.ast-no-sidebar .entry-content .alignfull .wp-block-cover__inner-container' => array(
											'width' => smarttoolz_get_css_value( $site_content_width + 40, 'px' ),
										),
									),
									'1200'
								);
				...
				if ( self::gutenberg_core_blocks_css_comp() ) {
					...
					$parse_css .= smarttoolz_parse_css( $desktop_screen_gb_css );
					...
					if ( false === $improve_gb_ui ) {
						...
						/* Parse CSS from array() -> min-width: (1200)px CSS */
						$parse_css .= smarttoolz_parse_css( $middle_screen_min_gb_css, '1200' );
					}
					...
					$parse_css .= smarttoolz_parse_css( $middle_screen_max_gb_css, '', '1200' );
					...
					$parse_css .= smarttoolz_parse_css( $tablet_screen_min_gb_css, smarttoolz_get_tablet_breakpoint() );
					...
					$parse_css .= smarttoolz_parse_css( $mobile_screen_max_gb_css, '', smarttoolz_get_mobile_breakpoint() );
				}

				$is_legacy_setup = 'legacy' === smarttoolz_get_option( 'wp-blocks-ui' ) ? true : false;

				if ( $is_legacy_setup && smarttoolz_wp_version_compare( '6.0', '>=' ) ) {
					...
					$parse_css               .= smarttoolz_parse_css( $image_block_center_align );
				}
				...
				if ( $is_legacy_setup ) {
					...
					$parse_css               .= smarttoolz_parse_css( $table_block_center_align );
				}
				...
				if ( self::gutenberg_media_text_block_css_compat() ) {
					...
					$parse_css .= smarttoolz_parse_css( $media_text_block_padding_css, smarttoolz_get_mobile_breakpoint() );
					...
					/* Parse CSS from array() -> max-width: (mobile-breakpoint)px CSS */
					$parse_css .= smarttoolz_parse_css( $mobile_screen_media_text_block_css, '', smarttoolz_get_mobile_breakpoint() );
				}
			}
			...
			if ( smarttoolz_button_default_padding_updated() ) {
				$default_border_size = '';
			}

			// Outline Gutenberg button compatibility CSS.
			$theme_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && ( '' !== $global_custom_button_border_size['top'] && '0' !== $global_custom_button_border_size['top'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['top'], 'px' ) : $default_border_size;
			$theme_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && ( '' !== $global_custom_button_border_size['right'] && '0' !== $global_custom_button_border_size['right'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['right'], 'px' ) : $default_border_size;
			$theme_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && ( '' !== $global_custom_button_border_size['left'] && '0' !== $global_custom_button_border_size['left'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['left'], 'px' ) : $default_border_size;
			$theme_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && ( '' !== $global_custom_button_border_size['bottom'] && '0' !== $global_custom_button_border_size['bottom'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
			...
			if ( self::gutenberg_core_patterns_compat() ) {
				...
				$outline_button_css = array(
					...
					'.post-page-numbers.current .page-link, .ast-pagination .page-numbers.current'                    => array(
						'color'            => smarttoolz_get_foreground_color( $theme_color ),
				...
				$parse_css .= smarttoolz_parse_css( $outline_button_css );
				...
				if ( $block_editor_legacy_setup ) {
					...
					if ( ! smarttoolz_button_default_padding_updated() ) {
						...
						$parse_css .= smarttoolz_parse_css( $outline_button_tablet_css, '', smarttoolz_get_tablet_breakpoint() );
						...
						$parse_css .= smarttoolz_parse_css( $outline_button_mobile_css, '', smarttoolz_get_mobile_breakpoint() );
					}
					...
					/* Parse CSS from array() -> min-width: (mobile-breakpoint) px CSS  */
					$parse_css .= smarttoolz_parse_css( $gb_patterns_min_mobile_css, smarttoolz_get_mobile_breakpoint() );
				}
			}
			 ...
			 */
			$scndry_btn_text_color                   = smarttoolz_get_option( 'secondary-button-color' );
			$scndry_btn_border_color                 = smarttoolz_get_option( 'secondary-theme-button-border-group-border-color' );
			$scndry_btn_border_h_color               = smarttoolz_get_option( 'secondary-theme-button-border-group-border-h-color' );
			$global_scndry_custom_button_border_size = smarttoolz_get_option( 'secondary-theme-button-border-group-border-size' );
			$scndry_theme_btn_top_border             = isset( $global_scndry_custom_button_border_size['top'] ) && ( '' !== $global_scndry_custom_button_border_size['top'] && '0' !== $global_scndry_custom_button_border_size['top'] ) ? smarttoolz_get_css_value( $global_scndry_custom_button_border_size['top'], 'px' ) : $default_border_size;
			$scndry_theme_btn_right_border           = isset( $global_scndry_custom_button_border_size['right'] ) && ( '' !== $global_scndry_custom_button_border_size['right'] && '0' !== $global_scndry_custom_button_border_size['right'] ) ? smarttoolz_get_css_value( $global_scndry_custom_button_border_size['right'], 'px' ) : $default_border_size;
			$scndry_theme_btn_left_border            = isset( $global_scndry_custom_button_border_size['left'] ) && ( '' !== $global_scndry_custom_button_border_size['left'] && '0' !== $global_scndry_custom_button_border_size['left'] ) ? smarttoolz_get_css_value( $global_scndry_custom_button_border_size['left'], 'px' ) : $default_border_size;
			$scndry_theme_btn_bottom_border          = isset( $global_scndry_custom_button_border_size['bottom'] ) && ( '' !== $global_scndry_custom_button_border_size['bottom'] && '0' !== $global_scndry_custom_button_border_size['bottom'] ) ? smarttoolz_get_css_value( $global_scndry_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
			$scndry_theme_btn_font_family            = smarttoolz_get_option( 'secondary-font-family-button' );
			$scndry_theme_btn_font_size              = smarttoolz_get_option( 'secondary-font-size-button' );
			$scndry_theme_btn_font_weight            = smarttoolz_get_option( 'secondary-font-weight-button' );
			$scndry_theme_btn_text_transform         = smarttoolz_get_font_extras( smarttoolz_get_option( 'secondary-font-extras-button' ), 'text-transform' );
			$scndry_theme_btn_line_height            = smarttoolz_get_font_extras( smarttoolz_get_option( 'secondary-font-extras-button' ), 'line-height', 'line-height-unit' );
			$scndry_theme_btn_letter_spacing         = smarttoolz_get_font_extras( smarttoolz_get_option( 'secondary-font-extras-button' ), 'letter-spacing', 'letter-spacing-unit' );
			$scndry_theme_btn_text_decoration        = smarttoolz_get_font_extras( smarttoolz_get_option( 'secondary-font-extras-button' ), 'text-decoration' );
			$scndry_theme_btn_padding                = smarttoolz_get_option( 'secondary-theme-button-padding' );
			$scndry_btn_border_radius_fields         = smarttoolz_get_option( 'secondary-button-radius-fields' );
			$scndry_btn_bg_color                     = smarttoolz_get_option( 'secondary-button-bg-color' );
			$scndry_btn_bg_hover_color               = smarttoolz_get_option( 'secondary-button-bg-h-color' );
			$scndry_btn_text_hover_color             = smarttoolz_get_option( 'secondary-button-h-color' );
			$outline_button_selector                 = '.wp-block-button.is-style-outline .wp-block-button__link.wp-element-button, .ast-outline-button';
			$padding_top                             = smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'top', 'desktop' );
			$padding_right                           = smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'right', 'desktop' );
			$padding_bottom                          = smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'desktop' );
			$padding_left                            = smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'left', 'desktop' );
			$border_top_val                          = '';
			$border_right_val                        = '';
			$border_bottom_val                       = '';
			$border_left_val                         = '';
			...
			$secondary_btn_preset_style = smarttoolz_get_option( 'secondary-button-preset-style' );
			...
			if ( 'button_04' === $secondary_btn_preset_style || 'button_05' === $secondary_btn_preset_style || 'button_06' === $secondary_btn_preset_style ) {
				...
				if ( '' === smarttoolz_get_option( 'secondary-button-bg-color' ) && '' === smarttoolz_get_option( 'secondary-button-color' ) ) {
					$btn_color_val = $theme_color;
				} elseif ( '' === smarttoolz_get_option( 'secondary-button-color' ) ) {
			...
			$outline_button_css_desktop = array(
				$outline_button_selector => array(
					...
					'font-family'                => smarttoolz_get_font_family( $scndry_theme_btn_font_family ),
					'font-weight'                => esc_attr( $scndry_theme_btn_font_weight ),
					'font-size'                  => isset( $scndry_theme_btn_font_size['desktop'] ) && isset( $scndry_theme_btn_font_size['desktop-unit'] ) && is_array( $scndry_theme_btn_font_size ) ? smarttoolz_get_font_css_value( $scndry_theme_btn_font_size['desktop'], $scndry_theme_btn_font_size['desktop-unit'] ) : '',
					...
					'border-top-left-radius'     => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'desktop' ),
					'border-top-right-radius'    => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'desktop' ),
					'border-bottom-right-radius' => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'desktop' ),
					'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'desktop' ),
				),
			...
			$outline_button_css_tablet = array(
				$outline_button_selector => array(
					'font-size'                  => smarttoolz_responsive_font( $scndry_theme_btn_font_size, 'tablet' ),
					'padding-top'                => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'top', 'tablet' ),
					'padding-right'              => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'right', 'tablet' ),
					'padding-bottom'             => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'tablet' ),
					'padding-left'               => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'left', 'tablet' ),
					'border-top-left-radius'     => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'tablet' ),
					'border-top-right-radius'    => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'tablet' ),
					'border-bottom-right-radius' => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'tablet' ),
					'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'tablet' ),
				),
			);

			$outline_button_css_mobile = array(
				$outline_button_selector => array(
					'font-size'                  => smarttoolz_responsive_font( $scndry_theme_btn_font_size, 'mobile' ),
					'padding-top'                => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'top', 'mobile' ),
					'padding-right'              => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'right', 'mobile' ),
					'padding-bottom'             => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'mobile' ),
					'padding-left'               => smarttoolz_responsive_spacing( $scndry_theme_btn_padding, 'left', 'mobile' ),
					'border-top-left-radius'     => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'mobile' ),
					'border-top-right-radius'    => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'mobile' ),
					'border-bottom-right-radius' => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'mobile' ),
					'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'mobile' ),
				),
			);
			...
			if ( 'button_01' === $secondary_btn_preset_style || 'button_02' === $secondary_btn_preset_style || 'button_03' === $secondary_btn_preset_style ) {
				if ( empty( $scndry_btn_text_color ) ) {
					$scndry_btn_text_color = smarttoolz_get_foreground_color( $theme_color );
				}
			...
			$parse_css .= smarttoolz_parse_css( $outline_button_css_desktop );

			/* Parse CSS from array() -> Tablet */
			$parse_css .= smarttoolz_parse_css( $outline_button_css_tablet, '', smarttoolz_get_tablet_breakpoint() );

			/* Parse CSS from array() -> Mobile */
			$parse_css .= smarttoolz_parse_css( $outline_button_css_mobile, '', smarttoolz_get_mobile_breakpoint() );
			 ...
			 * @since 4.4.0
			 */
			if ( smarttoolz_wp_version_compare( '6.3', '>=' ) ) {
				...
				/* Parse CSS from array() -> All media CSS */
				$parse_css .= smarttoolz_parse_css( $figure_margin_bottom );
			}
			...
			if ( $is_widget_title_support_font_weight ) {
				...
				/* Parse CSS from array() -> All media CSS */
				$parse_css .= smarttoolz_parse_css( $widget_title_font_weight_support );
			}
			 ...
			 * Applies to non-archive pages only. @see smarttoolz_check_is_structural_setup()
			 */
			...
			if ( defined( 'ELEMENTOR_PRO_VERSION' ) ) {
				...
				$parse_css              .= smarttoolz_parse_css( $elementor_shop_page_css );
			}
			...
			if ( defined( 'ELEMENTOR_PRO_VERSION' ) && $elementor_heading_margin_style_comp ) {
				...
				$parse_css .= smarttoolz_parse_css( $elementor_base_css );
			}

			// Getting the responsive alignment option.
			$shop_product_alignment = smarttoolz_get_option( 'shop-product-align-responsive' );

			// Added Check if the tablet alignment is 'align-center'
			if ( ( isset( $shop_product_alignment['desktop'] ) && 'align-center' === $shop_product_alignment['desktop'] ) && 'shop-page-list-style' !== smarttoolz_get_option( 'shop-style' ) ) {
				...
				/* Parse CSS from array() -> Desktop CSS */
				$parse_css .= smarttoolz_parse_css( $desktop_review_wrapper );
			}
			...
			if ( class_exists( 'WooCommerce' ) && ! is_product() ) {
				...
				/* Parse CSS from array() -> Desktop CSS */
				$parse_css .= smarttoolz_parse_css( $review_rating_style );
			}
			...
			if ( has_block( 'core/cover' ) ) {
				...
				$parse_css .= smarttoolz_parse_css( $cover_block_style );
			}
			...
			if ( true === $update_customizer_strctural_defaults ) {
				...
				$default_layout_update_css = array(
					...
					'.ast-separate-container .ast-article-post, .ast-separate-container .ast-article-single, .ast-separate-container .comment-respond' => array(
						'padding' => self::smarttoolz_4_6_0_compatibility() && is_single() ? '2.5em' : '3em',
					),
					...
					'.entry-title'                    => array(
						'margin-bottom' => self::smarttoolz_4_6_0_compatibility() ? '0.6em' : '0.5em',
					),
				...
				if ( ! self::smarttoolz_4_6_0_compatibility() ) {
					...
					if ( is_single() && smarttoolz_get_option( 'single-content-images-shadow', false ) ) {
				...
				/* Parse CSS from array() -> Desktop CSS */
				$parse_css .= smarttoolz_parse_css( $default_layout_update_css );
				...
				$parse_css .= smarttoolz_parse_css( $default_tablet_layout_css, smarttoolz_get_tablet_breakpoint() );
				...
				$parse_css .= smarttoolz_parse_css( $default_mobile_layout_css, '', smarttoolz_get_mobile_breakpoint() );
				...
				if ( is_user_logged_in() ) {
					...
					$parse_css                  .= smarttoolz_parse_css( $admin_bar_specific_page_css );
					...
					$parse_css                    .= smarttoolz_parse_css( $admin_bar_responsive_page_css, '', '782' );
				}
				...
				$parse_css .= smarttoolz_parse_css( $default_medium_layout_css, '1201' );
				...
				if ( is_author() ) {
					...
					/* Parse CSS from array() -> Desktop CSS */
					$parse_css                    .= smarttoolz_parse_css( $default_author_css );
					...
					/* Parse CSS from array() -> min-width: (tablet-breakpoint) CSS */
					$parse_css                    .= smarttoolz_parse_css( $default_tablet_min_author_css, smarttoolz_get_tablet_breakpoint() );
					...
					$parse_css                             .= smarttoolz_parse_css( $default_max_tablet_author_css, '', smarttoolz_get_tablet_breakpoint() );
					...
					$parse_css .= smarttoolz_parse_css( $default_tablet_min_extra_px_author_css, smarttoolz_get_tablet_breakpoint( '', 1 ) );
				}
			} else {
			...
			/* Parse CSS from array() -> max-width: (tablet-breakpoint)px CSS */
			$parse_css .= smarttoolz_parse_css( $static_layout_css, '', smarttoolz_get_tablet_breakpoint() );
			...
			if ( 'no-sidebar' !== smarttoolz_page_layout() ) {
				...
				$parse_css                  .= smarttoolz_parse_css( $static_secondary_layout_css, '', smarttoolz_get_tablet_breakpoint() );
			}
			...
			if ( 'no-sidebar' !== smarttoolz_page_layout() ) {
				...
				/* Parse CSS from array() -> max-width: (tablet-breakpoint)px CSS */
				$parse_css .= smarttoolz_parse_css( $static_layout_lang_direction_css, '', smarttoolz_get_tablet_breakpoint() );
			}
			...
			$parse_css .= smarttoolz_parse_css( $static_layout_css_min, smarttoolz_get_tablet_breakpoint( '', '1' ) );
			...
			if ( is_404() ) {
				...
				$page_404   = array(
					'.ast-404-layout-1 .ast-404-text' => array(
						'font-size' => smarttoolz_get_font_css_value( '200' ),
					),
				);
				$parse_css .= smarttoolz_parse_css( $page_404 );
				...
				$parse_css .= smarttoolz_parse_css(
					array(
						'.ast-404-layout-1 .ast-404-text' => array(
							'font-size' => smarttoolz_get_font_css_value( 100 ),
						),
					),
					'',
					'920'
			...
			if ( 'no-sidebar' !== smarttoolz_page_layout() ) {
				...
				/* Parse CSS from array() -> min-width: (tablet-breakpoint + 1)px CSS */
				$parse_css .= smarttoolz_parse_css( $static_layout_min_lang_direction_css, smarttoolz_get_tablet_breakpoint( '', '1' ) );
			}
			...
			if ( self::page_builder_button_style_css() ) {
				...
				$woo_btns_selector                      = defined( 'WC_VERSION' ) && true === self::smarttoolz_woo_support_global_settings() ? ', .woocommerce-js a.button, .woocommerce button.button, .woocommerce .woocommerce-message a.button, .woocommerce #respond input#submit.alt, .woocommerce input.button.alt, .woocommerce input.button,.woocommerce input.button:disabled, .woocommerce input.button:disabled[disabled], .woocommerce input.button:disabled:hover, .woocommerce input.button:disabled[disabled]:hover, .woocommerce #respond input#submit, .woocommerce button.button.alt.disabled, .wc-block-grid__products .wc-block-grid__product .wp-block-button__link, .wc-block-grid__product-onsale, [CLASS*="wc-block"] button, .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping), .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons a.checkout, .woocommerce button.button.alt.disabled.wc-variation-selection-needed, [CLASS*="wc-block"] .wc-block-components-button' : '';
				$woo_btns_hover_selector                = defined( 'WC_VERSION' ) && true === self::smarttoolz_woo_support_global_settings() ? ', .woocommerce-js a.button:hover, .woocommerce button.button:hover, .woocommerce .woocommerce-message a.button:hover,.woocommerce #respond input#submit:hover,.woocommerce #respond input#submit.alt:hover, .woocommerce input.button.alt:hover, .woocommerce input.button:hover, .woocommerce button.button.alt.disabled:hover, .wc-block-grid__products .wc-block-grid__product .wp-block-button__link:hover, [CLASS*="wc-block"] button:hover, .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping):hover, .woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons a.checkout:hover, .woocommerce button.button.alt.disabled.wc-variation-selection-needed:hover, [CLASS*="wc-block"] .wc-block-components-button:hover, [CLASS*="wc-block"] .wc-block-components-button:focus' : '';
				$v4_2_2_core_form_btns_styling_selector = true === self::smarttoolz_core_form_btns_styling() ? ', #comments .submit, .search .search-submit' : '';
				...
				$global_button_desktop = array(
					'.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' . $v4_2_2_core_form_btns_styling_selector . $search_button_selector . $file_block_button_selector . $search_page_btn_selector . $woo_btns_selector => array(
						'border-style'               => 'solid',
						'border-top-width'           => isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ? smarttoolz_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '0',
						'border-right-width'         => isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ? smarttoolz_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '0',
						'border-left-width'          => isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ? smarttoolz_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '0',
						'border-bottom-width'        => isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ? smarttoolz_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '0',
						'color'                      => esc_attr( $btn_text_color ),
						'border-color'               => empty( $btn_border_color ) ? esc_attr( $btn_bg_color ) : esc_attr( $btn_border_color ),
						'background-color'           => esc_attr( $btn_bg_color ),
						'padding-top'                => smarttoolz_responsive_spacing( $theme_btn_padding, 'top', 'desktop' ),
						'padding-right'              => smarttoolz_responsive_spacing( $theme_btn_padding, 'right', 'desktop' ),
						'padding-bottom'             => smarttoolz_responsive_spacing( $theme_btn_padding, 'bottom', 'desktop' ),
						'padding-left'               => smarttoolz_responsive_spacing( $theme_btn_padding, 'left', 'desktop' ),
						'font-family'                => smarttoolz_get_font_family( $theme_btn_font_family ),
						'font-weight'                => esc_attr( $theme_btn_font_weight ),
						'font-size'                  => smarttoolz_get_font_css_value( $theme_btn_font_size['desktop'], $theme_btn_font_size['desktop-unit'] ),
						...
						'border-top-left-radius'     => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'top', 'desktop' ),
						'border-top-right-radius'    => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'right', 'desktop' ),
						'border-bottom-right-radius' => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'bottom', 'desktop' ),
						'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'left', 'desktop' ),
					),
				...
				$global_button_tablet = array(
					'.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' . $v4_2_2_core_form_btns_styling_selector . $search_button_selector . $file_block_button_selector . $search_page_btn_selector . $woo_btns_selector => array(
						'padding-top'                => smarttoolz_responsive_spacing( $theme_btn_padding, 'top', 'tablet' ),
						'padding-right'              => smarttoolz_responsive_spacing( $theme_btn_padding, 'right', 'tablet' ),
						'padding-bottom'             => smarttoolz_responsive_spacing( $theme_btn_padding, 'bottom', 'tablet' ),
						'padding-left'               => smarttoolz_responsive_spacing( $theme_btn_padding, 'left', 'tablet' ),
						'font-size'                  => smarttoolz_responsive_font( $theme_btn_font_size, 'tablet' ),
						'border-top-left-radius'     => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'top', 'tablet' ),
						'border-top-right-radius'    => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'right', 'tablet' ),
						'border-bottom-right-radius' => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'bottom', 'tablet' ),
						'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'left', 'tablet' ),
					),
				);
				...
				$global_button_mobile = array(
					'.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' . $v4_2_2_core_form_btns_styling_selector . $search_button_selector . $file_block_button_selector . $search_page_btn_selector . $woo_btns_selector => array(
						'padding-top'                => smarttoolz_responsive_spacing( $theme_btn_padding, 'top', 'mobile' ),
						'padding-right'              => smarttoolz_responsive_spacing( $theme_btn_padding, 'right', 'mobile' ),
						'padding-bottom'             => smarttoolz_responsive_spacing( $theme_btn_padding, 'bottom', 'mobile' ),
						'padding-left'               => smarttoolz_responsive_spacing( $theme_btn_padding, 'left', 'mobile' ),
						'font-size'                  => smarttoolz_responsive_font( $theme_btn_font_size, 'mobile' ),
						'border-top-left-radius'     => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'top', 'mobile' ),
						'border-top-right-radius'    => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'right', 'mobile' ),
						'border-bottom-right-radius' => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'bottom', 'mobile' ),
						'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'left', 'mobile' ),
					),
				);
				...
				if ( 'color-typo' === self::elementor_default_color_font_setting() || 'color' === self::elementor_default_color_font_setting() || 'typo' === self::elementor_default_color_font_setting() ) {
					...
					/* Parse CSS from array() */
					$parse_css .= smarttoolz_parse_css( $ele_btn_default_desktop );
					...
					/* Parse CSS from array() */
					$parse_css .= smarttoolz_parse_css( $ele_btn_default_tablet, '', smarttoolz_get_tablet_breakpoint() );
					...
					/* Parse CSS from array() */
					$parse_css .= smarttoolz_parse_css( $ele_btn_default_mobile, '', smarttoolz_get_mobile_breakpoint() );
				}
				...
				/* Parse CSS from array() */
				$parse_css .= smarttoolz_parse_css( $global_button_page_builder_text_color_desktop );
				...
				if ( isset( $ele_btn_color_builder_desktop ) ) {
					$parse_css .= smarttoolz_parse_css( $ele_btn_color_builder_desktop );
				}
				...
				if ( 'color-typo' === self::elementor_default_color_font_setting() || 'typo' === self::elementor_default_color_font_setting() ) {
					$ele_btn_typo_builder_desktop = array(
						'.elementor-widget-button .elementor-button' => smarttoolz_get_font_array_css( smarttoolz_get_option( 'font-family-button' ), smarttoolz_get_option( 'font-weight-button' ), $theme_btn_font_size, 'font-extras-button' ),
						'body .elementor-button.elementor-size-sm, body .elementor-button.elementor-size-xs, body .elementor-button.elementor-size-md, body .elementor-button.elementor-size-lg, body .elementor-button.elementor-size-xl, body .elementor-button' => array(
							'font-size' => smarttoolz_responsive_font( $theme_btn_font_size, 'desktop' ),
						),
					);

					/* Parse CSS from array() */
					$parse_css .= smarttoolz_parse_css( $ele_btn_typo_builder_desktop );
				}
				...
				if ( $block_editor_legacy_setup && self::gutenberg_core_patterns_compat() && ! smarttoolz_button_default_padding_updated() ) {
					$theme_outline_gb_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && ( '' !== $global_custom_button_border_size['top'] && '0' !== $global_custom_button_border_size['top'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '2px';
					$theme_outline_gb_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && ( '' !== $global_custom_button_border_size['right'] && '0' !== $global_custom_button_border_size['right'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '2px';
					$theme_outline_gb_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && ( '' !== $global_custom_button_border_size['bottom'] && '0' !== $global_custom_button_border_size['bottom'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '2px';
					$theme_outline_gb_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && ( '' !== $global_custom_button_border_size['left'] && '0' !== $global_custom_button_border_size['left'] ) ? smarttoolz_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '2px';
					...
					if ( smarttoolz_button_default_padding_updated() || ! $block_editor_legacy_setup ) {
						$default_border_size = '';
					}
					...
					$btn_top_border_size    = isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ? smarttoolz_get_css_value( $global_custom_button_border_size['top'], 'px' ) : $default_border_size;
					$btn_bottom_border_size = isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ? smarttoolz_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
					$btn_right_border_size  = isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ? smarttoolz_get_css_value( $global_custom_button_border_size['right'], 'px' ) : $default_border_size;
					$btn_left_border_size   = isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ? smarttoolz_get_css_value( $global_custom_button_border_size['left'], 'px' ) : $default_border_size;
				...
				/* Parse CSS from array() */
				$parse_css .= smarttoolz_parse_css( $global_button_page_builder_desktop );

				/* Parse CSS from array() */
				$parse_css .= smarttoolz_parse_css( $global_button_page_builder_tablet, '', smarttoolz_get_tablet_breakpoint() );
				/* Parse CSS from array() */
				$parse_css .= smarttoolz_parse_css( $global_button_page_builder_mobile, '', smarttoolz_get_mobile_breakpoint() );
			...
			if ( true === $update_customizer_strctural_defaults ) {
				$global_button_desktop['form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button.has-icon'] = array(
					'padding-top'    => 'calc(' . smarttoolz_responsive_spacing( $theme_btn_padding, 'top', 'desktop' ) . ' - 3px)',
					'padding-right'  => 'calc(' . smarttoolz_responsive_spacing( $theme_btn_padding, 'right', 'desktop' ) . ' - 3px)',
					'padding-bottom' => 'calc(' . smarttoolz_responsive_spacing( $theme_btn_padding, 'bottom', 'desktop' ) . ' - 3px)',
					'padding-left'   => 'calc(' . smarttoolz_responsive_spacing( $theme_btn_padding, 'left', 'desktop' ) . ' - 3px)',
				);
			}

			/* Parse CSS from array() */
			$parse_css .= smarttoolz_parse_css( $global_button_desktop );

			$parse_css .= smarttoolz_parse_css( $global_button_tablet, '', smarttoolz_get_tablet_breakpoint() );

			$parse_css .= smarttoolz_parse_css( $global_button_mobile, '', smarttoolz_get_mobile_breakpoint() );
			...
			if ( empty( $site_content_width ) ) {
				...
				$parse_css               .= smarttoolz_parse_css( $container_min_tablet_css, smarttoolz_get_tablet_breakpoint() );
			}
			...
			$global_button_tablet = array(
				'.menu-toggle, button, .ast-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' => array(
					'font-size' => smarttoolz_get_font_css_value( $theme_btn_font_size['tablet'], $theme_btn_font_size['tablet-unit'] ),
				),
			...
			/* Parse CSS from array() -> min-width: (mobile-breakpoint) px CSS  */
			$parse_css .= smarttoolz_parse_css( $container_min_mobile_css, smarttoolz_get_mobile_breakpoint() );
			...
			$global_button_mobile = array(
				...
				'.menu-toggle, button, .ast-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' => array(
					'font-size' => smarttoolz_get_font_css_value( $theme_btn_font_size['mobile'], $theme_btn_font_size['mobile-unit'] ),
				),
			);
			...
			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active && false === self::remove_logo_max_width_mobile_static_css() ) {
			...
			if ( SmartToolz_Builder_Helper::is_component_loaded( 'search', 'header', 'mobile' ) ) {
				...
				$parse_css .= smarttoolz_parse_css( $global_button_tablet_lang_direction_css, '', smarttoolz_get_tablet_breakpoint() );
			}

			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active && 'custom-button' === $header_custom_button_style ) {
				$css_output = array(
					...
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button, .ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-family'    => smarttoolz_get_font_family( $header_custom_btn_font_family ),
						'font-weight'    => esc_attr( $header_custom_btn_font_weight ),
						'font-size'      => smarttoolz_responsive_font( $header_custom_btn_font_size, 'desktop' ),
						'line-height'    => esc_attr( $header_custom_btn_line_height ),
						'text-transform' => esc_attr( $header_custom_btn_text_transform ),
						'letter-spacing' => smarttoolz_get_css_value( $header_custom_btn_letter_spacing, 'px' ),
					),
					...
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						...
						'padding-top'                => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'top', 'desktop' ),
						'padding-bottom'             => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'bottom', 'desktop' ),
						'padding-left'               => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'left', 'desktop' ),
						'padding-right'              => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'right', 'desktop' ),
						'border-top-left-radius'     => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'top', 'desktop' ),
						'border-top-right-radius'    => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'right', 'desktop' ),
						'border-bottom-right-radius' => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'bottom', 'desktop' ),
						'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $btn_border_radius_fields, 'left', 'desktop' ),
						...
						'border-top-width'           => isset( $header_custom_button_border_size['top'] ) && '' !== $header_custom_button_border_size['top'] ? smarttoolz_get_css_value( $header_custom_button_border_size['top'], 'px' ) : '0px',
						'border-right-width'         => isset( $header_custom_button_border_size['right'] ) && '' !== $header_custom_button_border_size['right'] ? smarttoolz_get_css_value( $header_custom_button_border_size['right'], 'px' ) : '0px',
						'border-left-width'          => isset( $header_custom_button_border_size['left'] ) && '' !== $header_custom_button_border_size['left'] ? smarttoolz_get_css_value( $header_custom_button_border_size['left'], 'px' ) : '0px',
						'border-bottom-width'        => isset( $header_custom_button_border_size['bottom'] ) && '' !== $header_custom_button_border_size['bottom'] ? smarttoolz_get_css_value( $header_custom_button_border_size['bottom'], 'px' ) : '0px',
					),
					...
					'.ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						...
						'padding-top'         => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'top', 'desktop' ),
						'padding-bottom'      => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'bottom', 'desktop' ),
						'padding-left'        => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'left', 'desktop' ),
						'padding-right'       => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'right', 'desktop' ),
						'border-radius'       => smarttoolz_get_css_value( $header_custom_trans_button_radius, 'px' ),
						'border-style'        => 'solid',
						'border-color'        => esc_attr( $header_custom_trans_button_border_color ),
						'border-top-width'    => isset( $header_custom_trans_button_border_size['top'] ) && '' !== $header_custom_trans_button_border_size['top'] ? smarttoolz_get_css_value( $header_custom_trans_button_border_size['top'], 'px' ) : '',
						'border-right-width'  => isset( $header_custom_trans_button_border_size['right'] ) && '' !== $header_custom_trans_button_border_size['right'] ? smarttoolz_get_css_value( $header_custom_trans_button_border_size['right'], 'px' ) : '',
						'border-left-width'   => isset( $header_custom_trans_button_border_size['left'] ) && '' !== $header_custom_trans_button_border_size['left'] ? smarttoolz_get_css_value( $header_custom_trans_button_border_size['left'], 'px' ) : '',
						'border-bottom-width' => isset( $header_custom_trans_button_border_size['bottom'] ) && '' !== $header_custom_trans_button_border_size['bottom'] ? smarttoolz_get_css_value( $header_custom_trans_button_border_size['bottom'], 'px' ) : '',
					),
				...
				$custom_button_css = array(
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => smarttoolz_responsive_font( $header_custom_btn_font_size, 'tablet' ),
						'padding-top'    => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'top', 'tablet' ),
						'padding-bottom' => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'bottom', 'tablet' ),
						'padding-left'   => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'left', 'tablet' ),
						'padding-right'  => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'right', 'tablet' ),
					),
				);
				...
				$custom_trans_button_css = array(
					'.ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => smarttoolz_responsive_font( $header_custom_btn_font_size, 'tablet' ),
						'padding-top'    => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'top', 'tablet' ),
						'padding-bottom' => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'bottom', 'tablet' ),
						'padding-left'   => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'left', 'tablet' ),
						'padding-right'  => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'right', 'tablet' ),
					),
				);

				/* Parse CSS from array()*/
				$parse_css .= smarttoolz_parse_css( array_merge( $custom_button_css, $custom_trans_button_css ), '', smarttoolz_get_tablet_breakpoint() );

				/* Custom Menu Item Button */
				$custom_button = array(
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => smarttoolz_responsive_font( $header_custom_btn_font_size, 'mobile' ),
						'padding-top'    => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'top', 'mobile' ),
						'padding-bottom' => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'bottom', 'mobile' ),
						'padding-left'   => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'left', 'mobile' ),
						'padding-right'  => smarttoolz_responsive_spacing( $header_custom_button_spacing, 'right', 'mobile' ),
					),
				);
				...
				$custom_trans_button = array(
					'.ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => smarttoolz_responsive_font( $header_custom_btn_font_size, 'mobile' ),
						'padding-top'    => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'top', 'mobile' ),
						'padding-bottom' => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'bottom', 'mobile' ),
						'padding-left'   => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'left', 'mobile' ),
						'padding-right'  => smarttoolz_responsive_spacing( $header_custom_trans_button_spacing, 'right', 'mobile' ),
					),
				);

				/* Parse CSS from array()*/
				$parse_css .= smarttoolz_parse_css( array_merge( $custom_button, $custom_trans_button ), '', smarttoolz_get_mobile_breakpoint() );
			}
			...
			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				...
				if ( ! empty( $footer_adv_link_color ) ) {
					$footer_adv_tagcloud = array(
						'.footer-adv .tagcloud a:hover, .footer-adv .tagcloud a.current-item' => array(
							'color' => smarttoolz_get_foreground_color( $footer_adv_link_color ),
						),
						'.footer-adv .calendar_wrap #today' => array(
							'color' => smarttoolz_get_foreground_color( $footer_adv_link_color ),
						),
					);
					$parse_css          .= smarttoolz_parse_css( $footer_adv_tagcloud );
				}
			}

			/* Width for Footer */
			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active && 'content' !== $smarttoolz_footer_width ) {
				...
				/* Parse CSS from array()*/
				$parse_css .= smarttoolz_parse_css( $genral_global_responsive, smarttoolz_get_tablet_breakpoint( '', 1 ) );
			}

			/* Preventing link redirection when the cart is clicked */
			if ( 'redirect' !== smarttoolz_get_option( 'responsive-cart-click-action' ) ) {
				...
				/* Parse CSS from array()*/
				$parse_css .= smarttoolz_parse_css( $desktop_cart_link_event );
			}

			/* Preventing link redirection when the cart is clicked */
			if ( is_customize_preview() && 'redirect' !== smarttoolz_get_option( 'woo-header-cart-click-action' ) ) {
				...
				/* Parse CSS from array()*/
				$parse_css .= smarttoolz_parse_css( $responsive_cart_link_event );
			}
			...
			if ( 'page-builder' === $container_layout ) {
				$page_builder_comment = array(
					'.ast-page-builder-template .comments-area, .single.ast-page-builder-template .entry-header, .single.ast-page-builder-template .post-navigation, .single.ast-page-builder-template .ast-single-related-posts-container' => array(
						'max-width'    => smarttoolz_get_css_value( $site_content_width + 40, 'px' ),
						'margin-left'  => 'auto',
						'margin-right' => 'auto',
					),
				);
				/* Parse CSS from array()*/
				$parse_css .= smarttoolz_parse_css( $page_builder_comment, smarttoolz_get_mobile_breakpoint( '', 1 ) );

			}

			$smarttoolz_spearate_container_selector = 'body, .ast-separate-container';
			if ( smarttoolz_has_gcp_typo_preset_compatibility() && true === smarttoolz_apply_content_background_fullwidth_layouts() ) {
				$smarttoolz_spearate_container_selector = '.ast-separate-container';
			}

			$separate_container_css = array(
				$smarttoolz_spearate_container_selector => smarttoolz_get_responsive_background_obj( $box_bg_obj, 'desktop' ),
			);
			$parse_css             .= smarttoolz_parse_css( $separate_container_css );
			...
			if ( $block_editor_legacy_setup ) {
				...
				if ( true === $improve_gb_ui ) {
					...
					/* Parse CSS from array -> Desktop CSS. */
					$parse_css .= smarttoolz_parse_css( $core_blocks_width_desktop_ui_css );
					...
					$parse_css .= smarttoolz_parse_css( $core_blocks_min_width_tablet_ui_css, smarttoolz_get_tablet_breakpoint() );
					...
					$parse_css .= smarttoolz_parse_css( $core_blocks_min_width_1200_ui_css, '1200' );
					...
					$parse_css .= smarttoolz_parse_css( $core_blocks_min_width_mobile_ui_css, smarttoolz_get_mobile_breakpoint( '', 1 ) );
				} else {
					$smarttoolz_no_sidebar_layout_css =
					...
					$parse_css .= SmartToolz_Enqueue_Scripts::trim_css( $smarttoolz_no_sidebar_layout_css );
				}
			}
			...
			if ( isset( $body_font_size['tablet'] ) && '' != $body_font_size['tablet'] ) {
					...
					$tablet_typo = array(
						// Widget Title.
						'.widget-title' => array(
							'font-size' => smarttoolz_get_font_css_value( (int) $body_font_size['tablet'] * 1.428571429, 'px', 'tablet' ),
						),
					);
			}
			...
			$tablet_typography = array(
				'body, button, input, select, textarea, .ast-button, .ast-custom-button' => array(
					'font-size' => smarttoolz_responsive_font( $body_font_size, 'tablet' ),
				),
				'#secondary, #secondary button, #secondary input, #secondary select, #secondary textarea' => array(
					'font-size' => smarttoolz_responsive_font( $body_font_size, 'tablet' ),
				),
				'.site-title'                    => array(
					'font-size' => smarttoolz_responsive_font( $site_title_font_size, 'tablet' ),
					'display'   => esc_attr( $tablet_title_visibility ),
				),
				'.site-header .site-description' => array(
					'font-size' => smarttoolz_responsive_font( $site_tagline_font_size, 'tablet' ),
					'display'   => esc_attr( $tablet_tagline_visibility ),
				),
				'.entry-title'                   => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_title_font_size, 'tablet' ),
				),
				'.ast-blog-single-element.ast-taxonomy-container a' => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_tax_font_size, 'tablet' ),
				),
				'.ast-blog-meta-container'       => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_meta_font_size, 'tablet' ),
				),
				'blog-layout-4' === $blog_layout ? '.archive .ast-article-post .ast-article-inner, .blog .ast-article-post .ast-article-inner' : '.archive .ast-article-post, .ast-article-post .post-thumb-img-content, .ast-blog-layout-6-grid .ast-article-inner .post-thumb::after, .blog .ast-article-post' => array(
					'border-top-left-radius'     => smarttoolz_responsive_spacing( $archive_cards_radius, 'top', 'tablet' ),
					'border-top-right-radius'    => smarttoolz_responsive_spacing( $archive_cards_radius, 'right', 'tablet' ),
					'border-bottom-right-radius' => smarttoolz_responsive_spacing( $archive_cards_radius, 'bottom', 'tablet' ),
					'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $archive_cards_radius, 'left', 'tablet' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h1_font_size, 'tablet', $heading_font_size_comp ? '' : 30 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h2_font_size, 'tablet', $heading_font_size_comp ? '' : 25 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h3_font_size, 'tablet', $heading_font_size_comp ? '' : 20 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h4_font_size, 'tablet' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h5_font_size, 'tablet' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h6_font_size, 'tablet' ),
				),
				'.smarttoolz-logo-svg'                => array(
					'width' => smarttoolz_get_css_value( $header_logo_width['tablet'], 'px' ),
				),
				'.smarttoolz-logo-svg:not(.sticky-custom-logo .smarttoolz-logo-svg, .transparent-custom-logo .smarttoolz-logo-svg, .advanced-header-logo .smarttoolz-logo-svg)' => array(
					'height' => smarttoolz_get_css_value( ! empty( $header_logo_width['tablet-svg-height'] ) && ! is_customize_preview() ? $header_logo_width['tablet-svg-height'] : '', 'px' ),
				),
				is_customize_preview() ? '.ast-sg-logo-section .custom-logo-link img, header .custom-logo-link img, .ast-header-break-point .site-logo-img .custom-mobile-logo-link img' : 'header .custom-logo-link img, .ast-header-break-point .site-logo-img .custom-mobile-logo-link img' => array(
					'max-width' => smarttoolz_get_css_value( $header_logo_width['tablet'], 'px' ),
					'width'     => smarttoolz_get_css_value( $header_logo_width['tablet'], 'px' ),
				),
				'body, .ast-separate-container'  => smarttoolz_get_responsive_background_obj( $box_bg_obj, 'tablet' ),
			);

			/* Parse CSS from array()*/
			$parse_css .= smarttoolz_parse_css( array_merge( $tablet_typo, $tablet_typography ), '', smarttoolz_get_tablet_breakpoint() );
			...
			if ( isset( $body_font_size['mobile'] ) && '' !== $body_font_size['mobile'] ) {
				$mobile_typo = array(
					// Widget Title.
					'.widget-title' => array(
						'font-size' => smarttoolz_get_font_css_value( (int) $body_font_size['mobile'] * 1.428571429, 'px', 'mobile' ),
					),
				);
			}
			...
			$mobile_typography = array(
				'body, button, input, select, textarea, .ast-button, .ast-custom-button' => array(
					'font-size' => smarttoolz_responsive_font( $body_font_size, 'mobile' ),
				),
				'#secondary, #secondary button, #secondary input, #secondary select, #secondary textarea' => array(
					'font-size' => smarttoolz_responsive_font( $body_font_size, 'mobile' ),
				),
				'.site-title'                    => array(
					'font-size' => smarttoolz_responsive_font( $site_title_font_size, 'mobile' ),
					'display'   => esc_attr( $mobile_title_visibility ),
				),
				'.site-header .site-description' => array(
					'font-size' => smarttoolz_responsive_font( $site_tagline_font_size, 'mobile' ),
					'display'   => esc_attr( $mobile_tagline_visibility ),
				),
				'.entry-title'                   => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_title_font_size, 'mobile' ),
				),
				'.ast-blog-single-element.ast-taxonomy-container a' => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_tax_font_size, 'mobile' ),
				),
				'.ast-blog-meta-container'       => array(
					'font-size' => smarttoolz_responsive_font( $archive_post_meta_font_size, 'mobile' ),
				),
				'blog-layout-4' === $blog_layout ? '.archive .ast-article-post .ast-article-inner, .blog .ast-article-post .ast-article-inner' : '.archive .ast-article-post, .ast-article-post .post-thumb-img-content, .ast-blog-layout-6-grid .ast-article-inner .post-thumb::after, .blog .ast-article-post' => array(
					'border-top-left-radius'     => smarttoolz_responsive_spacing( $archive_cards_radius, 'top', 'mobile' ),
					'border-top-right-radius'    => smarttoolz_responsive_spacing( $archive_cards_radius, 'right', 'mobile' ),
					'border-bottom-right-radius' => smarttoolz_responsive_spacing( $archive_cards_radius, 'bottom', 'mobile' ),
					'border-bottom-left-radius'  => smarttoolz_responsive_spacing( $archive_cards_radius, 'left', 'mobile' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h1_font_size, 'mobile', $heading_font_size_comp ? '' : 30 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h2_font_size, 'mobile', $heading_font_size_comp ? '' : 25 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h3_font_size, 'mobile', $heading_font_size_comp ? '' : 20 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h4_font_size, 'mobile' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h5_font_size, 'mobile' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => smarttoolz_responsive_font( $heading_h6_font_size, 'mobile' ),
				),
				is_customize_preview() ? '.ast-sg-logo-section .custom-logo-link img, header .custom-logo-link img, .ast-header-break-point .site-branding img, .ast-header-break-point .custom-logo-link img' : 'header .custom-logo-link img, .ast-header-break-point .site-branding img, .ast-header-break-point .custom-logo-link img' => array(
					'max-width' => smarttoolz_get_css_value( $header_logo_width['mobile'], 'px' ),
					'width'     => smarttoolz_get_css_value( $header_logo_width['mobile'], 'px' ),
				),
				'.smarttoolz-logo-svg'                => array(
					'width' => smarttoolz_get_css_value( $header_logo_width['mobile'], 'px' ),
				),
				'.smarttoolz-logo-svg:not(.sticky-custom-logo .smarttoolz-logo-svg, .transparent-custom-logo .smarttoolz-logo-svg, .advanced-header-logo .smarttoolz-logo-svg)' => array(
					'height' => smarttoolz_get_css_value( ! empty( $header_logo_width['mobile-svg-height'] ) && ! is_customize_preview() ? $header_logo_width['mobile-svg-height'] : '', 'px' ),
				),
				'.ast-header-break-point .site-logo-img .custom-mobile-logo-link img' => array(
					'max-width' => smarttoolz_get_css_value( $header_logo_width['mobile'], 'px' ),
				),
				'body, .ast-separate-container'  => smarttoolz_get_responsive_background_obj( $box_bg_obj, 'mobile' ),
			);

			/* Parse CSS from array()*/
			$parse_css .= smarttoolz_parse_css( array_merge( $mobile_typo, $mobile_typography ), '', smarttoolz_get_mobile_breakpoint() );
			...
			if ( '' == $body_font_size['tablet'] ) {
				$html_tablet_typography = array(
					'html' => array(
						'font-size' => smarttoolz_get_font_css_value( (int) $body_font_size_desktop * 5.7, '%' ),
					),
				);
				$parse_css             .= smarttoolz_parse_css( $html_tablet_typography, '', smarttoolz_get_tablet_breakpoint() );
			}
			...
			/* Parse CSS from array()*/
			$parse_css .= smarttoolz_parse_css( $html_mobile_typography, '', smarttoolz_get_mobile_breakpoint() );
			...
			/* Parse CSS from array()*/
			$parse_css .= smarttoolz_parse_css( $site_width, smarttoolz_get_tablet_breakpoint( '', 1 ) );

			/* Narrow width container layout dynamic css */
			$parse_css .= smarttoolz_narrow_container_width( smarttoolz_get_content_layout(), $narrow_container_max_width );
			...
			if ( SmartToolz_Builder_Helper::apply_flex_based_css() ) {
				...
				$parse_css             .= smarttoolz_parse_css( $max_site_container_css, smarttoolz_get_tablet_breakpoint( '', 1 ) );
				...
				$parse_css             .= smarttoolz_parse_css( $min_site_container_css, '', smarttoolz_get_tablet_breakpoint() );
			}

			/**
			 * SmartToolz Fonts
			 */
			if ( apply_filters( 'smarttoolz_enable_default_fonts', true ) ) {
				$smarttoolz_fonts          = '@font-face {';
					$smarttoolz_fonts     .= 'font-family: "SmartToolz";';
					$smarttoolz_fonts     .= 'src: url(' . SMARTTOOLZ_THEME_URI . 'assets/fonts/smarttoolz.woff) format("woff"),';
						$smarttoolz_fonts .= 'url(' . SMARTTOOLZ_THEME_URI . 'assets/fonts/smarttoolz.ttf) format("truetype"),';
						$smarttoolz_fonts .= 'url(' . SMARTTOOLZ_THEME_URI . 'assets/fonts/smarttoolz.svg#smarttoolz) format("svg");';
					$smarttoolz_fonts     .= 'font-weight: normal;';
					$smarttoolz_fonts     .= 'font-style: normal;';
					$smarttoolz_fonts     .= 'font-display: ' . smarttoolz_get_fonts_display_property() . ';';
				$smarttoolz_fonts         .= '}';
				$parse_css           .= $smarttoolz_fonts;
			}
			...
			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				 ...
				 */
				$smarttoolz_navigation  = '@media (max-width:' . $header_break_point . 'px) {';
				$smarttoolz_navigation .= '.main-header-bar .main-header-bar-navigation{';
				$smarttoolz_navigation .= 'display:none;';
				$smarttoolz_navigation .= '}';
				$smarttoolz_navigation .= '}';
				$parse_css        .= $smarttoolz_navigation;
			}
			...
			if ( 'custom' === $blog_width ) {
				...
				$blog_css   = array(
					'.blog .site-content > .ast-container, .archive .site-content > .ast-container, .search .site-content > .ast-container' => array(
						'max-width' => smarttoolz_get_css_value( $blog_max_width, 'px' ),
					),
				);
				$parse_css .= smarttoolz_parse_css( $blog_css, smarttoolz_get_tablet_breakpoint( '', 1 ) );
			}
			...
			if ( 'custom' === $single_post_max ) {
				...
				$single_blog_css = array(
					'.single-post .site-content > .ast-container' => array(
						'max-width' => smarttoolz_get_css_value( $single_post_max_width, 'px' ),
					),
				);
				$parse_css      .= smarttoolz_parse_css( $single_blog_css, smarttoolz_get_tablet_breakpoint( '', 1 ) );
			}
			...
			if ( 'custom' === $single_page_max ) {
				...
				$single_page_css = array(
					' .page .site-content > .ast-container' => array(
						'max-width' => smarttoolz_get_css_value( $single_page_max_width, 'px' ),
					),
				);
				$parse_css      .= smarttoolz_parse_css( $single_page_css, smarttoolz_get_tablet_breakpoint( '', 1 ) );
			}

			if ( self::smarttoolz_headings_clear_compatibility() && is_singular() ) {
				/**
			...
			$blog_addon_condition = defined( 'SMARTTOOLZ_EXT_VER' ) && SmartToolz_Ext_Extension::is_active( 'blog-pro' );
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

			if ( is_search() || is_archive() || is_home() ) {
				if ( ! $blog_addon_condition ) {
					// If a old pro user has used blog-layout-1 to 3 and disabled smarttoolz addon then moved layout to 'blog-layout-4'.
				...
				$blog_grid   = smarttoolz_get_option( 'blog-grid' );
				...
				if ( 'blog-layout-4' === $blog_layout || 'blog-layout-6' === $blog_layout ) {
					...
					/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
					if ( ! ( defined( 'SMARTTOOLZ_EXT_VER' ) && SmartToolz_Ext_Extension::is_active( 'blog-pro' ) ) || ( $blog_addon_condition && 1 !== $blog_grid ) ) {
						/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				...
				$parse_css .= smarttoolz_parse_css( $blog_layout_css );
				...
				if ( 'blog-layout-4' === $blog_layout ) {
					...
					$parse_css .= smarttoolz_parse_css( $blog_layout_grid_css );
				}
				...
				if ( 'blog-layout-5' === $blog_layout ) {
					...
					$parse_css .= smarttoolz_parse_css( $blog_layout_list_css );

					$blog_layout_list_css_responsive = array();

					// Apply responsive CSS only if SmartToolz Pro is active.
					...
					$parse_css .= smarttoolz_parse_css( $blog_layout_list_css_responsive, '', smarttoolz_get_tablet_breakpoint() );
				}
				...
				if ( 'blog-layout-6' === $blog_layout ) {
					...
					if ( ( defined( 'SMARTTOOLZ_EXT_VER' ) && SmartToolz_Ext_Extension::is_active( 'blog-pro' ) ) && ( 1 === $blog_grid ) ) {
					...
					$parse_css .= smarttoolz_parse_css( $blog_layout_cover_css );
				}
				...
				$parse_css .= smarttoolz_parse_css( $blog_layout_css_responsive, '', smarttoolz_get_tablet_breakpoint() );

				$parse_css .= SmartToolz_Enqueue_Scripts::trim_css( self::blog_layout_static_css() );
				...
				if ( $aspect_ratio && $with_aspect_img_width ) {
						...
						$parse_css          .= smarttoolz_parse_css( $blog_featured_image );
				}
				...
				if ( 'custom' === $aspect_ratio_type ) {
					...
					$parse_css        .= smarttoolz_parse_css( $cover_style_image );
				}

				$author_avatar = smarttoolz_get_option( 'blog-meta-author-avatar' );
				...
				if ( $author_avatar ) {
					...
					$parse_css      .= smarttoolz_parse_css( $blog_author_css );
				}

				$blog_archive_hover_effect = smarttoolz_get_option( 'blog-hover-effect' );
				...
				if ( 'none' !== $blog_archive_hover_effect ) {
					...
					$parse_css .= smarttoolz_parse_css( $blog_archive_hover_effect_css );
				}

				// Post elements.
				$categories_styles      = smarttoolz_get_option( 'blog-category-style' );
				$tag_styles             = smarttoolz_get_option( 'blog-tag-style' );
				$categories_meta_styles = smarttoolz_get_option( 'blog-meta-category-style' );
				$tag_meta_styles        = smarttoolz_get_option( 'blog-meta-tag-style' );
				...
				if ( $categories_styles || $tag_styles || $categories_meta_styles || $tag_meta_styles ) {
					...
					';
					$parse_css      .= SmartToolz_Enqueue_Scripts::trim_css( $post_tax_style );
				}
			}

			// Primary Submenu Border Width & Color.
			$submenu_border_style = array(
				'.ast-desktop .main-header-menu.submenu-with-border .sub-menu, .ast-desktop .main-header-menu.submenu-with-border .smarttoolz-full-megamenu-wrapper' => array(
					'border-color' => esc_attr( $primary_submenu_b_color ),
				),

				'.ast-desktop .main-header-menu.submenu-with-border .sub-menu' => array(
					'border-top-width'    => ! empty( $submenu_border['top'] ) ? smarttoolz_get_css_value( $submenu_border['top'], 'px' ) : '',
					'border-right-width'  => ! empty( $submenu_border['right'] ) ? smarttoolz_get_css_value( $submenu_border['right'], 'px' ) : '',
					'border-left-width'   => ! empty( $submenu_border['left'] ) ? smarttoolz_get_css_value( $submenu_border['left'], 'px' ) : '',
					'border-bottom-width' => ! empty( $submenu_border['bottom'] ) ? smarttoolz_get_css_value( $submenu_border['bottom'], 'px' ) : '',
					'border-style'        => 'solid',
				),
				'.ast-desktop .main-header-menu.submenu-with-border .sub-menu .sub-menu' => array(
					'top' => isset( $submenu_border['top'] ) && '' != $submenu_border['top'] ? smarttoolz_get_css_value( '-' . $submenu_border['top'], 'px' ) : '',
				),
			...
			$submenu_border_for_left_align_menu = array(
				'.main-header-menu .sub-menu .menu-item.ast-left-align-sub-menu:hover > .sub-menu, .main-header-menu .sub-menu .menu-item.ast-left-align-sub-menu.focus > .sub-menu' => array(
					'margin-left' => ( isset( $submenu_border['left'] ) && '' != $submenu_border['left'] ) || isset( $submenu_border['right'] ) && '' != $submenu_border['right'] ? smarttoolz_get_css_value( '-' . ( (int) $submenu_border['left'] + (int) $submenu_border['right'] ), 'px' ) : '',
				),
			);

			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
				$parse_css .= smarttoolz_parse_css( $submenu_border_style );
			}

			// Submenu items goes outside?
			$parse_css .= smarttoolz_parse_css( $submenu_border_for_left_align_menu, smarttoolz_get_tablet_breakpoint( '', 1 ) );

			/* Small Footer CSS */
			if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active && 'disabled' !== $small_footer_layout ) {
				$sml_footer_css = array(
					'.ast-small-footer' => array(
						'border-top-style' => 'solid',
						'border-top-width' => smarttoolz_get_css_value( $small_footer_divider, 'px' ),
						'border-top-color' => esc_attr( $small_footer_divider_color ),
					),
				);
				$parse_css     .= smarttoolz_parse_css( $sml_footer_css );
			...
			if ( true === SmartToolz_Builder_Helper::$is_header_footer_builder_active && SmartToolz_Ext_Transparent_Header_Markup::is_transparent_header() ) {

				$html_text_color   = smarttoolz_get_option( 'transparent-header-html-text-color' );
				$html_link_color   = smarttoolz_get_option( 'transparent-header-html-link-color' );
				$html_link_h_color = smarttoolz_get_option( 'transparent-header-html-link-h-color' );

				$search_icon_color = smarttoolz_get_option( 'transparent-header-search-icon-color' );
				$search_text_color = smarttoolz_get_option( 'transparent-header-search-box-placeholder-color' );

				$search_box_bg_color = smarttoolz_get_option( 'transparent-header-search-box-background-color' );

				$social_color          = smarttoolz_get_option( 'transparent-header-social-icons-color' );
				$social_hover_color    = smarttoolz_get_option( 'transparent-header-social-icons-h-color' );
				$social_bg_color       = smarttoolz_get_option( 'transparent-header-social-icons-bg-color' );
				$social_bg_hover_color = smarttoolz_get_option( 'transparent-header-social-icons-bg-h-color' );

				$button_color          = smarttoolz_get_option( 'transparent-header-button-text-color' );
				$button_h_color        = smarttoolz_get_option( 'transparent-header-button-text-h-color' );
				$button_bg_color       = smarttoolz_get_option( 'transparent-header-button-bg-color' );
				$button_bg_h_color     = smarttoolz_get_option( 'transparent-header-button-bg-h-color' );
				$button_border_color   = smarttoolz_get_option( 'transparent-header-button-border-color' );
				$button_h_border_color = smarttoolz_get_option( 'transparent-header-button-border-h-color' );

				$divider_color                = smarttoolz_get_option( 'transparent-header-divider-color' );
				$account_icon_color           = smarttoolz_get_option( 'transparent-account-icon-color' );
				$account_loggedout_text_color = smarttoolz_get_option( 'transparent-account-type-text-color' );

				// Menu colors.
				$account_menu_color           = smarttoolz_get_option( 'transparent-account-menu-color' );
				$account_menu_bg_color        = smarttoolz_get_option( 'transparent-account-menu-bg-obj' );
				$account_menu_color_hover     = smarttoolz_get_option( 'transparent-account-menu-h-color' );
				$account_menu_bg_color_hover  = smarttoolz_get_option( 'transparent-account-menu-h-bg-color' );
				$account_menu_color_active    = smarttoolz_get_option( 'transparent-account-menu-a-color' );
				$account_menu_bg_color_active = smarttoolz_get_option( 'transparent-account-menu-a-bg-color' );
				...
				$transparent_header_builder_desktop_css = array(
					...
					'.ast-theme-transparent-header .ast-header-search .smarttoolz-search-icon, .ast-theme-transparent-header .ast-header-search .search-field::placeholder, .ast-theme-transparent-header .ast-header-search .ast-icon'         => array(
					...
					$widget_title_color      = smarttoolz_get_option( 'transparent-header-widget-title-color' );
					$widget_content_color    = smarttoolz_get_option( 'transparent-header-widget-content-color' );
					$widget_link_color       = smarttoolz_get_option( 'transparent-header-widget-link-color' );
					$widget_link_hover_color = smarttoolz_get_option( 'transparent-header-widget-link-h-color' );
					...
					if ( SmartToolz_Builder_Helper::is_component_loaded( 'mobile-trigger', 'header', 'mobile' ) ) {

						$transparent_toggle_selector = '.ast-theme-transparent-header [data-section="section-header-mobile-trigger"]';

						$trigger_bg           = smarttoolz_get_option( 'transparent-header-toggle-btn-bg-color' );
						$trigger_border_color = smarttoolz_get_option( 'transparent-header-toggle-border-color', $trigger_bg );
						$style                = smarttoolz_get_option( 'mobile-header-toggle-btn-style' );

						$icon_color = smarttoolz_get_option( 'transparent-header-toggle-btn-color' );
					...
					$parse_css .= smarttoolz_parse_css( $transparent_header_builder_desktop_css );
					...
					$parse_css .= smarttoolz_parse_css( $transparent_header_builder_tablet_css, '', smarttoolz_get_tablet_breakpoint() );
					...
					$parse_css .= smarttoolz_parse_css( $transparent_header_builder_mobile_css, '', smarttoolz_get_mobile_breakpoint() );
			}

			if ( self::smarttoolz_list_block_vertical_spacing() ) {
				$list_spacing_css = array(
					'.entry-content li > p' => array(
						'margin-bottom' => 0,
					),
				);
				$parse_css       .= smarttoolz_parse_css( $list_spacing_css );
			}

			if ( self::smarttoolz_fullwidth_sidebar_support() ) {
				if ( 'page-builder' === $ast_container_layout ) {
					add_filter(
						'smarttoolz_page_layout',
			...
			if ( smarttoolz_get_option( 'enable-comments-area', true ) ) {
				$parse_css .= SmartToolz_Extended_Base_Dynamic_CSS::prepare_inner_section_advanced_css( 'ast-sub-section-comments', '.site .comments-area' );

				$comments_radius = smarttoolz_get_option(
				...
				$list_spacing_css = array(
					'.comments-area .comments-title, .comments-area .comment-respond' => array(
						'border-top-left-radius'     => ! empty( smarttoolz_get_css_value( $comments_radius['top'] ) ) ? smarttoolz_get_css_value( $comments_radius['top'], 'px' ) : '',
						'border-bottom-right-radius' => ! empty( smarttoolz_get_css_value( $comments_radius['bottom'] ) ) ? smarttoolz_get_css_value( $comments_radius['bottom'], 'px' ) : '',
						'border-bottom-left-radius'  => ! empty( smarttoolz_get_css_value( $comments_radius['left'] ) ) ? smarttoolz_get_css_value( $comments_radius['left'], 'px' ) : '',
						'border-top-right-radius'    => ! empty( smarttoolz_get_css_value( $comments_radius['right'] ) ) ? smarttoolz_get_css_value( $comments_radius['right'], 'px' ) : '',
					),
				);
				$parse_css       .= smarttoolz_parse_css( $list_spacing_css );
			}
			...
			$custom_css = smarttoolz_get_option( 'custom-css' );
			...
			$parse_css = SmartToolz_Enqueue_Scripts::trim_css( $parse_css );

			return apply_filters( 'smarttoolz_theme_dynamic_css', $parse_css );
		}

		/**
		 * SmartToolz update default font size and font weight.
		 *
		 * @since 4.6.5
		 * @return bool
		 */
		public static function elementor_heading_margin_style_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'elementor_heading_margin', isset( $smarttoolz_settings['elementor-headings-style'] ) ? false : true );
		}
		 ...
		 * @return bool
		 */
		public static function smarttoolz_heading_inside_widget_font_size_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_heading_inside_widget_font_size', isset( $smarttoolz_settings['heading-widget-font-size'] ) ? false : true );
		}
		...
		public static function elementor_container_padding_style_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'elementor_container_padding', isset( $smarttoolz_settings['elementor-container-padding-style'] ) ? false : true );
		}
		...
		public static function elementor_btn_styling_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_elementor_button_body_selector_compatibility', isset( $smarttoolz_settings['elementor-btn-styling'] ) && $smarttoolz_settings['elementor-btn-styling'] ? true : false );
		}
		...
		public static function heading_font_size_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'heading_font_size_compatibility', isset( $smarttoolz_settings['smarttoolz-heading-font-size-compatibility'] ) ? false : true );
		}
		...
		public static function return_meta_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			 ...
			 *   - Sidebar Positions CSS
			 */
			$secondary_width = absint( smarttoolz_get_option( 'site-sidebar-width' ) );
			$primary_width   = absint( 100 - $secondary_width );
			$meta_style      = '';

			// Header Separator.
			$header_separator       = smarttoolz_get_option( 'header-main-sep' );
			$header_separator_color = smarttoolz_get_option( 'header-main-sep-color' );

			$meta_style = array(
				'.ast-header-break-point .main-header-bar' => array(
					'border-bottom-width' => smarttoolz_get_css_value( $header_separator, 'px' ),
					'border-bottom-color' => esc_attr( $header_separator_color ),
				),
			);

			$parse_css = smarttoolz_parse_css( $meta_style );
			...
			$parse_css .= smarttoolz_parse_css( $meta_style, smarttoolz_get_tablet_breakpoint( '', 1 ) );

			if ( 'no-sidebar' !== smarttoolz_page_layout() ) {

				$meta_style = array(
					'#primary'   => array(
						'width' => smarttoolz_get_css_value( $primary_width, '%' ),
					),
					'#secondary' => array(
						'width' => smarttoolz_get_css_value( strval( $secondary_width ), '%' ),
					),
				);
			...
			if ( false === self::smarttoolz_submenu_below_header_fix() ) {
				...
				$parse_css .= smarttoolz_parse_css( $submenu_below_header );
				...
				// Hence this is added to dynamic CSS which will be applied only if this filter `smarttoolz_submenu_below_header_fix` is enabled.
				// @see https://github.com/brainstormforce/smarttoolz/pull/828
				$submenu_below_header = array(
					'.main-header-menu .menu-item, #smarttoolz-footer-menu .menu-item, .main-header-bar .ast-masthead-custom-menu-items' => array(
						'-js-display'             => 'flex',
						'display'                 => '-webkit-box',
						'display'                 => '-webkit-flex',
						'display'                 => '-moz-box',
					...
					'.main-header-menu > .menu-item > .menu-link, #smarttoolz-footer-menu > .menu-item > .menu-link' => array(
						'height'              => '100%',
						'-webkit-box-align'   => 'center',
						'-webkit-align-items' => 'center',
						'-moz-box-align'      => 'center',
			...
			if ( false === self::smarttoolz_submenu_open_below_header_fix() ) {
				// If submenu below header fix is not to be loaded then add removed flex properties from class `ast-flex`.
				// Also restore the padding to class `main-header-bar`.
				$submenu_below_header = array(
					// CSS to open submenu just below menu.
			...
			if ( false === SmartToolz_Icons::is_svg_icons() ) {
				...
				$submenu_toggle = array(
					...
					'.smarttoolz-search-icon::before'        => array(
						'content'                 => '"\e8b6"',
						'font-family'             => 'SmartToolz',
						'font-style'              => 'normal',
						'font-weight'             => 'normal',
			...
			$parse_css .= smarttoolz_parse_css( $submenu_toggle );

			$dynamic_css .= $parse_css;

			$ltr_right    = is_rtl() ? esc_attr( 'left' ) : esc_attr( 'right' );
			$dynamic_css .= smarttoolz_parse_css(
				array(
		 ...
		 *
		 * Historically SmartToolz adds Colors/Typography CSS for headings and anchors for headings but this causes irregularities with the expected output.
		 * For eg Link color does not work for the links inside headings.
		 *
		 * If filter `smarttoolz_include_achors_in_headings_typography` is set to true or SmartToolz Option `include-headings-in-typography` is set to true, This will return selectors with anchors. Else This will return selectors without anchors.
		 *
		 * @since 1.4.9
		...
		public static function anchors_in_css_selectors_heading() {
			...
			if ( true === smarttoolz_get_option( 'include-headings-in-typography' ) &&
				true === apply_filters(
					'smarttoolz_include_achors_in_headings_typography',
					true
				) ) {
		 ...
		 */
		public static function smarttoolz_submenu_below_header_fix() {

			if ( false === smarttoolz_get_option( 'submenu-below-header', true ) &&
				false === apply_filters(
					'smarttoolz_submenu_below_header_fix',
					false
				) ) {
		 ...
		 */
		public static function smarttoolz_submenu_open_below_header_fix() {

			if ( false === smarttoolz_get_option( 'submenu-open-below-header', true ) &&
				false === apply_filters(
					'smarttoolz_submenu_open_below_header_fix',
					false
				) ) {
		...
		public static function page_builder_button_style_css() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_page_builder_button_style_css', isset( $smarttoolz_settings['pb-button-color-compatibility'] ) && false === $smarttoolz_settings['pb-button-color-compatibility'] ? false : true );
		}
		...
		public static function is_block_editor_support_enabled() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_has_block_editor_support', isset( $smarttoolz_settings['support-block-editor'] ) && false === $smarttoolz_settings['support-block-editor'] ? false : true );
		}
		...
		public static function is_elementor_default_color_font_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_elementor_default_color_font_comp', isset( $smarttoolz_settings['ele-default-color-typo-setting-comp'] ) && false === $smarttoolz_settings['ele-default-color-typo-setting-comp'] ? false : true );
		}
		 ...
		 */
		public static function smarttoolz_list_block_vertical_spacing() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_list_block_vertical_spacing', isset( $smarttoolz_settings['list-block-vertical-spacing'] ) ? false : true );
		}
		...
		public static function gtn_image_group_css_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_gutenberg_image_group_style_support', isset( $smarttoolz_settings['gtn-full-wide-image-grp-css'] ) ? false : true );
		}
		...
		public static function gtn_group_cover_css_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_gtn_group_cover_css_comp', isset( $smarttoolz_settings['gtn-full-wide-grp-cover-css'] ) ? false : true );
		}
		...
		public static function gutenberg_core_blocks_css_comp() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_gutenberg_core_blocks_design_compatibility', isset( $smarttoolz_settings['guntenberg-core-blocks-comp-css'] ) ? false : true );
		}
		...
		public static function gutenberg_media_text_block_css_compat() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_gutenberg_media_text_block_spacing_compatibility', isset( $smarttoolz_settings['guntenberg-media-text-block-padding-css'] ) ? false : true );
		}
		...
		public static function gutenberg_core_patterns_compat() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_gutenberg_patterns_compatibility', isset( $smarttoolz_settings['guntenberg-button-pattern-compat-css'] ) ? false : true );
		}
		...
		public static function support_font_css_to_widget_and_in_editor() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_heading_fonts_typo_support', isset( $smarttoolz_settings['can-support-widget-and-editor-fonts'] ) ? false : true );
		}

		/**
		 * Whether to remove or not following CSS which restricts logo size on responsive devices.
		 *
		 * @see https://github.com/brainstormforce/smarttoolz/commit/d09f63336b73d58c8f8951726edbc90671d7f419
		 *
		 * @since 3.6.0
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function remove_logo_max_width_mobile_static_css() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_remove_logo_max_width_css', isset( $smarttoolz_settings['can-remove-logo-max-width-css'] ) ? false : true );
		}
		...
		public static function unset_builder_elements_underline() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_unset_builder_elements_underline', isset( $smarttoolz_settings['unset-builder-elements-underline'] ) ? false : true );
		}
		...
		public static function v4_block_editor_compat() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_v4_block_editor_compat', isset( $smarttoolz_settings['v4-block-editor-compat'] ) ? false : true );
		}
		...
		/**
		 * SmartToolz Spectra Gutenberg Compatibility CSS.
		 *
		 * @since 3.9.4
		 * @return bool false if it is an existing user , true if not.
		 */
		public static function spectra_gutenberg_compat_css() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_spectra_gutenberg_compat_css', isset( $smarttoolz_settings['spectra-gutenberg-compat-css'] ) ? false : true );
		}
		...
		public static function load_cart_static_css() {
			...
			$btn_bg_color       = smarttoolz_get_option( 'button-bg-color', $theme_color );
			$btn_border_h_color = smarttoolz_get_option( 'theme-button-border-group-border-h-color' );
			$link_h_color       = smarttoolz_get_option( 'link-h-color' );
			$btn_bg_h_color     = smarttoolz_get_option( 'button-bg-h-color', '', $link_h_color );
			...
			$empty_cart_btn_selector = self::smarttoolz_4_11_12_compatibility() ? '' : ',
			...
			.ast-site-header-cart i.smarttoolz-icon {
				font-size: 20px;
				font-size: 1.3em;
				font-style: normal;
				font-weight: normal;
			...
			.ast-site-header-cart i.smarttoolz-icon.no-cart-total:after,
			.ast-header-break-point.ast-header-custom-item-outside .ast-edd-header-cart-info-wrap,
			.ast-header-break-point.ast-header-custom-item-outside .ast-woo-header-cart-info-wrap {
				display: none;
			}

			.ast-site-header-cart.ast-menu-cart-fill i.smarttoolz-icon,
			.ast-edd-site-header-cart.ast-edd-menu-cart-fill span.smarttoolz-icon {
				font-size: 1.1em;
			}

			.smarttoolz-cart-drawer {
				position: fixed;
				display: block;
				visibility: hidden;
				overflow: auto;
			...
			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-header {
				position: absolute;
				width: 100%;
				text-align: ' . $ltr_left . ';
			...
			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-header .smarttoolz-cart-drawer-title {
				color: var(--ast-global-color-2);
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-close .ast-close-svg {
				width: 22px;
				height: 22px;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content,
			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .widget_shopping_cart,
			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .widget_shopping_cart_content {
				height: 100%;
			}
			...
			.smarttoolz-cart-drawer .ast-mini-cart-price-wrap .multiply-symbol{
				padding: 0 0.5em;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart-item .ast-mini-cart-price-wrap {
				float: ' . $ltr_right . ';
				margin-top: 0.5em;
				max-width: 50%;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart-item .variation {
				margin-top: 0.5em;
				margin-bottom: 0.5em;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart-item .variation dt {
				font-weight: 500;
			}
			...
			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .widget_shopping_cart_content ul li {
				min-height: 60px;
			}

			.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__total {
				display: flex;
			...
			.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__total strong,
			.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__total .amount {
				width: 50%;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart {
				padding: 1.3em;
				flex: 1;
				overflow: auto;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart a.remove {
				width: 20px;
				height: 20px;
				line-height: 16px;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__total {
				padding: 1em 1.5em;
				margin: 0;
				text-align: center;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons {
				padding: 1.34em;
				text-align: center;
				margin-bottom: 0;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button.checkout {
				margin-' . $ltr_right . ': 0;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons a{
				width: 100%;
			}

			.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons a:nth-last-child(1) {
				margin-bottom: 0;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .edd-cart-item {
				padding: .5em 2.6em .5em 1.5em;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .edd-cart-item .edd-remove-from-cart::after {
				width: 20px;
				height: 20px;
				line-height: 16px;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .edd-cart-number-of-items {
				padding: 1em 1.5em 1em 1.5em;
				margin-bottom: 0;
				text-align: center;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .edd_total {
				padding: .5em 1.5em;
				margin: 0;
				text-align: center;
			}

			.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .cart_item.edd_checkout {
				padding: 1em 1.5em 0;
				text-align: center;
				margin-top: 0;
			}
			.smarttoolz-cart-drawer .widget_shopping_cart_content > .woocommerce-mini-cart__empty-message {
				display: none;
			}
			.smarttoolz-cart-drawer .woocommerce-mini-cart__empty-message,
			.smarttoolz-cart-drawer .cart_item.empty {
				text-align: center;
				margin-top: 10px;
			}

			body.admin-bar .smarttoolz-cart-drawer {
				padding-top: 32px;
			}
			@media (max-width: 782px) {
				body.admin-bar .smarttoolz-cart-drawer {
			...
			.ast-mobile-cart-active .smarttoolz-mobile-cart-overlay {
				opacity: 1;
				cursor: pointer;
				visibility: visible;
				z-index: 999;
			...
			.smarttoolz-cart-drawer-content .ast-mini-cart-empty {
				height: 100%;
				display: flex;
				flex-direction: column;
				justify-content: space-between;
			...
			.smarttoolz-cart-drawer-content .ast-mini-cart-empty .ast-mini-cart-message {
				display: flex;
				align-items: center;
				justify-content: center;
				height: 100%;
			...
			@media (min-width: 546px) {
				.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content.ast-large-view .woocommerce-mini-cart__buttons {
					display: flex;
				}

				.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content.ast-large-view .woocommerce-mini-cart__buttons a,
				.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content.ast-large-view .woocommerce-mini-cart__buttons a.checkout {
					margin-top: 0;
					margin-bottom: 0;
				}
			}
			...
			if ( is_rtl() ) {
				$cart_static_css .= '
				.ast-site-header-cart i.smarttoolz-icon:after {
					content: attr(data-cart-total);
					position: absolute;
					font-family: ' . smarttoolz_get_font_family( smarttoolz_body_font_family() ) . ';
					font-style: normal;
					top: -10px;
					left: -12px;
					font-weight: bold;
				...
				li.woocommerce-custom-menu-item .ast-site-header-cart i.smarttoolz-icon:after,
				li.edd-custom-menu-item .ast-edd-site-header-cart span.smarttoolz-icon:after {
					padding-right: 2px;
				}
				.smarttoolz-cart-drawer .smarttoolz-cart-drawer-close {
					position: absolute;
					top: 0.5em;
					left: 0;
					border: none;
				...
				.smarttoolz-mobile-cart-overlay {
				...
				.smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .edd-cart-item .edd-remove-from-cart {
					left: 1.2em;
				}
				...
				.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping) {
					margin-left: 10px;
					background-color: transparent;
					border: 2px solid var( --ast-global-color-0 );
				...
				.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons .button:not(.checkout):not(.ast-continue-shopping):hover {
					border-color: var( --ast-global-color-1 );
					color: var( --ast-global-color-1 );
				}

				.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons a.checkout {
					margin-right: 0;
					margin-top: 10px;
				}
				...
				.woocommerce-js .smarttoolz-cart-drawer .smarttoolz-cart-drawer-content .woocommerce-mini-cart__buttons a.checkout:hover {
					border-color: ' . $hover_border_color . ';
				}
			...
			// This CSS requires in case of :before SmartToolz icons. But in case of SVGs this loads twice that's why removed this from static & loading conditionally.
			if ( false === SmartToolz_Icons::is_svg_icons() ) {
				$cart_static_css .= '
				.ast-site-header-cart .cart-container *,
				.ast-edd-site-header-cart .ast-edd-cart-container * {
		 ...
		 * @since 4.0.0
		 */
		public static function smarttoolz_check_default_color_typo() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_update_default_color_typo', isset( $smarttoolz_settings['update-default-color-typo'] ) ? false : true );
		}
		 ...
		 * @since 4.1.0
		 */
		public static function smarttoolz_woo_support_global_settings() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_woo_support_global_settings', isset( $smarttoolz_settings['woo_support_global_settings'] ) ? false : true );
		}
		 ...
		 * @since 4.4.0
		 */
		public static function smarttoolz_sticky_sidebar_css() {
			$css = '';
			if ( smarttoolz_get_option( 'site-sticky-sidebar', false ) ) {
		 ...
		 * @since 4.6.0
		 */
		public static function smarttoolz_default_forms_styling_dynamic_css() {
			$css                       = '';
			$enable_site_accessibility = smarttoolz_get_option( 'site-accessibility-toggle', false );
			$is_dark_palette           = SmartToolz_Global_Palette::is_dark_palette();
			...
			$forms_default_styling_css = array(
				...
				'button, .ast-button, .button, input[type="button"], input[type="reset"], input[type="submit"]' . ( smarttoolz_button_consistency_compatibility() ? ', a:where(.wp-block-button__link)' : '' ) => array(
					'border-radius' => '4px',
					'box-shadow'    => '0px 1px 2px 0px rgba(0, 0, 0, 0.05)',
				),
				':root'                   => array(
			...
			return $css . smarttoolz_parse_css( $forms_default_styling_css );
		}
		 ...
		 * @since 4.2.0
		 */
		public static function smarttoolz_fullwidth_sidebar_support() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_fullwidth_sidebar_support', isset( $smarttoolz_settings['fullwidth_sidebar_support'] ) ? false : true );
		}
		 ...
		 * @since 4.2.2
		 */
		public static function smarttoolz_core_form_btns_styling() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_core_form_btns_styling', isset( $smarttoolz_settings['v4-2-2-core-form-btns-styling'] ) ? false : true );
		}
		 ...
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function smarttoolz_4_4_0_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_addon_upgrade_fullscreen_search_submit_style', isset( $smarttoolz_settings['v4-4-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function smarttoolz_4_5_0_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_upgrade_color_styles', isset( $smarttoolz_settings['v4-5-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function smarttoolz_4_9_0_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_dark_palette_backward', isset( $smarttoolz_settings['v4-9-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @since 4.6.0
		 */
		public static function smarttoolz_4_6_0_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_v4-6-0-backward-option', isset( $smarttoolz_settings['v4-6-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @since 4.6.2
		 */
		public static function smarttoolz_4_6_2_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_v4-6-2-backward-option', isset( $smarttoolz_settings['v4-6-2-backward-option'] ) ? false : true );
		}

		/**
		 * Upgrade SmartToolz default button stylings & compatibility with Spectra buttons.
		 *
		 * @return bool true|false.
		 * @since 4.6.4
		 */
		public static function smarttoolz_4_6_4_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_btn-stylings-upgrade', isset( $smarttoolz_settings['btn-stylings-upgrade'] ) ? false : true );
		}
		 ...
		 * @since 4.6.12
		 */
		public static function smarttoolz_headings_clear_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			/**
			 ...
			 */
			return apply_filters( 'smarttoolz_get_option_single_posts_pages_heading_clear_none', isset( $smarttoolz_settings['single_posts_pages_heading_clear_none'] ) ? false : true );
		}
		 ...
		 * @since 4.8.2
		 */
		public static function smarttoolz_4_8_2_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_v4-8-2-backward-option', isset( $smarttoolz_settings['v4-8-2-backward-option'] ) ? false : true );
		}
		 ...
		 * @return bool true|false.
		 */
		public static function smarttoolz_4_6_14_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_enable-4-6-14-compatibility', isset( $smarttoolz_settings['enable-4-6-14-compatibility'] ) ? false : true );
		}

		/**
		 * Upgrade SmartToolz secondary button border to look style guide in sync.
		 *
		 * @return bool true|false.
		 * @since 4.8.0
		 */
		public static function smarttoolz_4_8_0_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_enable-4-8-0-compatibility', isset( $smarttoolz_settings['enable-4-8-0-compatibility'] ) ? false : true );
		}
		 ...
		 * @since 4.8.4
		 */
		public static function smarttoolz_4_8_4_compatibility() {
			$smarttoolz_settings = smarttoolz_get_options();
			return apply_filters( 'smarttoolz_get_option_enable-4-8-4-compatibility', isset( $smarttoolz_settings['enable-4-8-4-compatibility'] ) ? false : true );
		}
		 ...
		 * @since 4.8.9
		 */
		public static function smarttoolz_4_8_9_compatibility() {
			$smarttoolz_settings = get_option( SMARTTOOLZ_THEME_SETTINGS );
			return apply_filters( 'smarttoolz_get_option_enable-4-8-9-compatibility', isset( $smarttoolz_settings['enable-4-8-9-compatibility'] ) ? false : true );
		}
		 ...
		 * @since 4.11.12
		 */
		public static function smarttoolz_4_11_12_compatibility() {
			$smarttoolz_settings = get_option( SMARTTOOLZ_THEME_SETTINGS );
			return apply_filters( 'smarttoolz_get_option_enable-4-11-12-compatibility', isset( $smarttoolz_settings['enable-4-11-12-compatibility'] ) ? false : true );
		}
