...
/**
 * SmartToolz Beaver Builder Compatibility
 */
if ( ! class_exists( 'SmartToolz_Beaver_Builder' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class SmartToolz_Beaver_Builder {
		/**
		 * Member Variable
		 *
		 * @var object instance
		...
		public function __construct() {
			...
			add_filter( 'smarttoolz_disable_block_content_attr', array( $this, 'remove_smarttoolz_block_editor_attr' ), 10, 2 );
		}

		/**
		 * Disable SmartToolz's block editor attr which applied for further block layout CSS.
		 *
		 ...
		 */
		public function remove_smarttoolz_block_editor_attr( $flag, $post_id ) {
		...
		public function add_styles( $assets ) {
			...
			if ( ! empty( $assets['css'] ) ) {
				$assets['css'] = array( 'smarttoolz-bb-builder' => 'compatibility/page-builder/bb-plugin' ) + $assets['css'];
			}
			return $assets;
		}
 ...
 */
SmartToolz_Beaver_Builder::get_instance();
