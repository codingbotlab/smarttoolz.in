...
/**
 * SmartToolz Ubermenu Compatibility
 */
if ( ! class_exists( 'SmartToolz_Ubermeu' ) ) {
	...
	class SmartToolz_Ubermeu {
		...
		public function __construct() {
			add_filter( 'smarttoolz_enable_mobile_menu_buttons', array( $this, 'disable_primary_menu_toggle' ), 30 );
		}

		/**
		 * Disable the Mobile Menu toggles from SmartToolz if Uber Menu is used.
		 *
		 * @since  1.1.7
 ...
 */
SmartToolz_Ubermeu::get_instance();
