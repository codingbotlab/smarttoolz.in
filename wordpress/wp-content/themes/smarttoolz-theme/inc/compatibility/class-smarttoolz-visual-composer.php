...
/**
 * SmartToolz Visual Composer Compatibility
 */
if ( ! class_exists( 'SmartToolz_Visual_Composer' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class SmartToolz_Visual_Composer {
		/**
		 * Member Variable
		 *
		 * @var object instance
		...
		public function add_styles( $assets ) {
			if ( ! empty( $assets['css'] ) ) {
				$assets['css'] = array( 'smarttoolz-vc-builder' => 'compatibility/page-builder/vc-plugin' ) + $assets['css'];
			}
			return $assets;
		}
	}
 ...
 */
SmartToolz_Visual_Composer::get_instance();
