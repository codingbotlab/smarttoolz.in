...
/**
 * SmartToolz Web_Stories Compatibility
 *
 * @since 3.2.0
 */
class SmartToolz_Web_Stories {
	/**
	 * Constructor
	 *
	 * @since 3.2.0
	...
	public function __construct() {
		...
		add_action( apply_filters( 'smarttoolz_web_stories_position', 'smarttoolz_body_top' ), array( $this, 'web_stories_embed' ) );
		add_filter( 'smarttoolz_dynamic_theme_css', array( $this, 'web_stories_css' ) );
	}
	...
	public function web_stories_css( $dynamic_css, $dynamic_css_filtered = '' ) {
		...
		$dynamic_css .= smarttoolz_parse_css( $stories_css_array );
