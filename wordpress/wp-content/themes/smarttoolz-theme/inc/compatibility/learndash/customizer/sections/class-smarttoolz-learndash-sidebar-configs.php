...
if ( ! class_exists( 'SmartToolz_Learndash_Sidebar_Configs' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class SmartToolz_Learndash_Sidebar_Configs extends SmartToolz_Customizer_Config_Base {
		/**
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				array(
					'name'              => SMARTTOOLZ_THEME_SETTINGS . '[learndash-sidebar-layout]',
					'type'              => 'control',
					'control'           => 'ast-radio-image',
					'sanitize_callback' => array( 'SmartToolz_Customizer_Sanitizes', 'sanitize_choices' ),
					'section'           => 'section-leandash-general',
					'default'           => smarttoolz_get_option( 'learndash-sidebar-layout' ),
					'priority'          => 5,
				 ...
				 */
				array(
					'name'       => SMARTTOOLZ_THEME_SETTINGS . '[learndash-sidebar-style]',
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => 'section-leandash-general',
					'default'    => smarttoolz_get_option( 'learndash-sidebar-style', 'default' ),
					'priority'   => 5,
...
new SmartToolz_Learndash_Sidebar_Configs();
