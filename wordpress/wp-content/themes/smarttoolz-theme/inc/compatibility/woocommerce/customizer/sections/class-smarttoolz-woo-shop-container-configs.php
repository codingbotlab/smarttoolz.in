...
if ( ! class_exists( 'SmartToolz_Woo_Shop_Container_Configs' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class SmartToolz_Woo_Shop_Container_Configs extends SmartToolz_Customizer_Config_Base {
		/**
		 * Register SmartToolz-WooCommerce Shop Container Settings.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'              => SMARTTOOLZ_THEME_SETTINGS . '[woocommerce-ast-content-layout]',
					'type'              => 'control',
					'control'           => 'ast-radio-image',
					'sanitize_callback' => array( 'SmartToolz_Customizer_Sanitizes', 'sanitize_choices' ),
					'section'           => 'section-woo-general',
					'default'           => smarttoolz_get_option( 'woocommerce-ast-content-layout' ),
					'priority'          => 5,
				 ...
				 */
				array(
					'name'        => SMARTTOOLZ_THEME_SETTINGS . '[woocommerce-content-style]',
					'type'        => 'control',
					'control'     => 'ast-selector',
					'section'     => 'section-woo-general',
					'default'     => smarttoolz_get_option( 'woocommerce-content-style', 'default' ),
					'priority'    => 5,
...
new SmartToolz_Woo_Shop_Container_Configs();
