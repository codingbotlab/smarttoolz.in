...
/**
 * Class SmartToolz_Builder_Helper.
 */
final class SmartToolz_Builder_Helper {
	/**
	...
	public function __construct() {
		...
		self::$num_of_header_button = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['header-button'] : 1;
		self::$num_of_footer_button = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['footer-button'] : 0;

		self::$num_of_header_html = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['header-html'] : 2;
		self::$num_of_footer_html = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['footer-html'] : 2;

		self::$num_of_header_menu = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['header-menu'] : 2;

		self::$num_of_header_widgets = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['header-widget'] : 2;
		self::$num_of_footer_widgets = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['footer-widget'] : 4;

		self::$num_of_header_social_icons = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['header-social-icons'] : 1;
		self::$num_of_footer_social_icons = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['footer-social-icons'] : 1;

		// Divider.
		self::$num_of_header_divider = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['header-divider'] : 0;
		self::$num_of_footer_divider = defined( 'SMARTTOOLZ_EXT_VER' ) ? self::$component_count_array['footer-divider'] : 0;

		self::$num_of_footer_columns = defined( 'SMARTTOOLZ_EXT_VER' ) ? apply_filters( 'smarttoolz_footer_column_count', 6 ) : 6;
	...
	public function initialize() {
		...
		self::$footer_row_layouts = apply_filters(
			...
			array(
				...
				'tablet'     => array(
					'6' => array(
						'6-equal' => array(
							'tooltip' => __( 'Equal Width Columns', 'smarttoolz' ),
							'icon'    => 'sixcol',
						),
						'full'    => array(
							'tooltip' => __( 'Collapse to Rows', 'smarttoolz' ),
							'icon'    => 'collapserowsix',
						),
					),
					'5' => array(
					...
					'4' => array(
						...
						'2-equal' => array(
							'tooltip' => __( 'Two Column Grid', 'smarttoolz' ),
							'icon'    => 'grid',
						),
						'full'    => array(
							'tooltip' => __( 'Collapse to Rows', 'smarttoolz' ),
					...
					'3' => array(
						...
						'3-lheavy'   => array(
							'tooltip' => __( 'Left Heavy 50/25/25', 'smarttoolz' ),
							'icon'    => 'lefthalf',
						),
						'3-rheavy'   => array(
							'tooltip' => __( 'Right Heavy 25/25/50', 'smarttoolz' ),
							'icon'    => 'righthalf',
						),
						'3-cheavy'   => array(
							'tooltip' => __( 'Center Heavy 25/50/25', 'smarttoolz' ),
							'icon'    => 'centerhalf',
						),
						'3-cwide'    => array(
							'tooltip' => __( 'Wide Center 20/60/20', 'smarttoolz' ),
							'icon'    => 'widecenter',
						),
						'3-firstrow' => array(
							'tooltip' => __( 'First Row, Next Columns 100 - 50/50', 'smarttoolz' ),
							'icon'    => 'firstrow',
						),
						'3-lastrow'  => array(
							'tooltip' => __( 'Last Row, Previous Columns 50/50 - 100', 'smarttoolz' ),
							'icon'    => 'lastrow',
						),
						'full'       => array(
							'tooltip' => __( 'Collapse to Rows', 'smarttoolz' ),
					...
					'2' => array(
						...
						'2-lheavy' => array(
							'tooltip' => __( 'Left Heavy 66/33', 'smarttoolz' ),
							'icon'    => 'twoleftgolden',
						),
						'2-rheavy' => array(
							'tooltip' => __( 'Right Heavy 33/66', 'smarttoolz' ),
							'icon'    => 'tworightgolden',
						),
						'full'     => array(
							'tooltip' => __( 'Collapse to Rows', 'smarttoolz' ),
					...
					'1' => array(
						'full' => array(
							'tooltip' => __( 'Single Row', 'smarttoolz' ),
							'icon'    => 'row',
						),
					),
				),
		...
		self::$header_desktop_items = apply_filters(
			'smarttoolz_header_desktop_items',
			array(
				'logo'    => array(
					'name'    => __( 'Site Title & Logo', 'smarttoolz' ),
					'icon'    => 'admin-appearance',
					'section' => 'title_tagline',
					'delete'  => false,
				),
				'search'  => array(
					'name'    => __( 'Search', 'smarttoolz' ),
					'icon'    => 'search',
					'section' => 'section-header-search',
					'delete'  => false,
				),
				'account' => array(
					'name'    => __( 'Account', 'smarttoolz' ),
					'icon'    => 'admin-users',
		...
		self::$footer_desktop_items = apply_filters(
			'smarttoolz_footer_desktop_items',
			array(
				'copyright' => array(
					'name'    => 'Copyright',
					'icon'    => 'nametag',
		...
		if ( ! defined( 'SMARTTOOLZ_EXT_VER' ) ) {
			$pro_footer_desktop_items = array(
				...
				'widget-5'  => array(
					'name' => __( 'Widget 5', 'smarttoolz' ),
					'icon' => 'screenoptions',
					'pro'  => true,
				),
				'widget-6'  => array(
					'name' => __( 'Widget 6', 'smarttoolz' ),
					'icon' => 'screenoptions',
					'pro'  => true,
				),
				'button-1'  => array(
					'name' => __( 'Button 1', 'smarttoolz' ),
					'icon' => 'button',
					'pro'  => true,
				),
				'button-2'  => array(
		...
		if ( class_exists( 'SmartToolz_Woocommerce' ) ) {
			...
			$woo_cart_name = class_exists( 'Easy_Digital_Downloads' ) ? __( 'Woo Cart', 'smarttoolz' ) : __( 'Cart', 'smarttoolz' );
		...
		if ( class_exists( 'Easy_Digital_Downloads' ) ) {
			...
			$edd_cart_name = class_exists( 'SmartToolz_Woocommerce' ) ? __( 'EDD Cart', 'smarttoolz' ) : __( 'Cart', 'smarttoolz' );
		...
		self::$header_mobile_items = apply_filters(
			'smarttoolz_header_mobile_items',
			array(
				'logo'           => array(
					'name'    => __( 'Site Title & Logo', 'smarttoolz' ),
					'icon'    => 'admin-appearance',
		...
		add_filter( 'smarttoolz_addon_list', array( $this, 'deprecate_old_header_and_footer' ) );
	}
	...
	public static function get_component_count() {
		...
		$component_keys_count = array_merge(
			...
			apply_filters(
				'smarttoolz_builder_elements_count',
				$component_keys_count
			)
		);
	...
	public static function is_header_footer_builder_active() {
		...
		return apply_filters( 'smarttoolz_is_header_footer_builder_active', isset( $smarttoolz_settings['is-header-footer-builder'] ) ? (bool) $smarttoolz_settings['is-header-footer-builder'] : true );
	}

	/**
	 *  Check if Migrated to new SmartToolz Builder.
	 */
	public static function is_new_user() {
		return smarttoolz_get_option( 'header-footer-builder-notice', true );
	}
	...
	public static function has_mobile_side_columns( $row = 'primary' ) {
		...
		$mobile_sides = false;
		$elements     = smarttoolz_get_option( 'header-mobile-items' );
	...
	public static function render_builder_markup( $row = 'primary', $column = 'left', $header = 'desktop', $builder = 'header' ) {
		$elements = smarttoolz_get_option( $builder . '-' . $header . '-items' );
	...
	public static function render_mobile_popup_markup() {
		...
		$off_canvas_slide   = smarttoolz_get_option( 'off-canvas-slide' );
		$mobile_header_type = smarttoolz_get_option( 'mobile-header-type' );
		$content_alignment  = smarttoolz_get_option( 'header-offcanvas-content-alignment' );
		...
		<div id="ast-mobile-popup-wrapper">
			...
			<div class="ast-mobile-popup-inner">
					<div class="ast-mobile-popup-header">
						<button type="button" id="menu-toggle-close" class="menu-toggle-close" aria-label="Close menu" tabindex="0">
							<span class="ast-svg-iconset">
								<?php echo do_shortcode( SmartToolz_Builder_UI_Controller::fetch_svg_icon( 'close' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
							</span>
						</button>
					</div>
					<div class="ast-mobile-popup-content">
						<?php
							/**
							 * SmartToolz Off-Canvas
							 */
							do_action( 'smarttoolz_render_mobile_popup', 'popup', 'content' );
						?>
					</div>
					<div class="ast-desktop-popup-content">
						<?php
							 ...
							 * SmartToolz Off-Canvas
							 */
							do_action( 'smarttoolz_render_desktop_popup', 'popup', 'content' );
						?>
					</div>
				</div>
		</div>
	...
	public static function has_center_column( $row = 'main', $builder_type = 'header', $device = 'desktop' ) {
		...
		$center   = false;
		$elements = smarttoolz_get_option( $builder_type . '-' . $device . '-items' );
		if ( isset( $elements ) && isset( $elements[ $row ] ) &&
	...
	public static function is_footer_row_empty( $row = 'primary' ) {
		$sides    = false;
		$elements = smarttoolz_get_option( 'footer-desktop-items' );
	...
	public static function is_component_loaded( $component_id, $builder_type = 'header', $device = 'both' ) {
		...
		if ( is_null( self::$loaded_grid ) ) {
			...
			$grids                   = array();
			$grids['header_desktop'] = smarttoolz_get_option( 'header-desktop-items', array() );
			$grids['header_mobile']  = smarttoolz_get_option( 'header-mobile-items', array() );
			$grids['footer_both']    = smarttoolz_get_option( 'footer-desktop-items', array() );
	...
	public static function apply_flex_based_css() {
		$smarttoolz_settings = smarttoolz_get_options();
		return apply_filters( 'smarttoolz_apply_flex_based_css', isset( $smarttoolz_settings['is-flex-based-css'] ) ? $smarttoolz_settings['is-flex-based-css'] : true );
	}
	...
	public static function get_translatable_strings() {
		if ( empty( self::$translatable_strings ) ) {
			...
			self::$translatable_strings = array(
				...
				'header-button1-text'  => _x( '%smarttoolz%', 'Builder: Header Button 1 Text', 'smarttoolz' ),
				'header-button2-text'  => _x( '%smarttoolz%', 'Builder: Header Button 2 Text', 'smarttoolz' ),
				'header-button3-text'  => _x( '%smarttoolz%', 'Builder: Header Button 3 Text', 'smarttoolz' ),
				'header-button4-text'  => _x( '%smarttoolz%', 'Builder: Header Button 4 Text', 'smarttoolz' ),
				'header-button5-text'  => _x( '%smarttoolz%', 'Builder: Header Button 5 Text', 'smarttoolz' ),
				'header-button6-text'  => _x( '%smarttoolz%', 'Builder: Header Button 6 Text', 'smarttoolz' ),
				'header-button7-text'  => _x( '%smarttoolz%', 'Builder: Header Button 7 Text', 'smarttoolz' ),
				'header-button8-text'  => _x( '%smarttoolz%', 'Builder: Header Button 8 Text', 'smarttoolz' ),
				'header-button9-text'  => _x( '%smarttoolz%', 'Builder: Header Button 9 Text', 'smarttoolz' ),
				'header-button10-text' => _x( '%smarttoolz%', 'Builder: Header Button 10 Text', 'smarttoolz' ),
				// Footer button components.
				'footer-button1-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 1 Text', 'smarttoolz' ),
				'footer-button2-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 2 Text', 'smarttoolz' ),
				'footer-button3-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 3 Text', 'smarttoolz' ),
				'footer-button4-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 4 Text', 'smarttoolz' ),
				'footer-button5-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 5 Text', 'smarttoolz' ),
				'footer-button6-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 6 Text', 'smarttoolz' ),
				'footer-button7-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 7 Text', 'smarttoolz' ),
				'footer-button8-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 8 Text', 'smarttoolz' ),
				'footer-button9-text'  => _x( '%smarttoolz%', 'Builder: Footer Button 9 Text', 'smarttoolz' ),
				'footer-button10-text' => _x( '%smarttoolz%', 'Builder: Footer Button 10 Text', 'smarttoolz' ),
				// Header HTML components.
				'header-html-1'        => _x( '%smarttoolz%', 'Builder: Header HTML 1', 'smarttoolz' ),
				'header-html-2'        => _x( '%smarttoolz%', 'Builder: Header HTML 2', 'smarttoolz' ),
				'header-html-3'        => _x( '%smarttoolz%', 'Builder: Header HTML 3', 'smarttoolz' ),
				'header-html-4'        => _x( '%smarttoolz%', 'Builder: Header HTML 4', 'smarttoolz' ),
				'header-html-5'        => _x( '%smarttoolz%', 'Builder: Header HTML 5', 'smarttoolz' ),
				'header-html-6'        => _x( '%smarttoolz%', 'Builder: Header HTML 6', 'smarttoolz' ),
				'header-html-7'        => _x( '%smarttoolz%', 'Builder: Header HTML 7', 'smarttoolz' ),
				'header-html-8'        => _x( '%smarttoolz%', 'Builder: Header HTML 8', 'smarttoolz' ),
				'header-html-9'        => _x( '%smarttoolz%', 'Builder: Header HTML 9', 'smarttoolz' ),
				'header-html-10'       => _x( '%smarttoolz%', 'Builder: Header HTML 10', 'smarttoolz' ),
				// Footer HTML components.
				'footer-html-1'        => _x( '%smarttoolz%', 'Builder: Footer HTML 1', 'smarttoolz' ),
				'footer-html-2'        => _x( '%smarttoolz%', 'Builder: Footer HTML 2', 'smarttoolz' ),
				'footer-html-3'        => _x( '%smarttoolz%', 'Builder: Footer HTML 3', 'smarttoolz' ),
				'footer-html-4'        => _x( '%smarttoolz%', 'Builder: Footer HTML 4', 'smarttoolz' ),
				'footer-html-5'        => _x( '%smarttoolz%', 'Builder: Footer HTML 5', 'smarttoolz' ),
				'footer-html-6'        => _x( '%smarttoolz%', 'Builder: Footer HTML 6', 'smarttoolz' ),
				'footer-html-7'        => _x( '%smarttoolz%', 'Builder: Footer HTML 7', 'smarttoolz' ),
				'footer-html-8'        => _x( '%smarttoolz%', 'Builder: Footer HTML 8', 'smarttoolz' ),
				'footer-html-9'        => _x( '%smarttoolz%', 'Builder: Footer HTML 9', 'smarttoolz' ),
				'footer-html-10'       => _x( '%smarttoolz%', 'Builder: Footer HTML 10', 'smarttoolz' ),
			);

			// Old header button.
			self::$translatable_strings['header-main-rt-section-button-text'] = _x( '%smarttoolz%', 'Button text for last item in Primary Menu', 'smarttoolz' );
		}
	...
	public static function get_translatable_string( $option_key ) {
		...
		return '%smarttoolz%'; // Indicates to use original string saved in the database.
	}
}

/**
 *  Prepare if class 'SmartToolz_Builder_Helper' exist.
 *  Kicking this off by calling 'get_instance()' method
 */
SmartToolz_Builder_Helper::get_instance();
