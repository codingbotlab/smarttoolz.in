<?php
/**
 * SmartToolz Builder Options default values.
 *
...
add_filter( 'smarttoolz_theme_defaults', 'smarttoolz_hf_builder_customizer_defaults' );
 ...
 * @return array
 */
function smarttoolz_hf_builder_customizer_defaults( $defaults ) {

	$smarttoolz_options                              = SmartToolz_Theme_Options::get_smarttoolz_options();
	$smarttoolz_update_footer_row_vertical_alignment = SmartToolz_Dynamic_CSS::smarttoolz_4_5_0_compatibility();
	$smarttoolz_dark_mode                            = SmartToolz_Dynamic_CSS::smarttoolz_4_9_0_compatibility();
	$blog_update                                = SmartToolz_Dynamic_CSS::smarttoolz_4_6_0_compatibility();
	...
	$defaults['hb-header-height']            = array(
		'desktop' => false === smarttoolz_check_is_structural_setup() ? 70 : 80,
		'tablet'  => '',
		'mobile'  => '',
	);
	...
	$defaults['hb-header-main-sep-color']    = 'var( --ast-global-color-subtle-background, var(--ast-global-color-7) )';
	...
	$defaults['hba-header-bottom-border-color']     = 'var( --ast-global-color-subtle-background, var(--ast-global-color-7) )';
	...
	$defaults['hbb-header-bottom-border-color'] = 'var( --ast-global-color-subtle-background, var(--ast-global-color-7) )';
	$defaults['hbb-header-bg-obj-responsive']   = array(
		'desktop' => array(
			'background-color'      => $is_dark_palette ? 'var( --ast-global-color-primary, var(--ast-global-color-4) )' : '#eeeeee',
			'background-image'      => '',
			'background-repeat'     => 'repeat',
			'background-position'   => 'center center',
			'background-size'       => 'auto',
	...
	foreach ( $margin_defaults as $margin_default ) {
		$defaults[ $margin_default ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
	}

	for ( $index = 1; $index <= SmartToolz_Builder_Helper::$component_limit; $index++ ) {

		$defaults = smarttoolz_prepare_button_defaults( $defaults, absint( $index ) );
		$defaults = smarttoolz_prepare_html_defaults( $defaults, absint( $index ) );
		$defaults = smarttoolz_prepare_social_icon_defaults( $defaults, absint( $index ) );
		$defaults = smarttoolz_prepare_widget_defaults( $defaults, absint( $index ) );
		$defaults = smarttoolz_prepare_menu_defaults( $defaults, absint( $index ) );
		$defaults = smarttoolz_prepare_divider_defaults( $defaults, absint( $index ) );
	}

	/**
	 * Header Types - Defaults
	 */
	$defaults['transparent-header-main-sep']       = false === smarttoolz_get_transparent_header_default_value() ? '' : 0;
	$defaults['transparent-header-main-sep-color'] = '';
	$reorder_color_seq                             = SmartToolz_Dynamic_CSS::smarttoolz_4_8_9_compatibility();
	...
	$defaults['hbb-footer-bg-obj-responsive'] = array(
		'desktop' => array(
			'background-color'      => $apply_new_default_color_typo_values ? ( $reorder_color_seq ? 'var(--ast-global-color-4 )' : 'var(--ast-global-color-5)' ) : ( $smarttoolz_dark_mode ? '#eeeeee' : 'var( --ast-global-color-primary, var(--ast-global-color-4) )' ),
			'background-image'      => '',
			'background-repeat'     => 'repeat',
			'background-position'   => 'center center',
			'background-size'       => 'auto',
	...
	$defaults['hb-footer-bg-obj-responsive']  = array(
		'desktop' => array(
			'background-color'      => $is_dark_palette ? 'var( --ast-global-color-primary, var(--ast-global-color-4) )' : '#f9f9f9',
			'background-image'      => '',
			'background-repeat'     => 'repeat',
			'background-position'   => 'center center',
			'background-size'       => 'auto',
	...
	$defaults['hbb-footer-top-border-color']  = $blog_update ? 'var( --ast-global-color-subtle-background, var(--ast-global-color-7) )' : 'var(--ast-global-color-subtle-background, var(--ast-global-color-6))';
	 ...
	 */
	$defaults['hbb-footer-height'] = $smarttoolz_update_footer_row_vertical_alignment ? 60 : 80;
	...
	$defaults['hbb-footer-vertical-alignment'] = $smarttoolz_update_footer_row_vertical_alignment ? 'center' : 'flex-start';
	...
	$defaults['hb-footer-main-sep-color'] = 'var( --ast-global-color-subtle-background, var(--ast-global-color-7) )';
	$defaults['live-search-result-count'] = 5;

	/**
	 * Footer Copyright.
	 */
	$defaults['footer-copyright-editor']              = __( 'Copyright [copyright] [current_year] [site_title] | Powered by [theme_author]', 'smarttoolz' );
	...
	$defaults['font-extras-section-footer-copyright'] = array(
		'line-height'         => ! isset( $smarttoolz_options['font-extras-section-footer-copyright'] ) && isset( $smarttoolz_options['line-height-section-footer-copyright'] ) ? $smarttoolz_options['line-height-section-footer-copyright'] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options['font-extras-section-footer-copyright'] ) && isset( $smarttoolz_options['text-transform-section-footer-copyright'] ) ? $smarttoolz_options['text-transform-section-footer-copyright'] : '',
		'text-decoration'     => '',
	);
	...
	$defaults['off-canvas-background']              = array(
		'background-color'      => $is_dark_palette ? 'var( --ast-global-color-secondary, var(--ast-global-color-5) )' : '#ffffff',
		'background-image'      => '',
		'background-repeat'     => 'repeat',
		'background-position'   => 'center center',
		'background-size'       => 'auto',
	...
	$defaults['footer-menu-font-extras'] = array(
		'line-height'         => ! isset( $smarttoolz_options['footer-menu-font-extras'] ) && isset( $smarttoolz_options['footer-menu-line-height'] ) ? $smarttoolz_options['footer-menu-line-height'] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options['footer-menu-font-extras'] ) && isset( $smarttoolz_options['footer-menu-text-transform'] ) ? $smarttoolz_options['footer-menu-text-transform'] : '',
		'text-decoration'     => '',
	);
	...
	$mobile_header_toggle_border_radius_fields             = ! isset( $smarttoolz_options['mobile-header-toggle-border-radius-fields'] ) && isset( $smarttoolz_options['mobile-header-toggle-border-radius'] ) ? $smarttoolz_options['mobile-header-toggle-border-radius'] : '';
	 ...
	 */
	$update_colors_for_starter_library = SmartToolz_Dynamic_CSS::smarttoolz_4_4_0_compatibility();
	$update_color_for_forms_ui         = SmartToolz_Dynamic_CSS::smarttoolz_4_6_0_compatibility();
	...
	$defaults['font-extras-header-mobile-menu'] = array(
		'line-height'         => ! isset( $smarttoolz_options['font-extras-header-mobile-menu'] ) && isset( $smarttoolz_options['header-mobile-menu-line-height'] ) ? $smarttoolz_options['header-mobile-menu-line-height'] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options['font-extras-header-mobile-menu'] ) && isset( $smarttoolz_options['header-mobile-menu-text-transform'] ) ? $smarttoolz_options['header-mobile-menu-text-transform'] : '',
		'text-decoration'     => '',
	);
	...
	$defaults['woo-header-cart-product-count-color-group'] = 'var( --ast-global-color-secondary, var(--ast-global-color-5) )';
	...
	$woo_header_cart_border_radius                         = ! isset( $smarttoolz_options['woo-header-cart-icon-radius-fields'] ) && isset( $smarttoolz_options['woo-header-cart-icon-radius'] ) ? $smarttoolz_options['woo-header-cart-icon-radius'] : '';
	...
	$defaults['header-account-logged-out-text']                       = __( 'Log In', 'smarttoolz' );
	$defaults['header-account-logged-in-text']                        = __( 'My Account', 'smarttoolz' );
	...
	$defaults['cloned-component-track'] = SmartToolz_Builder_Helper::$component_count_array;
 ...
 */
function smarttoolz_prepare_divider_defaults( $defaults, $index ) {

	$defaults[ 'section-hb-divider-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
	$defaults[ 'section-fb-divider-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function smarttoolz_prepare_button_defaults( $defaults, $index ) {
	...
	$defaults[ 'header-' . $_prefix . '-text' ]                 = __( 'Button', 'smarttoolz' );
	$defaults[ 'header-' . $_prefix . '-link-option' ]          = array(
		'url'      => apply_filters( 'smarttoolz_site_url', 'https://www.wpsmarttoolz.com' ),
		'new_tab'  => false,
		'link_rel' => '',
	);
	...
	$defaults[ 'header-' . $_prefix . '-font-extras' ]          = array(
		'line-height'         => ! isset( $smarttoolz_options[ 'header-' . $_prefix . '-font-extras' ] ) && isset( $smarttoolz_options[ 'header-' . $_prefix . '-line-height' ] ) ? $smarttoolz_options[ 'header-' . $_prefix . '-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options[ 'header-' . $_prefix . '-font-extras' ] ) && isset( $smarttoolz_options[ 'header-' . $_prefix . '-text-transform' ] ) ? $smarttoolz_options[ 'header-' . $_prefix . '-text-transform' ] : '',
		'text-decoration'     => '',
	);
	...
	$header_button_border_radius_fields                         = ! isset( $smarttoolz_options[ 'header-' . $_prefix . '-border-radius-fields' ] ) && isset( $smarttoolz_options[ 'header-' . $_prefix . '-border-radius' ] ) ? $smarttoolz_options[ 'header-' . $_prefix . '-border-radius' ] : '';
	...
	$smarttoolz_4_6_4_compatibility = SmartToolz_Dynamic_CSS::smarttoolz_4_6_4_compatibility();
	$legacy_hb_button_padding  = $apply_new_default_color_typo_values ? SmartToolz_Builder_Helper::$default_button_responsive_spacing : SmartToolz_Builder_Helper::$default_responsive_spacing;

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_top_padding = isset( $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['top'] ) ? $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['top'] : $legacy_hb_button_padding['desktop']['top'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_right_padding = isset( $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['right'] ) ? $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['right'] : $legacy_hb_button_padding['desktop']['right'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_bottom_padding = isset( $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['bottom'] ) ? $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['bottom'] : $legacy_hb_button_padding['desktop']['bottom'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_left_padding = isset( $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['left'] ) ? $smarttoolz_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['left'] : $legacy_hb_button_padding['desktop']['left'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	$defaults[ 'section-hb-button-' . $index . '-padding' ]         = array(
		'desktop'      => array(
			'top'    => $smarttoolz_4_6_4_compatibility ? 15 : $builder_button_top_padding,
			'right'  => $smarttoolz_4_6_4_compatibility ? 30 : $builder_button_right_padding,
			'bottom' => $smarttoolz_4_6_4_compatibility ? 15 : $builder_button_bottom_padding,
			'left'   => $smarttoolz_4_6_4_compatibility ? 30 : $builder_button_left_padding,
		),
		'tablet'       => array(
			'top'    => '',
			'right'  => '',
	...
	$defaults[ 'header-button' . $index . '-border-radius-fields' ] = array(
		'desktop'      => array(
			'top'    => $smarttoolz_4_6_4_compatibility ? 40 : '',
			'right'  => $smarttoolz_4_6_4_compatibility ? 40 : '',
			'bottom' => $smarttoolz_4_6_4_compatibility ? 40 : '',
			'left'   => $smarttoolz_4_6_4_compatibility ? 40 : '',
		),
		'tablet'       => array(
			'top'    => '',
			'right'  => '',
	...
	$defaults[ 'section-hb-button-' . $index . '-margin' ]          = SmartToolz_Builder_Helper::$default_responsive_spacing;
	$defaults[ 'sticky-header-button' . $index . '-padding' ]       = SmartToolz_Builder_Helper::$default_responsive_spacing;

	$_prefix = 'button' . $index;

	$defaults[ 'footer-' . $_prefix . '-text' ]                 = __( 'Button', 'smarttoolz' );
	...
	$footer_button_border_radius_fields                         = ! isset( $smarttoolz_options[ 'footer-' . $_prefix . '-border-radius-fields' ] ) && isset( $smarttoolz_options[ 'footer-' . $_prefix . '-border-radius' ] ) ? $smarttoolz_options[ 'footer-' . $_prefix . '-border-radius' ] : '';
	...
	$legacy_fb_button_padding = SmartToolz_Builder_Helper::$default_responsive_spacing;
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_top_padding = isset( $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['top'] ) ? $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['top'] : $legacy_fb_button_padding['desktop']['top'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_right_padding = isset( $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['right'] ) ? $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['right'] : $legacy_fb_button_padding['desktop']['right'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_bottom_padding = isset( $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['bottom'] ) ? $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['bottom'] : $legacy_fb_button_padding['desktop']['bottom'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_left_padding = isset( $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['left'] ) ? $smarttoolz_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['left'] : $legacy_fb_button_padding['desktop']['left'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	...
	$defaults[ 'section-fb-button-' . $index . '-margin' ]          = SmartToolz_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function smarttoolz_prepare_html_defaults( $defaults, $index ) {

	$smarttoolz_options = SmartToolz_Theme_Options::get_smarttoolz_options();

	$_section = 'section-hb-html-' . $index;

	$defaults[ 'header-html-' . $index ]                  = __( 'Insert HTML text here.', 'smarttoolz' );
	...
	$defaults[ 'font-extras-' . $_section ]               = array(
		'line-height'         => ! isset( $smarttoolz_options[ 'font-extras-' . $_section ] ) && isset( $smarttoolz_options[ 'line-height-' . $_section ] ) ? $smarttoolz_options[ 'line-height-' . $_section ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options[ 'font-extras-' . $_section ] ) && isset( $smarttoolz_options[ 'text-transform-' . $_section ] ) ? $smarttoolz_options[ 'text-transform-' . $_section ] : '',
		'text-decoration'     => '',
	);

	$defaults[ 'section-hb-html-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;

	$_section = 'section-fb-html-' . $index;

	$defaults[ 'footer-html-' . $index ]                  = __( 'Insert HTML text here.', 'smarttoolz' );
	...
	$defaults[ 'section-fb-html-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function smarttoolz_prepare_social_icon_defaults( $defaults, $index ) {
	...
	$defaults[ 'header-social-' . $index . '-radius-fields' ]      = array(
		'desktop'      => array(
			'top'    => ! isset( $smarttoolz_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $smarttoolz_options[ 'header-social-' . $index . '-radius' ],
			'right'  => ! isset( $smarttoolz_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $smarttoolz_options[ 'header-social-' . $index . '-radius' ],
			'bottom' => ! isset( $smarttoolz_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $smarttoolz_options[ 'header-social-' . $index . '-radius' ],
			'left'   => ! isset( $smarttoolz_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $smarttoolz_options[ 'header-social-' . $index . '-radius' ],
		),
		'tablet'       => array(
			'top'    => '',
			'right'  => '',
	...
	$defaults[ 'section-hb-social-icons-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
	...
	$defaults[ 'section-fb-social-icons-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function smarttoolz_prepare_widget_defaults( $defaults, $index ) {
	...
	$defaults[ 'header-widget-' . $index . '-font-extras' ] = array(
		'line-height'         => ! isset( $smarttoolz_options[ 'header-widget-' . $index . '-font-extras' ] ) && isset( $smarttoolz_options[ 'header-widget-' . $index . '-line-height' ] ) ? $smarttoolz_options[ 'header-widget-' . $index . '-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => ! isset( $smarttoolz_options[ 'header-widget-' . $index . '-font-extras' ] ) && isset( $smarttoolz_options[ 'header-widget-' . $index . '-letter-spacing' ] ) ? $smarttoolz_options[ 'header-widget-' . $index . '-letter-spacing' ] : '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options[ 'header-widget-' . $index . '-font-extras' ] ) && isset( $smarttoolz_options[ 'header-widget-' . $index . '-text-transform' ] ) ? $smarttoolz_options[ 'header-widget-' . $index . '-text-transform' ] : '',
		'text-decoration'     => '',
	);
	...
	$defaults[ 'header-widget-' . $index . '-content-font-extras' ] = array(
		'line-height'         => ! isset( $smarttoolz_options[ 'header-widget-' . $index . '-content-font-extras' ] ) && isset( $smarttoolz_options[ 'header-widget-' . $index . '-content-line-height' ] ) ? $smarttoolz_options[ 'header-widget-' . $index . '-content-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => ! isset( $smarttoolz_options[ 'header-widget-' . $index . '-content-font-extras' ] ) && isset( $smarttoolz_options[ 'header-widget-' . $index . '-content-letter-spacing' ] ) ? $smarttoolz_options[ 'header-widget-' . $index . '-content-letter-spacing' ] : '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options[ 'header-widget-' . $index . '-content-font-extras' ] ) && isset( $smarttoolz_options[ 'header-widget-' . $index . '-content-transform' ] ) ? $smarttoolz_options[ 'header-widget-' . $index . '-content-transform' ] : '',
		'text-decoration'     => '',
	);

	$defaults[ 'sidebar-widgets-header-widget-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
	...
	$defaults[ 'footer-widget-' . $index . '-content-font-extras' ] = array(
		'line-height'         => ! isset( $smarttoolz_options[ 'footer-widget-' . $index . '-content-font-extras' ] ) && isset( $smarttoolz_options[ 'footer-widget-' . $index . '-content-line-height' ] ) ? $smarttoolz_options[ 'footer-widget-' . $index . '-content-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => ! isset( $smarttoolz_options[ 'footer-widget-' . $index . '-content-font-extras' ] ) && isset( $smarttoolz_options[ 'footer-widget-' . $index . '-content-letter-spacing' ] ) ? $smarttoolz_options[ 'footer-widget-' . $index . '-content-letter-spacing' ] : '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $smarttoolz_options[ 'footer-widget-' . $index . '-content-font-extras' ] ) && isset( $smarttoolz_options[ 'footer-widget-' . $index . '-content-transform' ] ) ? $smarttoolz_options[ 'footer-widget-' . $index . '-content-transform' ] : '',
		'text-decoration'     => '',
	);
	...
	$defaults[ 'sidebar-widgets-footer-widget-' . $index . '-margin' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function smarttoolz_prepare_menu_defaults( $defaults, $index ) {
	...
	$defaults[ 'section-hb-menu-' . $index . '-margin' ]  = SmartToolz_Builder_Helper::$default_responsive_spacing;
	$defaults[ 'header-menu' . $index . '-menu-spacing' ] = SmartToolz_Builder_Helper::$default_responsive_spacing;
	...
	$header_button_submenu_border_radius_fields                         = ! isset( $smarttoolz_options[ 'header-' . $_prefix . '-submenu-border-radius-fields' ] ) && isset( $smarttoolz_options[ 'header-' . $_prefix . '-submenu-border-radius' ] ) ? $smarttoolz_options[ 'header-' . $_prefix . '-submenu-border-radius' ] : '';
