 ...
 *
 * @package SmartToolz WordPress theme
 */
if ( ! class_exists( 'SmartToolz_Walker_Page' ) ) {

	/**
	 * SmartToolz custom navigation walker.
	 *
	 * @since 1.5.4
	 */
	class SmartToolz_Walker_Page extends Walker_Page {
		/**
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$output  = apply_filters( 'smarttoolz_caret_wrap_filter', $output, $args['sort_column'] );
		}
			...
			if ( isset( $args['pages_with_children'][ $page->ID ] ) ) {
				...
				if ( true === is_object( $args ) ) {
					...
					'below_header_menu' === $args->theme_location )
						...
						$mobile_icon = '<button ' . smarttoolz_attr(
							'ast-menu-toggle',
							array(
								'aria-expanded' => 'false',
								'aria-haspopup' => 'true',
