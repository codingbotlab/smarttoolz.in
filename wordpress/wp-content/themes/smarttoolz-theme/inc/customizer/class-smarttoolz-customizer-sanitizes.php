<?php
/**
 * SmartToolz Theme Customizer Sanitize.
 *
 * @package     SmartToolz
 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'SmartToolz_Customizer_Sanitizes' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class SmartToolz_Customizer_Sanitizes {
		/**
		 * Instance
		 *
		 * @var object
		...
		public static function validate_email( $validity, $value ) {
			if ( ! is_email( $value ) ) {
				$validity->add( 'required', __( 'Enter valid email address!', 'smarttoolz' ) );
			}
			return $validity;
		}
		...
		public static function sanitize_html_widget( $input ) {
			...
			return wp_kses( $input, smarttoolz_get_html_widget_allowed_tags( false, $input ) );
		}
 ...
 */
SmartToolz_Customizer_Sanitizes::get_instance();
