 ...
 */
if ( ! class_exists( 'SmartToolz_Fonts_Data' ) ) {

	/**
	 * Fonts Data
	 */
	final class SmartToolz_Fonts_Data {
		/**
		 * Localize Fonts
		 *
		...
		public static function js( $skip_google_fonts = true ) {
			...
			$system = wp_json_encode( SmartToolz_Font_Families::get_system_fonts() );
			$custom = wp_json_encode( SmartToolz_Font_Families::get_custom_fonts() );
			...
			$google = wp_json_encode( SmartToolz_Font_Families::get_google_fonts() );
			$custom = $custom ? $custom : '{}';
