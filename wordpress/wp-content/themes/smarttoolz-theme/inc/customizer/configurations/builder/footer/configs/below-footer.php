 ...
 */
function smarttoolz_below_footer_configuration() {
	...
	$_configs = array(
		...
		array(
			'name'     => $_section,
			'type'     => 'section',
			'title'    => __( 'Below Footer', 'smarttoolz' ),
		...
		array(
			'name'       => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-column]',
			'default'    => smarttoolz_get_option( 'hbb-footer-column' ),
			'type'       => 'control',
			...
			'partial'    => array(
				...
				'render_callback'     => array( SmartToolz_Builder_Footer::get_instance(), 'below_footer' ),
			),
			'responsive' => false,
		 ...
		 */
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-layout]',
			'section'     => $_section,
			'default'     => smarttoolz_get_option( 'hbb-footer-layout' ),
			'priority'    => 3,
		 ...
		 */
		array(
			'name'       => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-layout-width]',
			'default'    => smarttoolz_get_option( 'hbb-footer-layout-width' ),
			'type'       => 'control',
			'control'    => 'ast-selector',
			'section'    => $_section,
			'priority'   => 25,
		...
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-height]',
			'section'     => $_section,
			'transport'   => 'refresh',
			'default'     => smarttoolz_get_option( 'hbb-footer-height' ),
			'priority'    => 30,
		 ...
		 */
		array(
			'name'       => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-vertical-alignment]',
			'default'    => smarttoolz_get_option( 'hbb-footer-vertical-alignment' ),
			'type'       => 'control',
			'control'    => 'ast-selector',
			'section'    => $_section,
			'priority'   => 34,
		...
		array(
			'name'     => SMARTTOOLZ_THEME_SETTINGS . '[hbb-stack]',
			'default'  => smarttoolz_get_option( 'hbb-stack' ),
			'type'     => 'control',
			'control'  => 'ast-selector',
			'section'  => $_section,
			'priority' => 5,
		...
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-separator]',
			'section'     => $_section,
			'priority'    => 40,
			'transport'   => 'postMessage',
			'default'     => smarttoolz_get_option( 'hbb-footer-separator' ),
		...
		array(
			'name'              => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-top-border-color]',
			'transport'         => 'postMessage',
			'default'           => smarttoolz_get_option( 'hbb-footer-top-border-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				...
				array(
					SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-separator]',
					'operator' => '>=',
					'value'    => 1,
				),
			),
		...
		array(
			'name'      => SMARTTOOLZ_THEME_SETTINGS . '[hbb-footer-bg-obj-responsive]',
			'type'      => 'control',
			'section'   => $_section,
			'control'   => 'ast-responsive-background',
			'transport' => 'postMessage',
			'default'   => smarttoolz_get_option( 'hbb-footer-bg-obj-responsive' ),
		 ...
		 */
		array(
			'name'              => SMARTTOOLZ_THEME_SETTINGS . '[hbb-inner-spacing]',
			'section'           => $_section,
			'priority'          => 205,
			'transport'         => 'postMessage',
			'default'           => smarttoolz_get_option( 'hbb-inner-spacing' ),
...
if ( SmartToolz_Builder_Customizer::smarttoolz_collect_customizer_builder_data() ) {
	add_action( 'init', 'smarttoolz_below_footer_configuration' );
}
