 ...
 */
function smarttoolz_above_header_configuration() {
	...
	$_configs = array(
		...
		array(
			'name'              => SMARTTOOLZ_THEME_SETTINGS . '[hba-header-height]',
			'section'           => $_section,
			'transport'         => 'postMessage',
			'default'           => smarttoolz_get_option( 'hba-header-height' ),
			'priority'          => 30,
		...
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hba-header-bg-obj-responsive]',
			'type'        => 'control',
			'section'     => $_section,
			'control'     => 'ast-responsive-background',
			'transport'   => 'postMessage',
			'default'     => smarttoolz_get_option( 'hba-header-bg-obj-responsive' ),
		...
		array(
			'name'              => SMARTTOOLZ_THEME_SETTINGS . '[hba-header-bottom-border-color]',
			'transport'         => 'postMessage',
			'default'           => smarttoolz_get_option( 'hba-header-bottom-border-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				...
				array(
					'setting'  => SMARTTOOLZ_THEME_SETTINGS . '[hba-header-separator]',
					'operator' => '>=',
					'value'    => 1,
				),
			),
		...
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hba-header-separator]',
			'section'     => $_section,
			'priority'    => 40,
			'transport'   => 'postMessage',
			'default'     => smarttoolz_get_option( 'hba-header-separator' ),
...
if ( SmartToolz_Builder_Customizer::smarttoolz_collect_customizer_builder_data() ) {
	add_action( 'init', 'smarttoolz_above_header_configuration' );
}
