 ...
 */
function smarttoolz_below_header_configuration() {
	...
	$_configs = array(
		...
		array(
			'name'              => SMARTTOOLZ_THEME_SETTINGS . '[hbb-header-height]',
			'section'           => $_section,
			'transport'         => 'postMessage',
			'default'           => smarttoolz_get_option( 'hbb-header-height' ),
			'priority'          => 30,
		...
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hbb-header-bg-obj-responsive]',
			'type'        => 'control',
			'section'     => $_section,
			'control'     => 'ast-responsive-background',
			'transport'   => 'postMessage',
			'default'     => smarttoolz_get_option( 'hbb-header-bg-obj-responsive' ),
		...
		array(
			'name'              => SMARTTOOLZ_THEME_SETTINGS . '[hbb-header-bottom-border-color]',
			'transport'         => 'postMessage',
			'default'           => smarttoolz_get_option( 'hbb-header-bottom-border-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				array(
					'setting'  => SMARTTOOLZ_THEME_SETTINGS . '[hbb-header-separator]',
					'operator' => '>=',
					'value'    => 1,
				),
		...
		array(
			'name'        => SMARTTOOLZ_THEME_SETTINGS . '[hbb-header-separator]',
			'section'     => $_section,
			'priority'    => 40,
			'transport'   => 'postMessage',
			'default'     => smarttoolz_get_option( 'hbb-header-separator' ),
...
if ( SmartToolz_Builder_Customizer::smarttoolz_collect_customizer_builder_data() ) {
	add_action( 'init', 'smarttoolz_below_header_configuration' );
}
