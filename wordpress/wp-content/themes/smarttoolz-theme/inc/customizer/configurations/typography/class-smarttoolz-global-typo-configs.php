 ...
 */
class SmartToolz_Global_Typo_Configs extends SmartToolz_Customizer_Config_Base {
	/**
	...
	public function register_configuration( $configurations, $wp_customize ) {
		...
		$_configs = array(
			 ...
			 */
			array(
				'name'      => 'smarttoolz-typography-presets',
				'type'      => 'control',
				'control'   => 'ast-typography-presets',
				'default'   => smarttoolz_get_typography_presets(),
				'options'   => array(
				...
				'section'   => smarttoolz_has_gcp_typo_preset_compatibility() ? 'section-typography' : 'section-body-typo',
				'transport' => 'postMessage',
				'priority'  => 5,
				'title'     => __( 'Presets', 'smarttoolz' ),
...
new SmartToolz_Global_Typo_Configs();
