...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 */
	class SmartToolz_WP_Customize_Section extends WP_Customize_Section {
		/**
		 * Section
		 *
		 * @since 1.0.31
		...
		public function json() {
			...
			if ( $this->panel ) {
				$array['customizeAction'] = sprintf( __( 'Customizing &#9656; %s', 'smarttoolz' ), esc_html( $this->manager->get_panel( $this->panel )->title ) );
			} else {
