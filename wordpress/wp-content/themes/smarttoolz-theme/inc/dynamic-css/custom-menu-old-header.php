...
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_old_header_custom_menu_css' );
 ...
 * @since 3.5.0
 */
function smarttoolz_old_header_custom_menu_css( $dynamic_css ) {
	...
	if ( false === SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
		...
		$search_box_type = smarttoolz_get_option( 'header-main-rt-section-search-box-type' );
