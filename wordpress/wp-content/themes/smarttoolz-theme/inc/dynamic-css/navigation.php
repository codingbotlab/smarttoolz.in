...
add_filter( 'smarttoolz_dynamic_theme_css', 'smarttoolz_navigation_css', 11 );
 ...
 * @since 4.6.0
 */
function smarttoolz_navigation_css( $dynamic_css ) {
	$mobile_breakpoint = strval( smarttoolz_get_mobile_breakpoint() );
	$link_hover_color  = smarttoolz_get_option( 'link-h-color' );

	/** Backward compatibility support for left-right paddings @since 4.6.13 */
	$remove_mobile_device_paddings = apply_filters( 'smarttoolz_remove_single_posts_navigation_mobile_device_padding', ! empty( smarttoolz_get_option( 'remove_single_posts_navigation_mobile_device_padding' ) ) );
	...
	$dynamic_css .= SmartToolz_Enqueue_Scripts::trim_css( $navigation_css );
