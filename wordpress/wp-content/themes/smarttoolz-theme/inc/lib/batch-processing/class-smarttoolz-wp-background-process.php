...
if ( ! class_exists( 'SmartToolz_WP_Background_Process' ) ) {
	...
	/**
	 * Abstract SmartToolz_WP_Background_Process class.
	 *
	 * @abstract
	 * @extends SmartToolz_WP_Async_Request
	 */
	abstract class SmartToolz_WP_Background_Process extends SmartToolz_WP_Async_Request {
		...
		public function schedule_cron_healthcheck( $schedules ) {
			...
			$schedules[ $this->identifier . '_cron_interval' ] = array(
				...
				'display'  => sprintf( /* translators: %d: Minutes interval */ __( 'Every %d Minutes', 'smarttoolz' ), $interval ),
			);
