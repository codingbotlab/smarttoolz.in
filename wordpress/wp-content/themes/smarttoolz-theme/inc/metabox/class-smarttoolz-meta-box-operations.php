<?php
/**
 * SmartToolz Meta Box Operations
 *
 * @package     SmartToolz
 ...
 * Meta Box
 */
if ( ! class_exists( 'SmartToolz_Meta_Box_Operations' ) ) {

	/**
	 * Meta Box
	 */
	class SmartToolz_Meta_Box_Operations {
		/**
		 * Instance
		 *
		 * @var $instance
		...
		public function meta_hooks() {
			...
			if ( is_singular() ) {
				...
				add_filter( 'smarttoolz_the_title_enabled', array( $this, 'post_title' ) );
		...
		public function primary_header() {
			...
			$display_header = apply_filters( 'smarttoolz_main_header_display', $display_header );
 ...
 */
SmartToolz_Meta_Box_Operations::get_instance();
