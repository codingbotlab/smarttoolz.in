 ...
 * Meta Boxes setup
 */
if ( ! class_exists( 'SmartToolz_Meta_Boxes' ) ) {

	/**
	 * Meta Boxes setup
	 */
	class SmartToolz_Meta_Boxes {
		/**
		 * Instance
		 *
		 * @var $instance
		...
		public function remove_metabox() {
			...
			if ( 'fl-theme-layout' === $post_type && $post_id ) {
					remove_meta_box( 'smarttoolz_settings_meta_box', 'fl-theme-layout', 'side' );
			}
		}
		...
		public function setup_meta_box() {
			...
			$metabox_name = sprintf(
				...
				__( '%s Settings', 'smarttoolz' ),
				smarttoolz_get_theme_name()
			);
			...
			foreach ( $post_types as $type ) {
				...
				if ( 'attachment' !== $type && ! in_array( $type, $excluded_post_types, true ) ) {
					add_meta_box(
						'smarttoolz_settings_meta_box',              // Id.
						$metabox_name,                          // Title.
		...
		public function markup_meta_box( $post ) {
			...
			wp_nonce_field( basename( __FILE__ ), 'smarttoolz_settings_meta_box' );
			...
			$meta_key                = isset( $meta['smarttoolz-migrate-meta-layouts']['default'] ) ? $meta['smarttoolz-migrate-meta-layouts']['default'] : '';
			$migrated_user           = ! SmartToolz_Dynamic_CSS::smarttoolz_fullwidth_sidebar_support();
			do_action( 'smarttoolz_meta_box_markup_before', $meta );
			...
			<div class="ast-site-content-layout-meta-wrap components-base-control__field">
				<p class="post-attributes-label-wrapper" >
					<strong> <?php esc_html_e( 'Container Layout', 'smarttoolz' ); ?> </strong>
				</p>
				<select name="ast-site-content-layout" id="ast-site-content-layout">
					<option value="default" <?php selected( $new_site_content_layout, 'default' ); ?> > <?php esc_html_e( 'Customizer Setting', 'smarttoolz' ); ?></option>
					<option value="normal-width-container" <?php selected( $new_site_content_layout, 'normal-width-container' ); ?> > <?php esc_html_e( 'Normal', 'smarttoolz' ); ?></option>
					<?php if ( ! $exclude_cpt ) { ?>
						<option value="narrow-width-container" <?php selected( $new_site_content_layout, 'narrow-width-container' ); ?> > <?php esc_html_e( 'Narrow', 'smarttoolz' ); ?></option>
					<?php } ?>
						<option value="full-width-container" <?php selected( $new_site_content_layout, 'full-width-container' ); ?> > <?php esc_html_e( 'Full Width', 'smarttoolz' ); ?></option>
					</select>
			</div>
			<?php
			/**
			...
			<div class="site-content-style-meta-wrap components-base-control__field">
				<p class="post-attributes-label-wrapper" >
					<strong> <?php esc_html_e( 'Container Style', 'smarttoolz' ); ?> </strong>
				</p>
				<select name="site-content-style" id="site-content-style">
					<option value="default" <?php selected( $site_content_style, 'default' ); ?> > <?php esc_html_e( 'Customizer Setting', 'smarttoolz' ); ?></option>
					<option value="unboxed" <?php selected( $site_content_style, 'unboxed' ); ?> > <?php esc_html_e( 'Unboxed', 'smarttoolz' ); ?></option>
					<option value="boxed" <?php selected( $site_content_style, 'boxed' ); ?> > <?php esc_html_e( 'Boxed', 'smarttoolz' ); ?></option>
				</select>
			</div>
			<?php
			/**
			...
			<div class="site-sidebar-layout-meta-wrap components-base-control__field">
				<p class="post-attributes-label-wrapper" >
					<strong> <?php esc_html_e( 'Sidebar Layout', 'smarttoolz' ); ?> </strong>
				</p>
				<select name="site-sidebar-layout" id="site-sidebar-layout">
					<option value="default" <?php selected( $site_sidebar, 'default' ); ?> > <?php esc_html_e( 'Customizer Setting', 'smarttoolz' ); ?></option>
					<option value="left-sidebar" <?php selected( $site_sidebar, 'left-sidebar' ); ?> > <?php esc_html_e( 'Left Sidebar', 'smarttoolz' ); ?></option>
					<option value="right-sidebar" <?php selected( $site_sidebar, 'right-sidebar' ); ?> > <?php esc_html_e( 'Right Sidebar', 'smarttoolz' ); ?></option>
					<option value="no-sidebar" <?php selected( $site_sidebar, 'no-sidebar' ); ?> > <?php esc_html_e( 'No Sidebar', 'smarttoolz' ); ?></option>
				</select>
			</div>
			<?php
			/**
			...
			<div class="site-sidebar-style-meta-wrap components-base-control__field">
				<p class="post-attributes-label-wrapper" >
					<strong> <?php esc_html_e( 'Sidebar Style', 'smarttoolz' ); ?> </strong>
				</p>
				<select name="site-sidebar-style" id="site-sidebar-style">
					<option value="default" <?php selected( $site_sidebar_style, 'default' ); ?> > <?php esc_html_e( 'Customizer Setting', 'smarttoolz' ); ?></option>
					<option value="unboxed" <?php selected( $site_sidebar_style, 'unboxed' ); ?> > <?php esc_html_e( 'Unboxed', 'smarttoolz' ); ?></option>
					<option value="boxed" <?php selected( $site_sidebar_style, 'boxed' ); ?> > <?php esc_html_e( 'Boxed', 'smarttoolz' ); ?></option>
				</select>
			</div>
			<?php
			/**
			...
			<div class="disable-section-meta-wrap components-base-control__field">
				<p class="post-attributes-label-wrapper">
					<strong> <?php esc_html_e( 'Disable Sections', 'smarttoolz' ); ?> </strong>
				</p>
				<div class="disable-section-meta">
					<?php do_action( 'smarttoolz_meta_box_markup_disable_sections_before', $meta ); ?>

					<?php
					/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
					if ( $show_meta_field && true === SmartToolz_Builder_Helper::$is_header_footer_builder_active && SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'desktop' ) ) {
						/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
						?>
					<div class="ast-hfb-above-header-display-option-wrap">
						...
						<label for="ast-hfb-above-header-display"><?php esc_html_e( 'Disable Above Header', 'smarttoolz' ); ?></label> <br />
					</div>
					<?php } ?>

					<?php
					/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
					if ( $show_meta_field && SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'desktop' ) ) {
						/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
						?>
					<div class="ast-main-header-display-option-wrap">
						...
						<?php esc_html_e( 'Disable Primary Header', 'smarttoolz' ); ?>
						</label>
					</div>
					<?php } ?>
					...
					<?php
					/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
					if ( $show_meta_field && true === SmartToolz_Builder_Helper::$is_header_footer_builder_active && SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'desktop' ) ) {
						/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
						?>
					<div class="ast-hfb-below-header-display-option-wrap">
						...
						<label for="ast-hfb-below-header-display"><?php esc_html_e( 'Disable Below Header', 'smarttoolz' ); ?></label> <br />
					</div>
					<?php } ?>
					<?php
					/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
					if ( $show_meta_field && true === SmartToolz_Builder_Helper::$is_header_footer_builder_active && ( SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'mobile' ) || SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'mobile' ) || SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'mobile' ) ) ) {
						/** @psalm-suppress DocblockTypeContradiction */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
						?>
					...
					<div class="ast-hfb-mobile-header-display-option-wrap">
						...
						<label for="ast-hfb-mobile-header-display"><?php esc_html_e( 'Disable Mobile Header', 'smarttoolz' ); ?></label> <br />
					</div>
					<?php } ?>

					<?php do_action( 'smarttoolz_meta_box_markup_disable_sections_after_primary_header', $meta ); ?>
					<?php if ( $show_meta_field ) { ?>
						<div class="site-post-title-option-wrap">
							<label for="site-post-title">
								...
								<?php esc_html_e( 'Disable Title', 'smarttoolz' ); ?>
							</label>
						</div>
						<?php
						$ast_breadcrumbs_content = smarttoolz_get_option( 'ast-breadcrumbs-content' );
						if ( 'disabled' !== $ast_breadcrumbs_content && 'none' !== smarttoolz_get_option( 'breadcrumb-position' ) ) {
							?>
					<div class="ast-breadcrumbs-content-option-wrap">
						<label for="ast-breadcrumbs-content">
							...
							<?php esc_html_e( 'Disable Breadcrumb', 'smarttoolz' ); ?>
						</label>
					</div>
						<?php } ?>
						...
						<div class="ast-featured-img-option-wrap">
							<label for="ast-featured-img">
								...
								<?php esc_html_e( 'Disable Featured Image', 'smarttoolz' ); ?>
							</label>
						</div>
						...
						if ( ( in_array( $post_type, $supported_post_types ) && true === smarttoolz_get_option( 'ast-single-' . $post_type . '-title', class_exists( 'WooCommerce' ) && 'product' === $post_type ? false : true ) ) ) {
							if ( ! ( class_exists( 'WooCommerce' ) && absint( smarttoolz_get_post_id() ) === wc_get_page_id( 'shop' ) ) ) {
								?>
							<div class="ast-banner-title-visibility-option-wrap">
								...
								<?php esc_html_e( 'Disable Banner Area', 'smarttoolz' ); ?>
								</label>
							</div>
								<?php
							}
						...
						if ( $show_meta_field && true === smarttoolz_get_option( 'enable-related-posts' ) ) {
							?>
					<div class="ast-disable-related-posts-option-wrap">
						<label for="ast-disable-related-posts">
							...
							<?php esc_html_e( 'Disable Related Posts', 'smarttoolz' ); ?>
						</label>
					</div>
							<?php
						}
					...
					<?php
					$footer_adv_layout = smarttoolz_get_option( 'footer-adv' );

					if ( $show_meta_field && ( 'disabled' !== $footer_adv_layout && ! SmartToolz_Builder_Helper::$is_header_footer_builder_active ) ) {
						?>
					<div class="footer-adv-display-option-wrap">
						<label for="footer-adv-display">
							...
							<?php esc_html_e( 'Disable Footer Widgets', 'smarttoolz' ); ?>
						</label>
					</div>

						<?php
					}
					$footer_sml_layout = smarttoolz_get_option( 'footer-sml-layout' );
					if ( 'disabled' !== $footer_sml_layout || SmartToolz_Builder_Helper::$is_header_footer_builder_active ) {
						?>
					<div class="footer-sml-layout-option-wrap">
						<label for="footer-sml-layout">
							...
							<?php esc_html_e( 'Disable Footer', 'smarttoolz' ); ?>
						</label>
					</div>
						<?php
					}
					?>
					<?php do_action( 'smarttoolz_meta_box_markup_disable_sections_after', $meta ); ?>
				</div>
			</div>
			<?php

			do_action( 'smarttoolz_meta_box_markup_after', $meta );

			if ( smarttoolz_showcase_upgrade_notices() ) {
				$nudge_copy        = array(
					'product' => __( 'Launch high-converting product pages faster - get 300+ templates and powerful design tools.', 'smarttoolz' ),
					'default' => __( 'Go from blank page to live website faster - get 300+ templates and powerful design tools.', 'smarttoolz' ),
				);
				...
				printf(
					...
					esc_url( SMARTTOOLZ_THEME_URI . 'inc/assets/images/smarttoolz-logo.svg' ),
					esc_html( $nudge_description ),
					esc_url( smarttoolz_get_pro_url( '/pricing/', 'free-theme', 'post-metabox', 'upgrade' ) ),
					esc_html__( 'Upgrade Now', 'smarttoolz' ),
					esc_attr__( 'SmartToolz Logo', 'smarttoolz' )
				);
			}
		}
		...
		public function save_meta_box( $post_id ) {
			...
			$is_valid_nonce = isset( $_POST['smarttoolz_settings_meta_box'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['smarttoolz_settings_meta_box'] ) ), basename( __FILE__ ) ) ? true : false;
			...
			// Added Check if current post type is excluded from SmartToolz meta settings.
			...
			foreach ( $post_meta as $key => $data ) {
				...
				switch ( $sanitize_filter ) {
					...
					case 'FILTER_DEFAULT':
						 ...
						 */
						$meta_value = apply_filters( 'smarttoolz_php_default_filter_input', ! empty( $_POST[ $key ] ) ? sanitize_text_field( wp_unslash( $_POST[ $key ] ) ) : '', $key );
						/** @psalm-suppress PossiblyInvalidArgument */
						break;
				...
				if ( $meta_value ) {
					...
					/** @psalm-suppress InvalidArgument */
					update_post_meta( $post_id, 'smarttoolz-migrate-meta-layouts', 'set' );
				} else {
		...
		public function load_classic_editor_styles() {
			...
			$css_uri      = SMARTTOOLZ_THEME_URI . '/inc/metabox/extend-metabox/css/' . $dir_name;
			wp_enqueue_style( 'smarttoolz-meta-box', $css_uri . '/metabox' . $file_prefix . '.css', array(), SMARTTOOLZ_THEME_VERSION );
		}
		...
		public function load_scripts() {
			...
			if ( defined( 'SMARTTOOLZ_ADVANCED_HOOKS_POST_TYPE' ) && SMARTTOOLZ_ADVANCED_HOOKS_POST_TYPE === $post_type ) {
				return;
			}
			...
			wp_enqueue_script( 'smarttoolz-meta-settings' );
			wp_set_script_translations( 'smarttoolz-meta-settings', 'smarttoolz' );
			$smarttoolz_ext_extension_class_exists = class_exists( 'SmartToolz_Ext_Extension' ) ? true : false;
			...
			$palette_css_var_prefix   = SmartToolz_Global_Palette::get_css_variable_prefix();
			$apply_new_default_values = smarttoolz_button_default_padding_updated();
			$bg_updated_title         = sprintf(
				/* translators: 1: Post type, 2: Background string */
				'%1$s %2$s',
				ucfirst( strval( $post_type ) ),
				__( 'Background', 'smarttoolz' )
			);
			$page_bg_dynamic_title = ( $post_type ? $bg_updated_title : __( 'Page Background', 'smarttoolz' ) );
			...
			/* Created a new array specifically designed for storing post types that don't require SmartToolz's meta settings.*/
			$register_smarttoolz_metabox = ! in_array( $post_type, array( 'wp_block' ), true );
			...
			wp_localize_script(
				...
				array(
					...
					'sidebar_title'                  => __( 'Sidebar', 'smarttoolz' ),
					...
					'content_layout_title'           => __( 'Content Layout', 'smarttoolz' ),
					'disable_sections_title'         => __( 'Disable Sections', 'smarttoolz' ),
					'disable_sections'               => $this->get_disable_section_fields(),
					'isWhiteLabelled'                => smarttoolz_is_white_labelled(),
					'sticky_header_title'            => __( 'Sticky Header', 'smarttoolz' ),
					'sticky_header_options'          => $this->get_sticky_header_options(),
					'transparent_header_title'       => __( 'Transparent Header', 'smarttoolz' ),
					'page_header_title'              => __( 'Page Header', 'smarttoolz' ),
					'page_header_edit_link'          => esc_url( admin_url( 'edit.php?post_type=smarttoolz_adv_header' ) ),
					...
					'is_bb_themer_layout'            => ! smarttoolz_check_is_bb_themer_layout(), // Show page header option only when bb is not activated.
					'is_addon_activated'             => defined( 'SMARTTOOLZ_EXT_VER' ) ? true : false,
					'sticky_addon_enabled'           => $smarttoolz_ext_extension_class_exists && SmartToolz_Ext_Extension::is_active( 'sticky-header' ) ? true : false,
					'register_smarttoolz_metabox'         => apply_filters( 'smarttoolz_settings_metabox_register', $register_smarttoolz_metabox ),
					'is_hide_contnet_layout_sidebar' => $ast_content_layout_sidebar,
					'upgrade_pro_link'               => esc_url_raw( smarttoolz_get_pro_url( '/pricing/', 'free-theme', 'post-metabox', 'upgrade' ) ),
					'show_upgrade_notice'            => smarttoolz_showcase_upgrade_notices(),
					'logo_url'                       => esc_url( SMARTTOOLZ_THEME_URI . 'inc/assets/images/smarttoolz-logo.svg' ),
					// Flag needed to check whether user is old or new, true for old user, false for new.
					'v4_1_6_migration'               => ! SmartToolz_Dynamic_CSS::smarttoolz_fullwidth_sidebar_support(),
					'color_addon_enabled'            => $smarttoolz_ext_extension_class_exists && SmartToolz_Ext_Extension::is_active( 'colors-and-background' ) ? true : false,
					...
					'ast_page_bg_title'              => __( 'Surface Colors', 'smarttoolz' ),
					'page_bg_toggle_options'         => $this->get_page_bg_toggle_options(),
					'surface_color_help_text'        => __( 'Enabling this option will override global > colors > surface color options', 'smarttoolz' ),
					'page_bg_dynamic_title'          => $page_bg_dynamic_title,
					'global_color_palette'           => $global_palette,
					'color_palette_labels'           => SmartToolz_Global_Palette::get_palette_labels(),
				)
			);

			wp_enqueue_script( 'smarttoolz-metabox-cf-compatibility', SMARTTOOLZ_THEME_URI . 'inc/assets/js/custom-fields-priority.js', array(), SMARTTOOLZ_THEME_VERSION, false );
		}
		...
		public function get_sidebar_options() {
			return array(
				'default'       => __( 'Customizer Setting', 'smarttoolz' ),
				'no-sidebar'    => __( 'No Sidebar', 'smarttoolz' ),
				'left-sidebar'  => __( 'Left Sidebar', 'smarttoolz' ),
				'right-sidebar' => __( 'Right Sidebar', 'smarttoolz' ),
			);
		}
		...
		public function get_content_layout_options() {
			...
			if ( smarttoolz_with_third_party() || $exclude_cpt ) {
				return array(
					'default'                => __( 'Customizer Setting', 'smarttoolz' ),
		 ...
		 *
		 * @return array $smarttoolz_header_options All header dependent toggle based page elements.
		 */
		public function get_header_disable_meta_fields() {
			$smarttoolz_header_options = array();

			if ( SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'desktop' ) ) {
				$smarttoolz_header_options[] = array(
					'key'   => 'ast-hfb-above-header-display',
					'label' => __( 'Disable Above Header', 'smarttoolz' ),
				);
			}

			if ( SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'desktop' ) ) {
				$smarttoolz_header_options[] = array(
					'key'   => 'ast-main-header-display',
					'label' => __( 'Disable Primary Header', 'smarttoolz' ),
				);
			}

			if ( SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'desktop' ) ) {
				$smarttoolz_header_options[] = array(
					'key'   => 'ast-hfb-below-header-display',
					'label' => __( 'Disable Below Header', 'smarttoolz' ),
				);
			}

			if (
				SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'mobile' ) ||
				SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'mobile' ) ||
				SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'mobile' )
			) {
				$smarttoolz_header_options[] = array(
					'key'   => 'ast-hfb-mobile-header-display',
					'label' => __( 'Disable Mobile Header', 'smarttoolz' ),
				);
			}

			return $smarttoolz_header_options;
		}

		/**
		 * Get disable section fields.
		 *
		 * @return array $smarttoolz_page_meta_elements All toggle based page elements.
		 */
		public function get_disable_section_fields() {

			$smarttoolz_page_meta_elements = array(
				array(
					'key'   => 'ast-global-header-display',
					'label' => __( 'Disable Header', 'smarttoolz' ),
				),
				array(
					'key'   => 'footer-sml-layout',
					'label' => __( 'Disable Footer', 'smarttoolz' ),
				),
			);
			...
			if ( ( in_array( $post_type, $supported_post_types ) && true === smarttoolz_get_option( 'ast-single-' . $post_type . '-title', class_exists( 'WooCommerce' ) && 'product' === $post_type ? false : true ) ) ) {
				if ( ! ( class_exists( 'WooCommerce' ) && absint( smarttoolz_get_post_id() ) === wc_get_page_id( 'shop' ) ) ) {
					$smarttoolz_page_meta_elements[] = array(
						...
						'label' => __( 'Disable Banner Area', 'smarttoolz' ),
					);
				}
			}

			if ( 'none' !== smarttoolz_get_option( 'breadcrumb-position', 'none' ) ) {
				$smarttoolz_page_meta_elements[] = array(
					'key'   => 'ast-breadcrumbs-content',
					'label' => __( 'Disable Breadcrumb', 'smarttoolz' ),
				);
			}

			if ( true === smarttoolz_get_option( 'enable-related-posts' ) ) {
				$smarttoolz_page_meta_elements[] = array(
					'key'   => 'ast-disable-related-posts',
					'label' => __( 'Disable Related Posts', 'smarttoolz' ),
				);
			}

			return $smarttoolz_page_meta_elements;
		}
		...
		public function get_sticky_header_options() {
			$smarttoolz_sticky_header_options     = array();
			...
			if ( defined( 'SMARTTOOLZ_EXT_VER' ) && SmartToolz_Ext_Extension::is_active( 'sticky-header' ) ) {
				/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				$sticky_on_devices = smarttoolz_get_option( 'sticky-header-on-devices' );
				switch ( $sticky_on_devices ) {
					case 'desktop':
						$sticky_above_header_condition   = SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'desktop' );
						$sticky_primary_header_condition = SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'desktop' );
						$sticky_below_header_condition   = SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'desktop' );
						break;
					case 'mobile':
						$sticky_above_header_condition   = SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'mobile' );
						$sticky_primary_header_condition = SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'mobile' );
						$sticky_below_header_condition   = SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'mobile' );
						break;
					default:
						$sticky_above_header_condition   = SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'desktop' ) || SmartToolz_Builder_Helper::is_row_empty( 'above', 'header', 'mobile' ) ? true : false;
						$sticky_primary_header_condition = SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'desktop' ) || SmartToolz_Builder_Helper::is_row_empty( 'primary', 'header', 'mobile' ) ? true : false;
						$sticky_below_header_condition   = SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'desktop' ) || SmartToolz_Builder_Helper::is_row_empty( 'below', 'header', 'mobile' ) ? true : false;
						break;
				}
			}
			...
			if ( $sticky_above_header_condition ) {
				$smarttoolz_sticky_header_options[] = array(
					...
					'label' => __( 'Stick Above Header', 'smarttoolz' ),
				);
			}
			...
			if ( $sticky_primary_header_condition ) {
				$smarttoolz_sticky_header_options[] = array(
					...
					'label' => __( 'Stick Primary Header', 'smarttoolz' ),
				);
			}
			...
			if ( $sticky_below_header_condition ) {
				$smarttoolz_sticky_header_options[] = array(
					...
					'label' => __( 'Stick Below Header', 'smarttoolz' ),
				);
			}

			return $smarttoolz_sticky_header_options;
		}
		...
		public function get_header_enabled_options() {
			return array(
				'default'  => __( 'Inherit', 'smarttoolz' ),
				'enabled'  => __( 'Enabled', 'smarttoolz' ),
				'disabled' => __( 'Disabled', 'smarttoolz' ),
			);
		}
		...
		public function check_page_header_availability() {
			...
			if ( class_exists( 'SmartToolz_Ext_Extension' ) && ! SmartToolz_Ext_Extension::is_active( 'advanced-headers' ) ) {
				return false;
			}

			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$page_headers = SmartToolz_Target_Rules_Fields::get_post_selection( 'smarttoolz_adv_header' );
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		...
		public function get_page_header_options() {
			...
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$header_options = SmartToolz_Target_Rules_Fields::get_post_selection( 'smarttoolz_adv_header' );
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			if ( empty( $header_options ) ) {
				$header_options = array(
					'' => __( 'No Page Headers Found', 'smarttoolz' ),
				);
			}
		...
		public function register_meta_settings() {
			...
			register_post_meta(
				'',
				'smarttoolz-migrate-meta-layouts',
				array(
					'show_in_rest' => true,
					'single'       => true,
					'default'      => isset( $meta['smarttoolz-migrate-meta-layouts']['default'] ) ? $meta['smarttoolz-migrate-meta-layouts']['default'] : '',
					'type'         => 'string',
				)
			);
			...
			register_post_meta(
				...
				array(
					'single'            => true,
					'type'              => 'object',
					'sanitize_callback' => 'smarttoolz_sanitize_background_meta',
					'show_in_rest'      => array(
						'schema' => array(
							'type'       => 'object',
							'properties' => array(
		...
		/**
		 * Setup meta options for SmartToolz meta settings.
		 *
		 * @since 3.7.8
		 */
		public static function post_meta_options() {
			...
			self::$meta_option        = apply_filters(
				...
				array(
					...
					'smarttoolz-migrate-meta-layouts'    => array(
						'default'  => 'default',
						'sanitize' => 'FILTER_DEFAULT',
					),
		...
		/**
		 * Get post types excluded from SmartToolz meta registration.
		 *
		 * @since 4.11.6
		 * @return array
		 */
		public static function get_excluded_meta_post_types() {
			/**
			 * Filter to exclude post types from SmartToolz meta registration.
			 *
			 * @param array $excluded_post_types Array of post types to exclude.
			 */
			return apply_filters( 'smarttoolz_excluded_meta_post_types', array( 'sureforms_form' ) );
		}
	}
}
 ...
 * @since 3.9.4
 */
function smarttoolz_footer_bar_display_cb( $display_footer ) {
...
add_filter( 'smarttoolz_footer_bar_display', 'smarttoolz_footer_bar_display_cb', 99, 1 );

/**
 * Kicking this off by calling 'get_instance()' method
 */
SmartToolz_Meta_Boxes::get_instance();
