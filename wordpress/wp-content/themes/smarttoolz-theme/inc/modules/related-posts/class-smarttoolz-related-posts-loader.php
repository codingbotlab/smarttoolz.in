<?php
/**
 * Related Posts Loader for SmartToolz theme.
 *
 * @package     SmartToolz
 ...
 * @since 3.5.0
 */
class SmartToolz_Related_Posts_Loader {
	/**
	 *  Constructor
	 *
	 * @since 3.5.0
	...
	public function add_fonts() {
		if ( smarttoolz_target_rules_for_related_posts() ) {
			...
			$section_title_font_family = smarttoolz_get_option( 'related-posts-section-title-font-family' );
			$section_title_font_weight = smarttoolz_get_option( 'related-posts-section-title-font-weight' );
			SmartToolz_Fonts::add_font( $section_title_font_family, $section_title_font_weight );

			// Related Posts - Posts title.
			$post_title_font_family = smarttoolz_get_option( 'related-posts-title-font-family' );
			$post_title_font_weight = smarttoolz_get_option( 'related-posts-title-font-weight' );
			SmartToolz_Fonts::add_font( $post_title_font_family, $post_title_font_weight );

			// Related Posts - Meta Font.
			$meta_font_family = smarttoolz_get_option( 'related-posts-meta-font-family' );
			$meta_font_weight = smarttoolz_get_option( 'related-posts-meta-font-weight' );
			SmartToolz_Fonts::add_font( $meta_font_family, $meta_font_weight );

			// Related Posts - Content Font.
			$content_font_family = smarttoolz_get_option( 'related-posts-content-font-family' );
			$content_font_weight = smarttoolz_get_option( 'related-posts-content-font-weight' );
			SmartToolz_Fonts::add_font( $content_font_family, $content_font_weight );
		}
	}
	...
	public function theme_defaults( $defaults ) {
		...
		$smarttoolz_blog_update = SmartToolz_Dynamic_CSS::smarttoolz_4_6_0_compatibility();

		// Related Posts.
		$defaults['enable-related-posts']                    = false;
		$defaults['related-posts-title']                     = __( 'Related Posts', 'smarttoolz' );
		...
		$defaults['related-posts-container-width']           = $smarttoolz_blog_update ? '' : 'fallback';
		...
		$defaults['related-posts-author-prefix-label']       = smarttoolz_default_strings( 'string-blog-meta-author-by', false );
		...
		$defaults['related-posts-section-title-font-extras']    = array(
			'line-height'         => ! isset( $smarttoolz_options['related-posts-section-title-font-extras'] ) && isset( $smarttoolz_options['related-posts-section-title-line-height'] ) ? $smarttoolz_options['related-posts-section-title-line-height'] : '1.6',
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $smarttoolz_options['related-posts-section-title-font-extras'] ) && isset( $smarttoolz_options['related-posts-section-title-text-transform'] ) ? $smarttoolz_options['related-posts-section-title-text-transform'] : '',
			'text-decoration'     => '',
		);
		...
		$defaults['related-posts-title-font-extras']    = array(
			'line-height'         => ! isset( $smarttoolz_options['related-posts-title-font-extras'] ) && isset( $smarttoolz_options['related-posts-title-line-height'] ) ? $smarttoolz_options['related-posts-title-line-height'] : ( $smarttoolz_blog_update ? '1.5' : '1' ),
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $smarttoolz_options['related-posts-title-font-extras'] ) && isset( $smarttoolz_options['related-posts-title-text-transform'] ) ? $smarttoolz_options['related-posts-title-text-transform'] : '',
			'text-decoration'     => '',
		);
		...
		$defaults['related-posts-meta-font-extras']    = array(
			'line-height'         => ! isset( $smarttoolz_options['related-posts-meta-font-extras'] ) && isset( $smarttoolz_options['related-posts-meta-line-height'] ) ? $smarttoolz_options['related-posts-meta-line-height'] : '1.6',
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $smarttoolz_options['related-posts-meta-font-extras'] ) && isset( $smarttoolz_options['related-posts-meta-text-transform'] ) ? $smarttoolz_options['related-posts-meta-text-transform'] : '',
			'text-decoration'     => '',
		);
		...
		$defaults['related-posts-content-font-extras']     = array(
			'line-height'         => ! isset( $smarttoolz_options['related-posts-content-font-extras'] ) && isset( $smarttoolz_options['related-posts-content-line-height'] ) ? $smarttoolz_options['related-posts-content-line-height'] : '',
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $smarttoolz_options['related-posts-content-font-extras'] ) && isset( $smarttoolz_options['related-posts-content-text-transform'] ) ? $smarttoolz_options['related-posts-content-text-transform'] : '',
			'text-decoration'     => '',
		);
	...
	public function related_posts_customize_register( $wp_customize ) {
		...
		require_once SMARTTOOLZ_RELATED_POSTS_DIR . 'customizer/class-smarttoolz-related-posts-configs.php';
	...
	public function render_related_posts_title() {
		return smarttoolz_get_option( 'related-posts-title' );
	}
}
 ...
 */
new SmartToolz_Related_Posts_Loader();
