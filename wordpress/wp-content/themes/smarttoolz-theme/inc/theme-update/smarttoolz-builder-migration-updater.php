<?php
/**
 * SmartToolz builder migration updates
 *
 ...
 * @return void
 */
function smarttoolz_header_builder_migration() {
	...
	$options = smarttoolz_primary_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = smarttoolz_below_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = smarttoolz_above_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = smarttoolz_footer_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = smarttoolz_footer_widgets_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = smarttoolz_primary_menu_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = smarttoolz_sticky_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
 ...
 * @return array
 */
function smarttoolz_primary_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
	...
	$mobile_layout = smarttoolz_get_option( 'header-main-menu-align' );
 ...
 * @return array
 */
function smarttoolz_below_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
	/**
	 * Below Header
	 */
 ...
 * @return array
 */
function smarttoolz_above_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
	/**
	 * Above Header.
	 */
 ...
 * @return array
 */
function smarttoolz_footer_builder_migration( $theme_options, $used_elements, $widget_options ) {
	/**
	 * Footer
	 */
 ...
 * @return array
 */
function smarttoolz_footer_widgets_migration( $theme_options, $used_elements, $widget_options ) {
 ...
 * @return array
 */
function smarttoolz_primary_menu_builder_migration( $theme_options, $used_elements, $widget_options ) {
 ...
 * @return array
 */
function smarttoolz_sticky_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
