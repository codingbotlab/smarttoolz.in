 ...
 * @return void.
 */
function smarttoolz_clear_all_assets_cache() {
	if ( ! class_exists( 'SmartToolz_Cache_Base' ) ) {
		return;
	}
	// Clear SmartToolz theme asset cache.
	$smarttoolz_cache_base_instance = new SmartToolz_Cache_Base( 'smarttoolz' );
	$smarttoolz_cache_base_instance->refresh_assets( 'smarttoolz' );

	// Clear SmartToolz Addon's static and dynamic CSS asset cache.
	$smarttoolz_addon_cache_base_instance = new SmartToolz_Cache_Base( 'smarttoolz-addon' );
	$smarttoolz_addon_cache_base_instance->refresh_assets( 'smarttoolz-addon' );
}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_0_0() {
	// Dynamic customizer migration starts here.
	$theme_options = get_option( 'smarttoolz-settings', array() );
	if ( ! isset( $theme_options['dynamic-blog-layouts'] ) && ! isset( $theme_options['theme-dynamic-customizer-support'] ) ) {
		...
		update_option( 'smarttoolz-settings', $theme_options );
	}
	...
	if ( ! isset( $admin_dashboard_settings['theme-setup-admin-migrated'] ) ) {
		...
		update_option( 'smarttoolz_admin_settings', $admin_dashboard_settings );
	}
	...
	if ( defined( 'SMARTTOOLZ_EXT_VER' ) && SmartToolz_Ext_Extension::is_active( 'scroll-to-top' ) ) {
		/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_0_2() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_1_0() {
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_1_4() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_1_6() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_1_7() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
	...
	if ( ! isset( $theme_options['smarttoolz-site-svg-logo-equal-height'] ) ) {
		$theme_options['smarttoolz-site-svg-logo-equal-height'] = false;
		update_option( 'smarttoolz-settings', $theme_options );
	}
}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_2_0() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
	if ( ! isset( $theme_options['v4-2-0-update-migration'] ) ) {
		...
		if ( isset( $theme_options['site-content-layout'] ) ) {
			$theme_options = smarttoolz_apply_layout_migration( 'site-content-layout', 'ast-site-content-layout', 'site-content-style', 'site-sidebar-style', $theme_options );
		}
		...
		foreach ( $blog_types as $blog_type ) {
			foreach ( $post_types as $post_type ) {
				...
				if ( isset( $theme_options[ $old_layout ] ) ) {
					$theme_options = smarttoolz_apply_layout_migration( $old_layout, $new_layout, $content_style, $sidebar_style, $theme_options );
				}
			}
		}
		...
		foreach ( $third_party_layouts as $layout ) {
			...
			if ( isset( $theme_options[ $old_layout ] ) ) {
				if ( 'lifterlms' === $layout ) {
					...
					$theme_options = smarttoolz_apply_layout_migration( $old_layout, $new_layout, $content_style, 'lifterlms-course-lesson-sidebar-style', $theme_options );
				}
				$theme_options = smarttoolz_apply_layout_migration( $old_layout, $new_layout, $content_style, $sidebar_style, $theme_options );
			}
		}
 ...
 */
function smarttoolz_apply_layout_migration( $old_layout, $new_layout, $content_style, $sidebar_style, $theme_options ) {
	switch ( smarttoolz_get_option( $old_layout ) ) {
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_2_2() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_4_0() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_5_0() {
	$theme_options = get_option( 'smarttoolz-settings', array() );

	if ( ! isset( $theme_options['v4-5-0-backward-option'] ) ) {
		$theme_options['v4-5-0-backward-option'] = false;

		$palette_options = get_option( 'smarttoolz-color-palettes', SmartToolz_Global_Palette::get_default_color_palette() );
		if ( ! isset( $palette_options['presets'] ) ) {
			$palette_options['presets'] = smarttoolz_get_palette_presets();
			update_option( 'smarttoolz-color-palettes', $palette_options );
		}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_5_2() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_0() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
	...
	$docs_legacy_data = get_option( 'smarttoolz_docs_data', array() );
	if ( ! empty( $docs_legacy_data ) ) {
		delete_option( 'smarttoolz_docs_data' );
	}
}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_2() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_4() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_5() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_6() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_11() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_12() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_6_14() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_7_0() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_7_1() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
...
/**
 * Handle backward compatibility Spectra Heading max-width with SmartToolz when fullwidth layout is selected.
 *
 * @since 4.8.0
 * @return void
 */
function smarttoolz_theme_background_updater_4_8_0() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_8_2() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_8_4() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
	...
	if ( ! isset( $theme_options['smarttoolz-heading-font-size-compatibility'] ) ) {
				$theme_options['smarttoolz-heading-font-size-compatibility'] = false;
		update_option( 'smarttoolz-settings', $theme_options );
	}
}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_8_7() {

	// Bail early if the starter template is being imported.
	if ( get_option( 'smarttoolz_sites_import_started' ) === 'yes' ) {
		return;
	}

	update_option( 'smarttoolz_nps_show', true );
}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_8_9() {
	// Bail early if the starter template is being imported.
	if ( get_option( 'smarttoolz_sites_import_started' ) === 'yes' || smarttoolz_get_option( 'new-color-labels' ) ) {
		smarttoolz_update_option( 'new-color-labels', true );
	}
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_8_10() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
	/**
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_9_0() {
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_10_0() {
	...
	$analytics_options = array(
		'bsf_analytics_installed_time' => 'smarttoolz_usage_installed_time',
		'bsf_analytics_optin'          => 'smarttoolz_usage_optin',
	);
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_11_6() {
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_11_12() {
	// Set button consistency backward compatibility flag.
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_12_0() {
	// Plain get_option, not smarttoolz_get_options — its request-static cache may hold a filtered copy that would bypass the updater filter detach.
	$theme_options = get_option( 'smarttoolz-settings', array() );
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_12_2() {
	// Retrieve the installed time and optin status of BSF Analytics and update it as per new key option.
	$analytics_options = array(
		'smarttoolz_analytics_installed_time' => 'smarttoolz_usage_installed_time',
		'smarttoolz_analytics_optin'          => 'smarttoolz_usage_optin',
	);
 ...
 * @return void
 */
function smarttoolz_theme_background_updater_4_13_11() {
