...
SmartToolz is fast, fully customizable & beautiful WordPress theme suitable for blog, personal portfolio, business website and WooCommerce storefront.

== Description ==

SmartToolz is fast, fully customizable & beautiful WordPress theme suitable for blog, personal portfolio, business website and WooCommerce storefront. It is very lightweight (less than 50KB on frontend) and offers unparalleled speed. Built with SEO in mind, SmartToolz comes with Schema.org code integrated and is Native AMP ready so search engines will love your site.

It offers special features and templates so it works perfectly with all page builders like Elementor, Beaver Builder, Visual Composer, SiteOrigin, Divi, etc. Some of the other features: # WooCommerce Ready # Responsive # RTL & Translation Ready # Extendible with premium addons # Regularly updated # Designed, Developed, Maintained & Supported by SmartToolz.

Looking for a perfect base theme? Look no further. SmartToolz is fast, fully customizable and WooCommerce ready theme that you can use for building any kind of website!

The SmartToolz WordPress theme is lightning-fast and highly customizable. It has over 1 million downloads and the only theme in the world with 6,000+ five-star reviews! 
...
SmartToolz also provides expert support for free users. A dedicated team of fully trained WordPress experts are on hand to help with every aspect of the theme.

<a href="https://zipwp.org/themes/smarttoolz/" target="_blank">Try the live demo of SmartToolz</a>

== Installation ==

= From within WordPress =
1. Visit "Appearance > Themes > Add New"
2. Search for "SmartToolz"
3. Install and activate

== License ==

SmartToolz WordPress Theme, Copyright 2020 SmartToolz.
SmartToolz is distributed under the terms of the GNU GPL.

SmartToolz is based on Underscores https://underscores.me/, (C) 2012-2020 Automattic, Inc.
Underscores is distributed under the terms of the GNU GPL v2 or later.

== Features ==

= Appearance > Widgets =
SmartToolz has up to 4 widget area. 1 in your header, 1 for each sidebar and up to 2 in your footer.
...
= SMARTTOOLZ Child Theme =

There are multiple ways you can use a child theme with the SmartToolz Theme, Use any one method mentoned below to create a child theme or use a child theme we have created.

1. Download the child theme from Github - https://github.com/brainstormforce/smarttoolz-child/releases/latest/
...
Screenshot image is a collage of actual sites created using the SmartToolz WordPress Theme.
...
Hand-drawn illustrations used are created by SmartToolz and released under Creative Commons ( CC0 ) License.
...
For more information, refer to this document on how to create a page like in the screenshot - https://wpsmarttoolz.com/docs/replicating-the-screenshot/.
...
SmartToolz icon font is based on IcoMoon-Free vector icon by Keyamoon.
...
SmartToolz default breadcrumb is based on Breadcrumb Trail by Justin Tadlock. (https://github.com/justintadlock/breadcrumb-trail)
...
SmartToolz local fonts feature is based on Webfonts Loader by WordPress Themes Team (WPTT). (https://github.com/WPTT/webfont-loader)
Licensed under MIT ( https://github.com/WPTT/webfont-loader/blob/master/LICENSE )

= WP Background Processing =

SmartToolz uses a modified version of WP Background Processing library for handling background tasks efficiently.
...
SmartToolz uses a YouTube video embedded in the SmartToolz dashboard to provide helpful information and tutorials.
Please note that YouTube may collect user data as outlined in their Privacy Policy (https://policies.google.com/privacy).
No personal data is collected or stored by the SmartToolz theme itself through this video embed.
